...
public class NoPremium extends PluginForHost implements JDPremInterface {
    ...
    public String getAGBLink() {
        if (plugin == null) return "http://www.nopremium.pl/terms.php";
    ...
    public String getHost() {
        if (plugin == null) return "nopremium.pl";
    ...
    public String getBuyPremiumUrl() {
        if (plugin == null) return "http://www.nopremium.pl/offer.php";
    ...
    private boolean handleNoPremium(DownloadLink link) throws Exception {
        ...
        synchronized (LOCK) {
            ...
            // acc =
            // AccountController.getInstance().getValidAccount("nopremium.pl");
        ...
        if (plugin != null) {
            if (PremiumCompoundExtension.preferLocalAccounts() && account != null) {
                ...
                synchronized (LOCK) {
                    ...
                    // ("NoPremium.pl") != null) return Integer.MAX_VALUE;
                }
            }
            // return plugin.getMaxSimultanDownload(account);
            return Integer.MAX_VALUE;
    ...
    public String getCustomFavIconURL() {
        if (proxyused) return "NoPremium.pl";

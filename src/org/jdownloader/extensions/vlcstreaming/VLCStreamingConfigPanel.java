...
public class VLCStreamingConfigPanel extends ExtensionConfigPanel<VLCStreamingExtension> {

    public VLCStreamingConfigPanel(VLCStreamingExtension plg, VLCStreamingConfig config) {
        super(plg);
        this.config = config;
        initComponents();
        layoutPanel();
    ...
    private final VLCStreamingConfig config;

 ...
 * <p>
 * The HTML.Tmpl.Filter interface allows you to write Filters for your
 * templates. The filter is called after the template is read and before it is
 * parsed.
 * <p>
 * You can use a filter to make changes in the template file before it is parsed
 * by HTML.Template, so for example, use it to replace constants, or to
 * translate your own tags to HTML.Template tags.
 * <p>
 * A common usage would be to do what you think you're doing when you do
 * <code>&lt;TMPL_INCLUDE file="&lt;TMPL_VAR name="the_file"&gt;"&gt;</code>:
 * <p>
 * myTemplate.tmpl:
 * 
 * <pre>
...
public interface Filter {
    ...
    /**
     * Tells HTML.Template what kind of filter this is. Should return either
     * SCALAR or ARRAY to indicate which parse method must be called.
     * 
     * @return the values SCALAR or ARRAY indicating which parse method is to be
     *         called
     */
    public int format();

    /**
     * parses the template as a single string, and returns the parsed template
     * as a single string.
     * <p>
     * Should throw an UnsupportedOperationException if it isn't implemented
     * 
     * @param t
     *            a string containing the entire template
     * 
     ...
     * 
     * @param t
     *            an array of strings containing the template - one line at a
     *            time
     * 
     * @return an array of strings containing the parsed template - one line at
     *         a time
     * 
     * @throws UnsupportedOperationException
     *             if this method isn't implemented

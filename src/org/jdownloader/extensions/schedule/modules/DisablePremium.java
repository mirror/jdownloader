...
public class DisablePremium implements SchedulerModuleInterface {
    ...
    public void execute(String parameter) {
        org.jdownloader.settings.staticreferences.CFG_GENERAL.USE_AVAILABLE_ACCOUNTS.setValue(false);
    }

    public String getTranslation() {
        return T._.jd_plugins_optional_schedule_modules_disablePremium();
    }

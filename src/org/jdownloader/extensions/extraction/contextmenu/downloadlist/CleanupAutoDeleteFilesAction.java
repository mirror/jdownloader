...
public class CleanupAutoDeleteFilesAction extends ExtensionAction<ExtractionExtension, ExtractionConfig, ExtractionTranslation> {

    protected List<Archive> archives;

    public CleanupAutoDeleteFilesAction(final SelectionInfo<?, ?> selection) {

...
public class AntistandbyConfigPanel extends ExtensionConfigPanel<AntiStandbyExtension> {
    ...
    public AntistandbyConfigPanel(AntiStandbyExtension trayExtension) {
        ...
        addPair(T.T.mode(), null, new ComboBox<Mode>(keyHandler2, new Mode[] { Mode.DOWNLOADING, Mode.RUNNING }, new String[] { T.T.gui_config_antistandby_whiledl2(), T.T.gui_config_antistandby_whilejd2() }));

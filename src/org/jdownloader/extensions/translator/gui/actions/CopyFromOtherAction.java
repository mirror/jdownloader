...
public class CopyFromOtherAction extends AppAction {
    ...
    public void actionPerformed(ActionEvent e) {
        final ComboBoxDialog d = new ComboBoxDialog(0, "Clone Translation", "Choose the Language you want to clone", owner.getTranslations().toArray(new TLocale[] {}), PRE == null ? 0 : owner.getTranslations().indexOf(PRE), new AbstractIcon(IconKey.ICON_LANGUAGE, 32), null, null, null);

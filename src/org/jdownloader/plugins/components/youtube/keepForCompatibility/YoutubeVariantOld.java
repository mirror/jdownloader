...
public enum YoutubeVariantOld {
    ...
    DASH_AUDIO_OPUS_160KBIT(null, VariantGroup.AUDIO, DownloadType.DASH_AUDIO, "opus", null, YoutubeITAG.DASH_AUDIO_OPUS_160KBIT, null, null) {
        public String _getName(Object caller) {
            return _GUI.T.YoutubeVariant_name_generic_audio("160kbit", "Opus");
        }
    ...
    DASH_AUDIO_OPUS_48KBIT(null, VariantGroup.AUDIO, DownloadType.DASH_AUDIO, "opus", null, YoutubeITAG.DASH_AUDIO_OPUS_48KBIT, null, null) {
        public String _getName(Object caller) {
            return _GUI.T.YoutubeVariant_name_generic_audio("48kbit", "Opus");
        }
    ...
    DASH_AUDIO_OPUS_64KBIT(null, VariantGroup.AUDIO, DownloadType.DASH_AUDIO, "opus", null, YoutubeITAG.DASH_AUDIO_OPUS_64KBIT, null, null) {
        public String _getName(Object caller) {
            return _GUI.T.YoutubeVariant_name_generic_audio("64kbit", "Opus");
        }

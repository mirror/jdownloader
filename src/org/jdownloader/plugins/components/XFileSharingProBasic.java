...
public class XFileSharingProBasic extends antiDDoSForHost {
    ...
    public boolean isLoggedin() {
        ...
        final boolean myAccountOkay = new Regex(htmlWithoutScriptTagsAndComments, ahref + "(&|\\?)op=my_account").matches() || new Regex(htmlWithoutScriptTagsAndComments, ahref + "/my(-|_)account\"").matches();

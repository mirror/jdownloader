...
public abstract class XFileSharingProBasic extends antiDDoSForHost implements DownloadConnectionVerifier {
    ...
    protected void fixFilename(final URLConnectionAdapter connection, final DownloadLink link) {
        ...
        String servNameExt = connection != null ? getFileNameFromDispositionHeader(connection) : null;
        if (servNameExt != null && servNameExt.matches("(?i)video\\.(mp4|mkv)$")) {
            servNameExt = null;
        }
        // TODO: If needed, additionally try to obtain filename from URL.
        // String urlNameExt = null;
        // if (connection != null) {
        // urlNameExt = Plugin.getFileNameFromURL(connection.getURL());
        // urlNameExt = URLEncode.decodeURIComponent(urlNameExt);
        // }

        ...
        try {
            ...
            while (true) {
                ...
                for (final DownloadLink link : links) {
                    ...
                    if (!foundResult) {
                        /**
                         * This should never happen. Possible reasons: </br> - Wrong APIKey </br> - We tried to check too many items at once
                         * </br> - API only allows users to check self-uploaded content --> Disable API linkchecking in plugin! </br> - API
                         * does not not allow linkchecking at all --> Disable API linkchecking in plugin! </br>
                         */

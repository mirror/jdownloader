...
public class XFileSharingProBasic extends antiDDoSForHost {
     ...
     * </br> 2020-05-25: Do NOT trust our users as they could also put in apikeys for hosts which do not even have the XFS "API Mod"
     * installed! Override this if you want to allow users to use the API for linkchecking!
     */

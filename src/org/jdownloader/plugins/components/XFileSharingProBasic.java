...
public class XFileSharingProBasic extends antiDDoSForHost {
     ...
     */
    protected boolean isWebsiteUnderMaintenance(final DownloadLink link, final Browser br, final String correctedBR) {
    ...
    protected void checkErrors(final Browser br, final String html, final DownloadLink link, final Account account, final boolean checkAll) throws NumberFormatException, PluginException {
        ...
        } else if (isWebsiteUnderMaintenance(link, br, html)) {

        ...
        SecondLevelLaunch.INIT_COMPLETE.executeWhenReached(new Runnable() {
            ...
            public void run() {
                if (parameters.length == 3) {
                    try {
                        RemoteAPIController.getInstance().getAdvancedConfigAPI().set(null, parameters[0], null, parameters[1], JSonStorage.restoreFromString(parameters[2], new TypeRef<Object>() {
                        }));
                    ...
                    try {
                        RemoteAPIController.getInstance().getAdvancedConfigAPI().set(null, parameters[0], parameters[1], parameters[2], JSonStorage.restoreFromString(parameters[3], new TypeRef<Object>() {
                        }));

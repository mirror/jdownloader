...
public class DeprecatedRemoteAPIRequest extends RemoteAPIRequest {
    ...
    public DeprecatedRemoteAPIRequest(InterfaceHandler<?> iface, String methodName, String[] parameters, DeprecatedAPIRequestInterface request, String callback) throws IOException {

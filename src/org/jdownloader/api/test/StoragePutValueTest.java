...
public class StoragePutValueTest extends Test {
    ...
    public void run(Storage config, AbstractMyJDClientForDesktopJVM api) throws Exception {
        ...
        final String value = Dialog.getInstance().showInputDialog(0, "Enter value", "Enter", null, null, null, null);
        storageAPI.putValue(storageID, key, value);
    }

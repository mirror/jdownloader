...
public class StorageCreateTest extends Test {
    ...
    public void run(Storage config, AbstractMyJDClientForDesktopJVM api) throws Exception {
        ...
        final String storageID = Dialog.getInstance().showInputDialog(0, "Enter storageID to create", "Enter", null, null, null, null);
        storageAPI.create(storageID);

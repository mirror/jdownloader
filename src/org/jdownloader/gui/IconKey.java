...
public class IconKey {
    ...
    public static final String ICON_LOGO_OBOOM                   = "logo_oboom";
    public static final String ICON_LOGO_OBOOM_SMALL             = "logo_oboom_small";
    public static final String ICON_LOGO_OBOOM_SMALL_LANDSCAPE   = "logo_oboom_small_landscape";
    ...
    public static final String ICON_OBOOM_JDBANNER_FREE_DE       = "oboom/jdbanner_free_de";
    public static final String ICON_OBOOM_JDBANNER_FREE_EN       = "oboom/jdbanner_free_en";
    public static final String ICON_OBOOM_JDBANNER_FREE_ES       = "oboom/jdbanner_free_es";
    public static final String ICON_OBOOM_JDBANNER_FREE_FR       = "oboom/jdbanner_free_fr";
    public static final String ICON_OBOOM_JDBANNER_FREE_IT       = "oboom/jdbanner_free_it";
    public static final String ICON_OBOOM_JDBANNER_FREE_NL       = "oboom/jdbanner_free_nl";
    public static final String ICON_OBOOM_JDBANNER_FREE_PL       = "oboom/jdbanner_free_pl";
    public static final String ICON_OBOOM_JDBANNER_FREE_PT       = "oboom/jdbanner_free_pt";
    public static final String ICON_OBOOM_JDBANNER_FREE_TR       = "oboom/jdbanner_free_tr";
    public static final String ICON_OBOOM_JDBANNER_GETPRO_DE     = "oboom/jdbanner_getpro_de";
    public static final String ICON_OBOOM_JDBANNER_GETPRO_EN     = "oboom/jdbanner_getpro_en";
    public static final String ICON_OBOOM_JDBANNER_GETPRO_ES     = "oboom/jdbanner_getpro_es";
    public static final String ICON_OBOOM_JDBANNER_GETPRO_FR     = "oboom/jdbanner_getpro_fr";
    public static final String ICON_OBOOM_JDBANNER_GETPRO_IT     = "oboom/jdbanner_getpro_it";
    public static final String ICON_OBOOM_JDBANNER_GETPRO_NL     = "oboom/jdbanner_getpro_nl";
    public static final String ICON_OBOOM_JDBANNER_GETPRO_PL     = "oboom/jdbanner_getpro_pl";
    public static final String ICON_OBOOM_JDBANNER_GETPRO_PT     = "oboom/jdbanner_getpro_pt";
    public static final String ICON_OBOOM_JDBANNER_GETPRO_TR     = "oboom/jdbanner_getpro_tr";

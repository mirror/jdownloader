                    ...
                    new EDTRunner() {
                        ...
                        protected void runInEDT() {
                            ...
                            case NORMAL:
                                ...
                                BasicNotify no = new BasicNotify(CFG_TRAY_CONFIG.BALLON_NOTIFY_ON_NEW_LINKGRABBER_PACKAGE_ENABLED, _GUI._.balloon_new_package(), _GUI._.balloon_new_package_msg(((CrawledPackage) event.getParameter(0)).getName()), NewTheme.I().getIcon(IconKey.ICON_PACKAGE_NEW, 32));
            ...
            public void onHighLight(CrawledLink parameter) {
                new EDTRunner() {
                    ...
                    protected void runInEDT() {
                        ...
                        BasicNotify no = new BasicNotify(CFG_TRAY_CONFIG.BALLON_NOTIFY_ON_NEW_LINKGRABBER_LINKS_ENABLED, _GUI._.balloon_new_links(), _GUI._.balloon_new_links_msg(LinkCollector.getInstance().getPackages().size(), LinkCollector.getInstance().getChildrenCount()), NewTheme.I().getIcon(IconKey.ICON_LINKGRABBER, 32));
                        no.setActionListener(new ActionListener() {
        ...
        if (UpdateController.getInstance().hasPendingUpdates() && !updatesNotified) {
            ...
            new EDTRunner() {
                ...
                protected void runInEDT() {
                    ...
                    BasicNotify no = new BasicNotify(CFG_TRAY_CONFIG.BALLON_NOTIFY_ON_UPDATE_AVAILABLE_ENABLED, _GUI._.balloon_updates(), _GUI._.balloon_updates_msg(), NewTheme.I().getIcon("update", 32));
                    no.setActionListener(new ActionListener() {
    ...
    public void onBeforeReconnect(final ReconnecterEvent event) {
        ...
        new EDTRunner() {
            ...
            protected void runInEDT() {
                ...
                BasicNotify no = new BasicNotify(CFG_TRAY_CONFIG.BALLON_NOTIFY_ON_RECONNECT_START_ENABLED, _GUI._.balloon_reconnect(), _GUI._.balloon_reconnect_start_msg(), NewTheme.I().getIcon("reconnect", 32));
        ...
        new EDTRunner() {
            ...
            protected void runInEDT() {
                ...
                if (!(Boolean) event.getParameter()) {
                    ...
                    BasicNotify no = new BasicNotify(CFG_TRAY_CONFIG.BALLON_NOTIFY_ON_RECONNECT_END_ENABLED, _GUI._.balloon_reconnect(), _GUI._.balloon_reconnect_end_msg_failed(IPController.getInstance().getIP()), NewTheme.I().getIcon("error", 32));

                    show(no);

                } else {

                    BasicNotify no = new BasicNotify(CFG_TRAY_CONFIG.BALLON_NOTIFY_ON_RECONNECT_END_ENABLED, _GUI._.balloon_reconnect(), _GUI._.balloon_reconnect_end_msg_failed(IPController.getInstance().getIP()), NewTheme.I().getIcon("ok", 32));

...
public class RemoveOptionsAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        popup.add(new RemoveSelectionAction(table.getExtTableModel().getSelectedObjects()).toContextMenuAction());
        popup.add(new RemoveNonSelectedAction(table.getExtTableModel().getSelectedObjects()).toContextMenuAction());
        popup.add(new RemoveOfflineAction(table.getExtTableModel().getSelectedObjects()).toContextMenuAction());

...
public class FilePackagePropertiesPanel extends DownloadLinkPropertiesPanel {
    ...
    public void fillPopup(JPopupMenu pu) {
        ...
        // CFG_GUI.DOWNLOADS_PROPERTIES_PANEL_DOWNLOAD_FROM_VISIBLE));
        // pu.add(new CheckboxMenuItem(_GUI._.LinkgrabberPropertiesHeader_downloadpassword(),
        // CFG_GUI.DOWNLOADS_PROPERTIES_PANEL_DOWNLOAD_PASSWORD_VISIBLE));
    ...
    @Override
    protected void updateInEDT(DownloadLink link, FilePackage pkg) {

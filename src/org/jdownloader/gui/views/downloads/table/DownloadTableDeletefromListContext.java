...
public class DownloadTableDeletefromListContext extends MenuContext<JMenu> {
    ...
    public DownloadTableDeletefromListContext(JMenu submenu, SelectionInfo<FilePackage, DownloadLink> si) {
        super(submenu);

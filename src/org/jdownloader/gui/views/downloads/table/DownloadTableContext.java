...
public class DownloadTableContext extends MenuContext<JPopupMenu> {
    ...
    public DownloadTableContext(DownloadsTable downloadsTable, JPopupMenu popup, AbstractNode contextObject, ArrayList<AbstractNode> selection, ExtColumn<AbstractNode> column, MouseEvent ev) {
        super(popup);

...
public class ServicePanelImageTyperzTooltip extends PanelToolTip {
    ...
    public static final DomainInfo DOMAININFO = DomainInfo.getInstance("ImageTyperz.com");
    ...
    public ServicePanelImageTyperzTooltip(ServicePanel owner, final ImageTyperzCaptchaSolver solver) {
        ...
        new Thread() {
            public void run() {
                ...
                final ImageTyperzAccount account = solver.loadAccount();
                new EDTRunner() {
                    ...
                    protected void runInEDT() {
                        ...
                        // revalidate();
                        // repaint();
                        ToolTipController.getInstance().show(ServicePanelImageTyperzTooltip.this);
                    }

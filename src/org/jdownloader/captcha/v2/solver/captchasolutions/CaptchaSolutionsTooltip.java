...
public class CaptchaSolutionsTooltip extends PanelToolTip {
    ...
    public CaptchaSolutionsTooltip(ServicePanel owner, final CaptchaSolutionsSolver solver) {
        ...
        new Thread() {
            public void run() {
                ...
                final CaptchaSolutionsAccount account = solver.loadAccount();
                new EDTRunner() {
                    ...
                    protected void runInEDT() {
                        ...
                        // revalidate();
                        // repaint();
                        ToolTipController.getInstance().show(CaptchaSolutionsTooltip.this);
                    }

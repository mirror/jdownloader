...
public class TwoCaptchaTooltip extends PanelToolTip {
    ...
    public TwoCaptchaTooltip(ServicePanel owner, final TwoCaptchaSolver solver) {
        ...
        JLabel header = new JLabel("2Captcha.com Solver", new AbstractIcon(IconKey.ICON_LOGO_2CAPTCHA, 18), JLabel.LEFT);
        ...
        new Thread() {
            public void run() {
                final TwoCaptchaAccount account = solver.loadAccount();
                new EDTRunner() {
                    @Override
                    protected void runInEDT() {
                        ...
                        // revalidate();
                        // repaint();
                        ToolTipController.getInstance().show(TwoCaptchaTooltip.this);
                    }
                };
            }
        }.start();

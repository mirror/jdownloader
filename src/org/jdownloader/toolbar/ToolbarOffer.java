...
public class ToolbarOffer extends AbstractDialog<Object> implements Runnable, ShutdownVetoListener {
    ...
    public static void main(String[] args) {
        ...
        try {
            Dialog.getInstance().showDialog(new ToolbarOffer());
    ...
    public JComponent layoutDialogContent() {
        ...
        final JLabel lblSearch = (new JLabel("Set the JDownloader Web Search as my default search and notify me of changes"));
        final JLabel lblHp = (new JLabel("Set my home page and new browser tabs to the JDownloader customized Web Search page"));

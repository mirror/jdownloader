...
public class CreditsManager {
    ...
    private CreditsManager() {
        ...
        add(new Credit("Icons8 IconSet", "© 2016 VisualPharm LLC", "Several Icons and Images", "http://www.icons8.com", CouplingType.ICONS, License.CC_BY_ND_3, new License("Licensee AppWork GmbH", "Licensee AppWork GmbH; Captain Vector Plan", "licenses/Icons8_Paid_License.pdf")));

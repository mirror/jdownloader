...
public class CFG_CAPTCHA {
    ...
    /**
     * If the CES Bubble Support is enable, the bubble gives the user a chance to cancel the CES usage. This is the timeout for this skip option
     **/
     ...
     **/
    public static final IntegerKeyHandler               CAPTCHA_DIALOG_CAPTCHA_BROTHERHOOD_TIMEOUT     = SH.getKeyHandler("CaptchaDialogCaptchaBrotherhoodTimeout", IntegerKeyHandler.class);

...
public class CFG_GUI {
     ...
     **/
    public static final EnumKeyHandler                                 WINDOW_FOCUS_ACTION_WHEN_NEW_LINKS_ARE_ADDED         = SH.getKeyHandler("WindowFocusActionWhenNewLinksAreAdded", EnumKeyHandler.class);
    // true

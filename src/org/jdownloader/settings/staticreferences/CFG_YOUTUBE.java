...
public class CFG_YOUTUBE {
     ...
     **/
    public static final BooleanKeyHandler             SET_ENABLE_INCLUDE_VARIANT_STRING_IN_CONTENT_URLS_ENABLED = SH.getKeyHandler("EnableIncludeVariantStringInContentURLs", BooleanKeyHandler.class);

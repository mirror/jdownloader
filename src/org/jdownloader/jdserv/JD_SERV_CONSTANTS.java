...
public class JD_SERV_CONSTANTS {
    ...
    // public static final String HOST = "192.168.2.250:81/thomas/fcgi";
    ...
    public static void main(String[] args) {
        ...
        LogCollection log = new RemoteClient("192.168.2.250/thomas/fcgi").create(UploadInterface.class).get("1342021886903", null);

...
//                if (event.getID() == ControlEvent.CONTROL_INIT_COMPLETE) {
                    ...
                    if (JDL.isGerman()) {
                        ...
                        UserIO.getInstance().requestMessageDialog(UserIO.NO_COUNTDOWN,"Survey", "To make JDownloader event better, we do an Survey about user satisfaction. We would be very happy if you could spend a few minutes.\r\nGreetings, your JD-Team");
                    }
                    try {

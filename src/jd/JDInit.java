...
public class JDInit {
    ...
    public void loadPluginForDecrypt() {
        ...
        // );
        new DecryptPluginWrapper("ddl-music.org", "DDLMusicOrg", PluginPattern.decrypterPattern_DDLMusic_Main.pattern() + "|" + PluginPattern.decrypterPattern_DDLMusic_Crypt.pattern());
        ...
        new DecryptPluginWrapper("3dl.am", "DreiDlAm", PluginPattern.decrypterPattern_DreiDlAm_1.pattern() + "|" + PluginPattern.decrypterPattern_DreiDlAm_2.pattern() + "|" + PluginPattern.decrypterPattern_DreiDlAm_3.pattern());
        ...
        new DecryptPluginWrapper("relink.us", "RelinkUs", "http://[\\w\\.]*?relink\\.us\\/(go\\.php\\?id=\\d+|f/\\d+)");
        ...
        //TODO finish work! new DecryptPluginWrapper("sdx.cc","SdxCc","http://[\\w\\.]*?sdx\\.cc/infusions/(pro_download_panel|user_uploads)/download\\.php\\?did=\\d+");
        ...
        new DecryptPluginWrapper("sharebank.ws", "SharebankWs", "http://[\\w\\.]*?sharebank\\.ws/\\?v\\=[a-zA-Z0-9]+");
        ...
        new DecryptPluginWrapper("Wordpress Parser", "Wordpress", PluginPattern.decrypterPattern_Wordpress);
    ...
    public void loadPluginForHost() {
        ...
        new HostPluginWrapper("HTTP Links", "HTTPAllgemein", "httpviajd://[\\w\\.:-]*/.*?\\.(bin|cue|divx|dlc|ccf|rsdf|zip|mp3|mp4|avi|iso|mov|wmv|mpg|rar|mp2|7z|pdf|flv|jpg|jpeg|exe|3gp|wav|mkv|tar|bz2)");
        ...
        new HostPluginWrapper("Megashares.Com", "MegasharesCom", "http://[\\w\\.]*?(d[0-9]{2}\\.)?megashares\\.com/.*\\?d[0-9]{2}=[0-9a-f]{7}");
        ...
        new HostPluginWrapper("shragle.com", "ShragleCom", "http://[\\w\\.]*?shragle\\.com/files/[a-zA-Z0-9]+/.*");

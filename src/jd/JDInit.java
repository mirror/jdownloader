...
public class JDInit {
    ...
    public HashMap<String, PluginOptional> loadPluginOptional() {
        ...
        String[] optionalPlugins = new String[] { "JDTrayIcon", "JDGetter", "JDLightTray", "webinterface.JDWebinterface", "schedule.Schedule", "JDFolderWatch","JDRemoteControl", "JDShutDown"};

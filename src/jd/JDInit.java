...
public class JDInit {
    ...
    public void loadPluginForDecrypt() {
        ...
        new DecryptPluginWrapper("crypting.it", "CryptingIt", "http://[\\w\\.]*?crypting\\.it/(s/[a-zA-Z0-9]+|index\\.php\\?p=show(usrfolders)?(&user=.+)?&id=[a-zA-Z0-9]+)");
    ...
    public void loadPluginForHost() {
        ...
        new HostPluginWrapper("MegaPorn.com", "MegaPornCom", "http://[\\w\\.]*?(megaporn)\\.com/.*?(\\?|&)d=[a-zA-Z0-9]+", PluginWrapper.LOAD_ON_INIT);
        ...
        // Free Hoster
        new HostPluginWrapper("FreakShare.net", "Freaksharenet", "http://[\\w\\.]*?freakshare\\.net/file(s/|/)[a-zA-Z0-9]+/(.*)");
        ...
        new HostPluginWrapper("HTTP Links", "HTTPAllgemein", "https?viajd://[\\d\\w\\.:\\-@]*/.*\\.(otrkey|ac3|3gp|7zip|7z|aiff|aif|aifc|au|avi|bin|bz2|ccf|cue|divx|dlc|doc|docx|dot|exe|flv|gif|gz|iso|java|jpg|jpeg|mkv|mp2|mp3|mp4|mov|movie|mpe|mpeg|mpg|msi|msu|nfo|png|pdf|ppt|pptx|pps|ppz|pot|qt|rar|rsdf|rtf|snd|sfv|tar|tif|tiff|viv|vivo|wav|wmv|xla|xls|zip|ts)");
        ...
        new HostPluginWrapper("FileFlyer.com", "FileFlyerCom", "http://[\\w\\.]*?fileflyer\\.com/view/[A-Za-z0-9]+");

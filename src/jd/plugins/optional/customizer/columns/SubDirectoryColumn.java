...
public class SubDirectoryColumn extends JDCheckBoxTableColumn {
    ...
    protected boolean getBooleanValue(Object value) {
        return ((CustomizeSetting) value).isUseSubDirectory();
    }

    @Override
    protected void setBooleanValue(boolean value, Object object) {
        ((CustomizeSetting) object).setUseSubDirectory(value);
    }

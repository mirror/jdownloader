...
public class PackageNameColumn extends JDTableColumn implements ActionListener {
    ...
    public PackageNameColumn(String name, JDTableModel table) {
        ...
        jlr.setToolTipText(JDL.L("jd.plugins.optional.customizer.columns.PackageNameColumn.tooltip", "Leave it empty for default"));
        jlr.setBorder(null);
        text = new JTextField();
        text.setToolTipText(JDL.L("jd.plugins.optional.customizer.columns.PackageNameColumn.tooltip", "Leave it empty for default"));
    }

...
public class Multi implements IExtraction {
     ...
     * 
     * @param file The file from the harddisk.
...
//                }
    ...
    /**
     * Returns the downloadlinks in which the given extracted file is present. Works only with Rar multipart files.
     * 
     * @param path The extracted file.

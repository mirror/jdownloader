...
public class JDChat extends PluginOptional {
    ...
    static {
        try {
            STYLE = IO.readURLToString(Application.getRessourceURL(JDChat.class.getPackage().getName().replace(".", "/") + "/styles.css", false));
        } catch (IOException e) {
            STYLE = "";
            e.printStackTrace();
    ...
    static {
        try {
            USERLIST_STYLE = IO.readURLToString(Application.getRessourceURL(JDChat.class.getPackage().getName().replace(".", "/") + "/userliststyles.css", false));
        } catch (IOException e) {
            USERLIST_STYLE = "";
            e.printStackTrace();

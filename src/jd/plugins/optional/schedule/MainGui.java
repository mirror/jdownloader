...
public class MainGui extends View implements ActionListener, MouseListener {
    ...
    public MainGui(SubConfiguration cfg) {
        ...
        edit = new JButton(JDL.L("plugin.optional.scheduler.edit", "Edit"));
        ...
        close = new JButton(JDL.L("plugin.optional.scheduler.close", "Close"));
    ...
    private class MyTableModel extends AbstractTableModel {
        ...
        public String getColumnName(int column) {
            ...
            case 0:
                return "";
            case 1:
                return JDL.L("plugin.optional.scheduler.column.action.name", "Name");
            case 2:
                return JDL.L("plugin.optional.scheduler.column.action.date", "Date");
            case 3:
                return JDL.L("plugin.optional.scheduler.column.action.time", "Time");
            case 4:
            	return JDL.L("plugin.optional.scheduler.column.action.repeats", "Repeats");
            case 5:
                return JDL.L("plugin.optional.scheduler.column.action.number", "# of actions");
            }
            ...
            switch (columnIndex) {
                ...
                case 4:
                	switch(Schedule.getInstance().getActions().get(rowIndex).getRepeat()) {
                		case 0:
                			return JDL.L("plugin.optional.scheduler.add.once", "Only once");
                		case 60:
                			return JDL.L("plugin.optional.scheduler.add.hourly", "Hourly");
                		case 1440:
                			return JDL.L("plugin.optional.scheduler.add.daily", "Daily");
                		case 10080:
                			return JDL.L("plugin.optional.scheduler.add.weekly", "Weekly");
                		default:
                			int hour = Schedule.getInstance().getActions().get(rowIndex).getRepeat() / 60;
                			return JDL.LF("plugin.optional.scheduler.add.interval", "Interval: %sh %sm", hour,  Schedule.getInstance().getActions().get(rowIndex).getRepeat()-(hour*60));
                	}
                case 5:
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == add) {
        	...
        	JDGui.getInstance().disposeView(this);
        }
    }
	...
	public String getTitle() {
		return JDL.L("plugin.optional.scheduler.title", "Scheduler");
	}

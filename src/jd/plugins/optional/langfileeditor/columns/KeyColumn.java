...
public class KeyColumn extends JDTableColumn implements ActionListener {

    private static final long serialVersionUID = -2305836770033923728L;
    private JRendererLabel jlr;
    private JTextField text;

    public KeyColumn(String name, JDTableModel table) {
        super(name, table);
    ...
    public Component myTableCellEditorComponent(JDTableModel table, Object value, boolean isSelected, int row, int column) {
        ...
        text.setText(((KeyInfo) value).getKey());
    ...
    public Component myTableCellRendererComponent(JDTableModel table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        jlr.setText(((KeyInfo) value).getKey());
        return jlr;
    }

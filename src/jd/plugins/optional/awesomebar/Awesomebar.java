...
public class Awesomebar extends JFrame {
				...
				public void keyPressed(java.awt.event.KeyEvent e) {
					...
					if (e.getKeyChar() != KeyEvent.CHAR_UNDEFINED) {
						if (e.getKeyCode() == KeyEvent.VK_ENTER) {
							...
							awesome.requestProposal(getJTextField().getText().substring(0, getJTextField().getCaretPosition()) + e.getKeyChar()
									+ getJTextField().getText().substring(getJTextField().getCaretPosition()));
						} else {
							if (getJTextField().getCaretPosition() > 0) {
								awesome.requestProposal(getJTextField().getText().substring(0, getJTextField().getCaretPosition() - 1)
										+ getJTextField().getText().substring(getJTextField().getCaretPosition()));
							}
						}
					} else {

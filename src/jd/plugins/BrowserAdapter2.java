 ...
 *
 */
public class BrowserAdapter2 {

    public static class BrowserAdapter {

        public static final int ERROR_REDIRECTED = -1;

        private DownloadInterface getDownloadInterface(Downloadable downloadable, Request request, boolean resumeEnabled, int chunksCount) throws Exception {

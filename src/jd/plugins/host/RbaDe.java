...
public class RbaDe extends PluginForHost{
	...
	/*
	private static final String REGEX_DOWNLOADLINK1		= "<tr><td><a href='download\\.php\\?FILE=\\d+-2\\.mp3&amp;PATH=\\d'>Runde 1 hin</a></td>";
	private static final String REGEX_DOWNLOADLINK2		= "<tr><td><a href='download\\.php\\?FILE=\\d+-5\\.mp3&amp;PATH=\\d'>Runde 2 hin</a></td>";
	private static final String REGEX_DATUMSANGABE1		= "<td>\\d+\\.\\d+\\.\\d+ \\d+:\\d+:\\d+\\.\\d+</td>";
	private static final String REGEX_DATUMSANGABE2		= "<td>\\d+\\.\\d+\\.\\d+ \\d+:\\d+:\\d+</td>";
	*/
	private static final String REGEX_NICKNAME			= "<td>(.+?)</td><td>\\d+</td></tr>";
	
	//private static final Pattern REGEX_HERAUSFORDERER 	= Pattern.compile(REGEX_DOWNLOADLINK1+"\\s+?"+REGEX_DATUMSANGABE1+"|"+REGEX_DATUMSANGABE2+"\\s+?"+REGEX_NICKNAME, Pattern.CASE_INSENSITIVE|Pattern.LITERAL);
	//private static final Pattern REGEX_GEGNER 			= Pattern.compile(REGEX_DOWNLOADLINK2+"\\s+?"+REGEX_DATUMSANGABE1+"|"+REGEX_DATUMSANGABE2+"\\s+?"+REGEX_NICKNAME, Pattern.MULTILINE);
	...
	//<tr><td><a href='download.php?FILE=45529-2.mp3&amp;PATH=5'>Runde 1 hin</a></td>
	//<tr><td><a href='download.php?FILE=4217-2.mp3&amp;PATH=5'>Runde 1 hin</a></td>
	...
	public static void main(String[] args) {
		System.out.println("<td>JackPod</td><td>138</td></tr>".matches("<td>(\\w+)</td><td>\\d+</td></tr>"));
		//System.out.println("<tr><td><a href='download.php?FILE=45529-2.mp3&amp;PATH=5'>Runde 1 hin</a></td>".matches(REGEX_DOWNLOADLINK1));
		//System.out.println("<td>26.08.2002 18:41:49</td>".matches(REGEX_DATUMSANGABE2));
		//System.out.println("<td>JackPod</td><td>121</td></tr>".matches(REGEX_NICKNAME));
		RbaDe rba = new RbaDe();
		DownloadLink dl = new DownloadLink(null, null, "r-b-a.de", Encoding.htmlDecode("http://www.r-b-a.de/download.php?FILE=4217-2.mp3&PATH=5"), true);
		//System.out.println(dl.getDownloadURL());
		//rba.getFileInformation(dl);
		try {
			System.out.println(rba.getFileInformation(dl));
			//rba.handleFree(dl);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		//System.out.println("<tr><td><a href='download.php?FILE=4217-2.mp3&amp;PATH=5'>Runde 1 hin</a></td>\n<td>26.08.2002 18:41:49</td>\n<td>Abdel</td><td>2009</td></tr>".matches("" +
		//		REGEX_HERAUSFORDERER));	
	}*/
	...
	public boolean getFileInformation(DownloadLink link) {
		...
		try {
			...
			//String herausforderer = new Regex(page, REGEX_HERAUSFORDERER).getFirstMatch();
	...
	public void handleFree(DownloadLink link) throws Exception {
        ...
        /*
        String header;
		logger.finer("Überprüfe Headerfled - \"Conten-Type\"! URL: --> "+ link.getDownloadURL());
		if ((header=br.openGetConnection(link.getDownloadURL()).getHeaderField("Content-Type"))!=null&&header.equals("application/octetstream")) {

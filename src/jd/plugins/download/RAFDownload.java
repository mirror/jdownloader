...
public class RAFDownload extends OldRAFDownload {
    ...
    private Downloadable createInterface(final DownloadLink downloadLink) {
        return new Downloadable() {
            ...
            private DownloadPluginProgress downloadPluginProgress;
            ...
            public void setFilesizeCheck(boolean b) {
                downloadLink.setProperty(PROPERTY_DOFILESIZECHECK, b);
            }
            ...
            public boolean isDoFilesizeCheckEnabled() {
                return downloadLink.getBooleanProperty(PROPERTY_DOFILESIZECHECK, true);
            }

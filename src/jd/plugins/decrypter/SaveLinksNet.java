...
urls = { "http://(www\\.)?linkshield\\.org/(p|d)/[a-z0-9]+", "http://(www\\.)?safelink\\.strike-up\\.net/(p|d)/[a-z0-9]+", "http://(www\\.)?dwnlinks\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?oxyl\\.me/(p|d)/[a-z0-9]+", "http://(www\\.)?linkguard\\.in/(p|d)/[a-z0-9]+", "http://(www\\.)?linkpacking\\.net/(p|d)/[a-z0-9]+", "http://(www\\.)?doridroz\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?resumable\\-link\\.info/(p|d)/[a-z0-9]+", "http://(www\\.)?kids\\-funclub\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?noor7\\.me/(p|d)/[a-z0-9]+", "http://(www\\.)?trollbridge\\.org/(p|d)/[a-z0-9]+", "http://(www\\.)?mylinks\\.asia/(p|d)/[a-z0-9]+", "http://(www\\.)?wicket99\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?safelinks\\.fr/(p|d)/[a-z0-9]+", "http://(www\\.)?t9c\\.de/(p|d)/[a-z0-9]+", "http://(www\\.)?gamezine\\.info/(p|d)/[a-z0-9]+", "http://(www\\.)?deni1743\\-safelink\\.tk/(p|d)/[a-z0-9]+",

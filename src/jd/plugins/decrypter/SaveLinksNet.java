...
names = { "dwnlinks.com", "oxyl.me", "linkguard.in", "linkpacking.net", "doridroz.com", "resumable-link.info", "kids-funclub.com", "noor7.me", "trollbridge.org", "mylinks.asia", "wicket99.com", "safelinks.fr", "t9c.de", "gamezine.info", "deni1743-safelink.tk", "moesubs.tk", "backdoor.ir", "uniquerelink.com", "lulusafe.tk", "doujinlinks.org", "matthy.tk", "hydelink.in", "safelinking.biz", "securelinking.tk", "urlshrtnr.com", "uniquerelink.com", "filedp.com", "keepyourlinkssafe.com", "7pz.com", "safemylink.net", "mway.tk", "url-shortener.info", "rgf.me", "720pm.com", "javaddiction.us", "hidemylinks.net", "r4dm.com", "savelinks.net" },

urls = { "http://(www\\.)?dwnlinks\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?oxyl\\.me/(p|d)/[a-z0-9]+", "http://(www\\.)?linkguard\\.in/(p|d)/[a-z0-9]+", "http://(www\\.)?linkpacking\\.net/(p|d)/[a-z0-9]+", "http://(www\\.)?doridroz\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?resumable\\-link\\.info/(p|d)/[a-z0-9]+", "http://(www\\.)?kids\\-funclub\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?noor7\\.me/(p|d)/[a-z0-9]+", "http://(www\\.)?trollbridge\\.org/(p|d)/[a-z0-9]+", "http://(www\\.)?mylinks\\.asia/(p|d)/[a-z0-9]+", "http://(www\\.)?wicket99\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?safelinks\\.fr/(p|d)/[a-z0-9]+", "http://(www\\.)?t9c\\.de/(p|d)/[a-z0-9]+", "http://(www\\.)?gamezine\\.info/(p|d)/[a-z0-9]+", "http://(www\\.)?deni1743\\-safelink\\.tk/(p|d)/[a-z0-9]+", "http://(www\\.)?moesubs\\.tk/(p|d)/[a-z0-9]+", "http://(www\\.)?backdoor\\.ir/(p|d)/[a-z0-9]+",
        "http://(www\\.)?uniquerelink\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?lulusafe\\.tk/(p|d)/[a-z0-9]+", "http://(www\\.)?doujinlinks\\.org/(p|d)/[a-z0-9]+", "http://(www\\.)?matthy\\.tk/(p|d)/[a-z0-9]+", "http://(www\\.)?hydelink\\.in/(p|d)/[a-z0-9]+", "http://(www\\.)?safelinking\\.biz/(p|d)/[a-z0-9]+", "http://(www\\.)?securelinking\\.tk/(p|d)/[a-z0-9]+", "http://(www\\.)?urlshrtnr\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?uniquerelink\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?filedp\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?keepyourlinkssafe\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?7pz\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?safemylink\\.net/(p|d)/[a-z0-9]+", "http://(www\\.)?mway\\.tk/(p|d)/[a-z0-9]+", "http://(www\\.)?url\\-shortener\\.info/(p|d)/[a-z0-9]+", "http://(www\\.)?rgf\\.me/(p|d)/[a-z0-9]+", "http://(www\\.)?720pm\\.com/(p|d)/[a-z0-9]+",
        "http://(www\\.)?javaddiction\\.us/(p|d)/[a-z0-9]+", "https?://(www\\.)?hidemylinks\\.net/(p|d)/[a-z0-9]+", "https?://(www\\.)?r4dm\\.com/(p|d)/[a-z0-9]+", "http://(www\\.)?savelinks\\.net/(p|d)/[a-z0-9]+" },

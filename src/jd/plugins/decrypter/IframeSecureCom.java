...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "iframe-secure.com" }, urls = { "https?://(?:www\\.)?iframe\\-secure\\.com/embed/[a-z0-9]+" })
public class IframeSecureCom extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        // br.getHeaders().put("Referer", "http://www.iframe-secure.com/embed/" + fid);

...
public class Srnnks extends PluginForDecrypt {
	...
	private SrnnksLinks createdl(String parameter, String[] info) {
		...
		SrnnksLinks dlink = new SrnnksLinks(linkName, hostname,
	...
	private ArrayList<SrnnksLinks> decryptItMain(CryptedLink param)
			throws Exception {
					...
					if (wh != null) {
						...
						if (!got) {
							for (String element : links) {
								String[] info = getLinkName(element,
										lastHtmlCode);
								SrnnksLinks dl_link = createdl(element,
										info);
								decryptedLinks.add(dl_link);
								break;
	...
	private class SrnnksThread extends Thread {
		...
		public SrnnksThread(SrnnksLinks downloadLink,
	...
	private class SrnnksLinks {
		...
		public SrnnksLinks(String name, String host, long size,
		...
		private void initGUI() {
			...
			btnOK.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					useScat = new int[] {
							((SrnnksMeth) methods.getSelectedItem()).var,

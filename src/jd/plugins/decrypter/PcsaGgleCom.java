...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "picasaweb.google.com" }, urls = { "http://[\\w\\.]*?picasaweb\\.google\\.com/.*?/.*?(\\?feat=(featured#[0-9]+|featured#)|#[0-9]+|#)" }, flags = { 0 })

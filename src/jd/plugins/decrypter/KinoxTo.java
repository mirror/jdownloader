...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "kinox.to" }, urls = { "https?://(?:www[0-9]*\\.)?kino[xyzs]\\.(?:am|cloud|fun|fyi|gratis|io|lol|me|mobi|nu|pe|sg|sh|si|sx|to|tv|wtf)/Stream/[A-Za-z0-9\\-_]+\\.html" })

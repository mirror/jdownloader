...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "israbox.com" }, urls = { "http://[\\w\\.]*israbox\\.(com|net|org|info|me)/[0-9]+-.*?\\.html" }, flags = { 0 })
public class SrBoxCom extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        if (br.containsHTML("(An error has occurred|The article cannot be found)") || "http://www.israbox.me/".equals(br.getRedirectLocation()) || "http://www.israbox.info/".equals(br.getRedirectLocation()) || "http://www.israbox.org/".equals(br.getRedirectLocation()) || "http://www.israbox.net/".equals(br.getRedirectLocation()) || "http://www.israbox.com/".equals(br.getRedirectLocation())) {
            try {
        ...
        if (TabImage2.length == 0) {
            TabImage1 = br.getRegex("<img src=\"(http://[\\w\\.]*?israbox\\.(com|net|org|info|me))*?/uploads(.*?)\"").getColumn(2);
            TabNet = br.getRegex("<img src=\"(http://[\\w\\.]*?israbox\\.(com|net|org|info|me))*?/uploads(.*?)\"").getColumn(1);
        }
        ...
        String[] linksCrypted = br.getRegex("\"(http://www\\.israbox\\.(com|net|org|info|me)/engine/go\\.php\\?url=.*?)\"").getColumn(0);
    ...
    protected DownloadLink createDownloadlink(String link, Boolean bVerify) {
        ...
        if (link.startsWith("http://www.israbox.com/uploads/img/") || link.startsWith("http://www.israbox.net/uploads/img/") || link.startsWith("http://www.israbox.org/uploads/img/") || link.startsWith("http://www.israbox.info/uploads/img/") || link.startsWith("http://www.israbox.me/uploads/img/")) {
            return null;
        }
        ...
        if (bVerify && (link.startsWith("http://www.israbox.com") || link.startsWith("http://www.israbox.net") || link.startsWith("http://www.israbox.org") || link.startsWith("http://www.israbox.info") || link.startsWith("http://www.israbox.me"))) {
            return null;
        }

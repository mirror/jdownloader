...
public class SflnkgNt extends abstractSafeLinking {
    ...
    public static String[] getAnnotationNames() {
        return new String[] { "linkvault.pro", "rawfile.co", "3download.safelinking.net", "deni1743-safelink.tk", "cryptit.so", "jessica.suyalynx.com", "linkler.us", "links.sceper.ws", "nexushd2urlprotector.tytung.com", "nsad.xcarlos.safelinking.net", "r4dm.com", "protect.mmportal.info", "safe.linkninja.net", "safe.dlinks.info", "safelinking.net", "safelinking.com", "safelinking.mobi", "vault.vhsclub.com", "yls.re", "sflk.in" };

...
//EmbedDecrypter 0.1.7
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "nudeamateurgirls.net" }, urls = { "http://(www\\.)?nudeamateurgirls\\.net/vids/vid/\\d{4}/[^<>\"/]*?\\.html" }, flags = { 0 })
public class NudeAmateurGirlsNet extends PluginForDecrypt {

    public NudeAmateurGirlsNet(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        if (br.containsHTML("<title> \\| nudeamateurgirls\\.net</title>")) {

...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "openloadtvstream.me" }, urls = { "https?://(www\\.)?(openloadtvstream\\.me|clipwatching\\.me)/(tvshows|movies|episodes)/.+" })

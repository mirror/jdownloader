            ...
            if (fpName == null) {
                ...
                if (fpName == null) {
                    ...
                    if (fpName == null) {
                        ...
                        } else if (parameter.matches(".+usersfiles\\.com/.+")) {

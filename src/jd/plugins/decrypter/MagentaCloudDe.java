...
@DecrypterPlugin(revision = "$Revision: 33293 $", interfaceVersion = 3, names = { "magentacloud.de" }, urls = { "https?://(www\\.)?magentacloud\\.de/(share|lnk)/[a-z0-9\\-]+" }, flags = { 32 })
public class MagentaCloudDe extends PluginForDecrypt {

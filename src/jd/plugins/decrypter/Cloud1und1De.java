...
@DecrypterPlugin(revision = "$Revision: 33293 $", interfaceVersion = 3, names = { "cloud.1und1.de" }, urls = { "https?://cloud\\.1und1\\.de/ngcloud/external\\?.*?guestToken=[a-zA-Z0-9\\-]{22}(&loginName=\\d+)?" }) public class Cloud1und1De extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink parameter, ProgressController progress) throws Exception {
        ...
        final Map<String, Object> premiumizeNodes = JSonStorage.restoreFromString(br2.toString(), TypeRef.HASHMAP, null);
        final Map<String, Object> ui_fs = (Map<String, Object>) premiumizeNodes.get("ui:fs");
        final String name = (String) ui_fs.get("name");

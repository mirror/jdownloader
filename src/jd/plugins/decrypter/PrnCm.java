...
@DecrypterPlugin(revision = "$Revision: 7139 $", interfaceVersion = 2, names = { "youporn.com" }, urls = { "http://[\\w\\.]*?youporn\\.com/watch/\\d+/?.+/?"}, flags = { 0 })


public class PrnCm extends PluginForDecrypt {

    public PrnCm(PluginWrapper wrapper) {
        super(wrapper);
    }

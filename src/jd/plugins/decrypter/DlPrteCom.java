 ...
 * @author raztoki, psp
 */
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "dl-protecte.com" }, urls = { "https?://(?:www(|[0-9])\\.)?(?:dl-protecte\\.(?:com|org)|protect-lien\\.com|protect-zt\\.com|zt-protect\\.com|protecte-link\\.com|liens-telechargement\\.com|dl-protect1\\.com?|dl-protect\\.top|dl\\-protect\\.net|dl-protect\\.best|dl-protect\\.info|dl-protect\\.one|(zone-warez|zone-telechargement|tirexo)\\.(?:.*)/link)(-|/)\\S+" })
public class DlPrteCom extends antiDDoSForDecrypt {
    @Override
    public String[] siteSupportedNames() {
        return new String[] { "dl-protect.top", "dl-protecte.com", "dl-protecte.org", "protect-lien.com", "protect-zt.com", "zt-protect.com", "protecte-link.com", "liens-telechargement.com", "dl-protect1.com", "dl-protect1.co", "dl-protect.net", "zone-warez.com", "dl-protect.best", "dl-protect-info", "dl-protect.one" };
    }

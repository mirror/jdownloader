...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "pornpics.com" }, urls = { "https?://(?:www\\.)?pornpics\\.com/galleries/.+" })
public class PornPicsComGallery extends PluginForDecrypt {
    public PornPicsComGallery(PluginWrapper wrapper) {
        super(wrapper);
    }

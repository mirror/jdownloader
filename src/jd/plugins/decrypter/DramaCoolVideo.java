...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "dramacool.video" }, urls = { "https?://(?:www\\\\d*\\.)?(?:dramacool\\d*\\.(video|movie|so|link|vc)|watchasian\\.vc)/(?:.+\\.html?|drama-detail/.+)" })

...
public class FlickrCom extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        /* Old code, last change 03.12.2014 */
        ...
        if (br.containsHTML("var photo = \\{")) {
            ...
            for (int i = 1; i <= lastPage; i++) {
                ...
                final String[] regexes = { "data\\-track=\"photo\\-click\" href=\"(/photos/[^<>\"\\'/]+/\\d+)", "<a class=\"ui\\-bottom\\-gradient\" href=\"(/photos/[^<>\"\\'/]+/\\d+)" };

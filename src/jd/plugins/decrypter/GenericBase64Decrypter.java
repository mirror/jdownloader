 ...
 *
 */
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "playercdn.com", "yourporntube.com", "gfxxtra.com", "manteb.in", "djurl.com", "hbrowse.com", "free.downloader.my", "saylicadebrid.tk", "binbox.io", "re-direcciona.me", "mediaboom.org", "bookgn.com", "vip-files.net", "tunesies.com", "xtragfx.com", "psdkeys.com", "asianspankee.com" }, urls = { "https?://(?:www\\.)?playercdn\\.com/ec/[a-z0-9]+\\.php\\?[^/]*?\\&url=([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:www\\.)?yourporntube\\.com/video/\\?id=([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:www\\.)?(?:gfxxtra\\.com|gftxra\\.net)/engine/go\\.php\\?url\\=([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:\\w+\\.)?manteb\\.in/\\?go=([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:\\w+\\.)?djurl\\.com/\\?r=([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:\\w+\\.)?hbrowse\\.com/redirect/([a-zA-Z0-9_/\\+\\=\\-%]+)",
        ...
        "http://(?:www\\.)?asianspankee\\.com/.*\\?goto=([a-zA-Z0-9_/\\+\\=\\-%]+)" })

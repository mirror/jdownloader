...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "asianspankee.com", "tinymoviez.info", "re-direcciona.me", "asianspankee.com", "mediaboom.org", "bookgn.com", "vip-files.net", "url4u.org", "tunesies.com", "xtragfx.com", "psdkeys.com" },

urls = { "http://(www\\.)?asianspankee\\.com/.+\\?goto=[a-zA-Z0-9_/+=-%]+", "http://(www\\.)?tinymoviez\\.info/download\\.php\\?link=[a-zA-Z0-9_/\\+\\=\\-]+", "http://(www\\.)?re-direcciona\\.me/(I|r)/[A-Za-z0-9=]+", "http://asianspankee\\.com/\\?goto=[A-Za-z0-9=%]+", "http://(www\\.)?mediaboom\\.org/engine/go\\.php\\?url=[A-Za-z0-9=%]+", "http://(www\\.)?bookgn\\.com/engine/go\\.php\\?url=[A-Za-z0-9=%]+", "http://(www\\.)?vip\\-files\\.net/download\\.php\\?e=[A-Za-z0-9=%]+", "http://www\\.url4u\\.org/[A-Za-z0-9=%]+", "https?://(www\\.)?tunesies\\.com/go/[a-zA-Z0-9_/\\+\\=\\-]+", "https?://(www\\.)?xtragfx\\.com/engine/go\\.php\\?url=[A-Za-z0-9=%]+", "https?://(www\\.)?psdkeys\\.com/engine/go\\.php\\?url=[A-Za-z0-9=%]+" },

...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "RnB4U.in" }, urls = { "http://[\\w\\.]*?rnb4u\\.in/download\\.php\\?action=kategorie&kat_id=\\d+|http://[\\w\\.]*?rnb4u\\.in/download\\.php\\?action=popup&kat_id=\\d+&fileid=\\d+"}, flags = { 0 })

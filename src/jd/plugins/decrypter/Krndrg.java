...
@DecrypterPlugin(revision = "$Revision: 7139 $", interfaceVersion = 2, names = { "joke-around.org" }, urls = { "http://[\\w\\.]*?joke-around\\.org/.+"}, flags = { 0 })


public class Krndrg extends PluginForDecrypt {

    public Krndrg(PluginWrapper wrapper) {
        super(wrapper);
    }

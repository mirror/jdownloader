...
@DecrypterPlugin(revision = "$Revision: 7185 $", interfaceVersion = 2, names = { "cryptlink.ws" }, urls = { "http://[\\w\\.]*?cryptlink\\.ws/\\?file=[\\w]+|http://[\\w\\.]*?cryptlink\\.ws/crypt\\.php\\?file=[0-9]+"}, flags = { 0 })

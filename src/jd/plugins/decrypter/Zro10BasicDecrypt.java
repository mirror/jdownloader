...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "save-link.info" }, urls = { "https?://(?:www\\.)?(?:links-secure\\.com|save-link\\.info|share-link\\.info|h-link\\.us|foxmoviez\\.com|zmelody\\.com|filmey\\.co|dualmarket\\.info|wwenews\\.us|[a-z0-9]+\\.arabseed\\.com)/[0-9]+" })
public class Zro10BasicDecrypt extends PluginForDecrypt {
    ...
    public String[] siteSupportedNames() {
        return new String[] { "links-secure.com", "save-link.info", "share-link.info", "h-link.us", "forexurls.net", "zmelody.com", "foxmoviez.com", "filmey.co", "dualmarket.info", "wwenews.us", "arabseed.com" };
    }

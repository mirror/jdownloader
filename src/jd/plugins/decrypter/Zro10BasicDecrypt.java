...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "links-secure.com" }, urls = { "https?://(?:www\\.)?(?:links-secure\\.com|h-link\\.us|filmey\\.co|wwenews\\.us)/[0-9]+" })
public class Zro10BasicDecrypt extends PluginForDecrypt {
    ...
    public String[] siteSupportedNames() {
        return new String[] { "links-secure.com", "h-link.us", "filmey.co", "wwenews.us" };
    }

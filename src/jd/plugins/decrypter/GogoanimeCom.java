...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "gogoanime.com" }, urls = { "http://(www\\.)?gogoanime\\.com/(?!category|thumbs|sitemap|img|xmlrpc|fav|images)[a-z0-9\\-_]+(/\\d+)?" }, flags = { 0 })

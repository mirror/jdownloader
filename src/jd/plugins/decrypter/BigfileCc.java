...
public class BigfileCc extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(final CryptedLink param, ProgressController progress) throws Exception {
        ...
        final String[] htmls = br.getRegex("class=\"urlfile\".*?</noindex></td></tr>").getColumn(-1);
        for (final String html : htmls) {
            final String fname = new Regex(html, "class=\"urlfile\">([^<]+)<").getMatch(0);
            final String fsize = new Regex(html, "<td style=\"font-size:70%;\"[^>]*>(\\d+[^<]+)<").getMatch(0);
            final String url = new Regex(html, "data-link=\"(https?://[^\"]*/d/[^\"]+)\".*?$").getMatch(0);

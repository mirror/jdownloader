...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "hide-my.link", "linkdecode.com", "lienscash.com", "cli.gs", "hulkshare.biz", "is.gd", "djurl.com", "umhq.net", "madlink.sk", "lnx.lu", "handsupbr.com", "mkv2.info", "searchonzippy.eu", "sharmota.com", "allsubs.org", "komp3.net", "url.bilgiportal.com", "hflix.in", "hnzoom.com", "basemp3.ru", "stream2k.eu", "leechmf.com", "protetorbr.com", "lezlezlez.com", "dwz.cn", "guardlink.org", "q32.ru", "icefilms.info", "unlimfiles.com", "adfoc.us", "egfire.net", "damasgate.com", "freeonsmash.com", "lnk.co", "trackstash.com", "myurl.in", "h-url.in", "filep.info", "grou.ps", "linkexterno.com", "eskimotube.com", "m4u.in", "4p5.com", "telona.biz", "href.hu", "migre.me", "altervista.org", "agaleradodownload.com", "link.songs.pk + songspk.info", "clubteam.eu", "jforum.uni.cc", "deurl.me", "yourfileplace.com", "muzgruz.ru",
        "zero10.net", "aiotool.net", "chip.de/c1_videos", "nbanews.us", "top2tech.com", "1tool.biz", "file4ever.us", "zero10.net and gamz.us", "official.fm", "academicearth.org", "tm-exchange.com", "adiarimore.com", "mafia.to", "view.stern.de", "warcraft.ingame.de", "mixconnect.com", "twiturm.com", "ebooksdownloadfree.com", "freebooksearcher.info", "mp3.wp.pl", "gantrack.com" },
...
public class DecrypterForRedirectServicesWithoutDirectRedirects extends antiDDoSForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(final CryptedLink param, final ProgressController progress) throws Exception {
        ...
        try {
            if (!parameter.contains("1tool.biz") && !parameter.contains("file4ever.us") && !parameter.contains("tm-exchange.com/") && !parameter.contains("mixconnect.com/") && !parameter.contains("dwz.cn/") && !parameter.contains("icefilms.info/")) {

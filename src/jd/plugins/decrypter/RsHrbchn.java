...
@DecrypterPlugin(revision = "$Revision: 7185 $", interfaceVersion = 2, names = { "rs.hoerbuch.in" }, urls = { "http://rs\\.hoerbuch\\.in/com-[\\w]{11}/.*|http://rs\\.hoerbuch\\.in/de-[\\w]{11}/.*|http://rs\\.hoerbuch\\.in/u[\\w]{6}.html"}, flags = { 0 })

...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "av-th.info" }, urls = { "https?://(?:www\\.)?av-th\\.info/(?:f|v)/([a-zA-Z0-9_-]+)" })
public class Jav extends PluginForDecrypt {
    public Jav(PluginWrapper wrapper) {
        super(wrapper);
    }

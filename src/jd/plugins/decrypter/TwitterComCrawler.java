...
public class TwitterComCrawler extends PluginForDecrypt {
    ...
    private ArrayList<DownloadLink> crawlSingleTweetViaGraphqlAPI(final Account account, final String username, final String tweetID) throws Exception {
        ...
        if (preferNewWay20230811) {
            ...
            final Map<String, Object> entries = restoreFromString(br.getRequest().getHtmlCode(), TypeRef.MAP);
            Map<String, Object> tweetMap = (Map<String, Object>) JavaScriptEngineFactory.walkJson(entries, "data/tweetResult/result/legacy");
            if (tweetMap == null) {
                /* 2023-09-21 */
                tweetMap = (Map<String, Object>) JavaScriptEngineFactory.walkJson(entries, "data/tweetResult/result/tweet/legacy");
            }
            if (tweetMap == null) {

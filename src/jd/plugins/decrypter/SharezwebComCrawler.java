...
import jd.plugins.hoster.SharezwebCom;

@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 3, names = {}, urls = {})
@PluginDependencies(dependencies = { SharezwebCom.class })
public class SharezwebComCrawler extends PluginForDecrypt {
    public SharezwebComCrawler(PluginWrapper wrapper) {
        super(wrapper);
    }

    public static List<String[]> getPluginDomains() {
        return SharezwebCom.getPluginDomains();
    }

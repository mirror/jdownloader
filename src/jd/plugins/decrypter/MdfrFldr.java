            ...
            if (Boolean.TRUE.equals(isFile)) {
                ...
                if (folder_count != null && (foldersNum = Long.parseLong(folder_count)) > 0) {
                    for (int i = 1; i <= 100; i++) {
                        ...
                        if (subFolders == null || subFolders.length < 100) break;
                    }
                }

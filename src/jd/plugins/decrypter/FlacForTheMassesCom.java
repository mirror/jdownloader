...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "flacforthemasses.com" }, urls = { "https?://flacforthemasses\\.(com|org)/node/\\d+" }, flags = { 0 })
public class FlacForTheMassesCom extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        final String parameter = param.toString().replace("flacforthemasses.com/", "flacforthemasses.org/");
        ...
        final String linktext = br.getRegex("class=\"download-links transition\"(.*?)/i></strong></p>").getMatch(0);

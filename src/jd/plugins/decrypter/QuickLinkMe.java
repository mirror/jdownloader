...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "quicklink.me" }, urls = { "http://[\\w\\.]*?quicklink\\.me/\\?l=[\\w]+"}, flags = { 0 })


public class QuickLinkMe extends PluginForDecrypt {

    public QuickLinkMe(PluginWrapper wrapper) {
        super(wrapper);
    }

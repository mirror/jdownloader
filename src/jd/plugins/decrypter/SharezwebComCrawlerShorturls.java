...
public class SharezwebComCrawlerShorturls extends PluginForDecrypt {
    public SharezwebComCrawlerShorturls(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public ArrayList<DownloadLink> decryptIt(final CryptedLink param, ProgressController progress) throws Exception {
        ...
        if (type.equals("f")) {
            ...
            ret.add(createDownloadlink("https://www.sharezweb.com/a/f/" + ressourceID));
        } else {
            ret.add(createDownloadlink(SharezwebComCrawler.createFolderURL(ressourceID, null)));
        }
        return ret;
    }
}

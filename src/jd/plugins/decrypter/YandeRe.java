...
public class YandeRe extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        final String tagname = new Regex(parameter, "tags=(.+)").getMatch(0);
        final String fpName = tagname;
        ...
        int page_counter = 1;
        int offset = 0;
        final int min_entries_per_page = 14;
        ...
        do {
            ...
            if (page_counter > 1) {
                this.br.getPage("https://yande.re/post?tags=" + tagname + "&page=" + page_counter);
            }
            ...
            for (final String linkid : linkids) {
                final String link = "https://" + this.getHost() + "/post/show/" + linkid;

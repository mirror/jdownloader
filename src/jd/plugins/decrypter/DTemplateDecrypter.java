...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "DTemplateDecrypter" }, urls = { "http://(www\\.)?(cloudyload\\.com|filebeer\\.info|speedload\\.org)/(\\d+~f|[A-Za-z0-9]+)" }, flags = { 0 })

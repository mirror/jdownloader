...
names = { "sht.io", "afl.to", "noref.co", "led.wf", "vk.cc", "somosmovies.com", "smv.tv", "ligman.me", "feedproxy.google.com", "cur.bz", "awe.sm", "pip.bz", "ovh.to", "po.st", "share-films.net", "fburls.com", "mblink.info", "shrk.biz", "go.madmimi.com", "alturl.com", "click.tf", "ssh.yt", "rapidsky.net", "yhoo.it", "proton.biz", "smarturl.it", "westernlink.co", "sharingdb.com", "ift.tt", "share.wf", "urlm.in", "cutmy.name", "tinyw.in", "baidu.com", "sharedpartners.com", "relink.ws", "clck.ru", "youtu.be", "readthis.ca", "redirects.ca", "goshrink.com", "clickthru.ca", "atu.ca", "easyurl.net", "redirect.wayaround.org", "rurl.org", "tinyurl.com", "smarturl.eu", "rln.me", "sp2.ro", "ow.ly", "bit.ly", "maticulo.us", "trib.al", "ab.co", "vb.ly", "ponyurl.com", "budurl.com", "yep.it", "tra.kz", "tiny.pl", "linkth.at", "moourl.com", "ri.ms", "gelen.org", "pettyurl.com", "9mmo.com",
        ...
        "http://[\\w\\.]*?alturl\\.com/[a-z0-9]+", "http://click\\.tf/[a-zA-Z0-9]{8}", "http://(?:www\\.)?ssh\\.yt/[a-zA-Z0-9]+", "http://(www\\.)?rapidsky\\.net/[A-Za-z0-9]+", "https?://(www\\.)?yhoo\\.it/[\\w]+", "https?://(\\w\\.)?proton\\.biz/aralara\\.php\\?link=[a-z0-9]+", "http://[\\w\\.]*smarturl\\.it/[A-Za-z0-9]+", "http://[\\w\\.]*westernlink\\.co/l/[A-Za-z0-9]+", "http://[\\w\\.]*sharingdb\\.com/[a-z0-9]+", "http://(www\\.)?ift\\.tt/[a-zA-Z0-9]+", "http://(www\\.)?share\\.wf/[A-Za-z0-9]+", "https?://(www\\.)?urlm\\.in/[a-zA-Z0-9]+", "http://(www\\.)?cutmy\\.name/(?!#|.+\\.php)(u/[a-f0-9]{6,8}|[a-z0-9]+)", "https?://(www\\.)?tinyw\\.in/[a-zA-Z0-9]+", "http://(www\\.)?baidu\\.com/link\\?url=[A-Za-z0-9\\-_]+", "http://(www\\.)?sharedpartners\\.com/in/\\d+/\\d+", "http://(www\\.)?relink\\.ws/[A-Za-z0-9]+", "http://(www\\.)?clck\\.ru/(d/[A-Za-z0-9\\-_]+|[A-Za-z0-9\\-_]+)",

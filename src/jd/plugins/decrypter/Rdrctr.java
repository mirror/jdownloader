...
urls = { "http://(?:www\\.)?ligman\\.me/[A-Za-z0-9]+", "https?://feedproxy\\.google\\.com/~r/.+", "http://cur\\.bz/[A-Za-z0-9]+", "http://(www\\.)?awe\\.sm/[A-Za-z0-9]+", "http://(www\\.)?pip\\.bz/[A-Za-z0-9\\-]+", "http://(www\\.)?ovh\\.to/[A-Za-z0-9]+", "http://(www\\.)?po\\.st/[A-Za-z0-9]+", "http://(www\\.)?share-films\\.net/redirect\\.php\\?url=[a-z0-9]+", "http://(www\\.)?fburls\\.com/\\d+\\-[A-Za-z0-9]+", "http://(www\\.)?umquetenha\\.org/protecao/resolve\\.php\\?link=.{2,}", "http://(www\\.)?mblink\\.info/\\?id=\\d+", "https?://t\\.co/[a-zA-Z0-9]+", "http://(de\\.)?shrk\\.biz/\\w+", "https?://go\\.madmimi\\.com/redirects/[a-zA-Z0-9]+\\?pa=\\d+", "http://[\\w\\.]*?alturl\\.com/[a-z0-9]+", "http://click\\.tf/[a-zA-Z0-9]{8}", "http://(?:www\\.)?ssh\\.yt/[a-zA-Z0-9]+", "http://(www\\.)?rapidsky\\.net/[A-Za-z0-9]+", "https?://(www\\.)?yhoo\\.it/[\\w]+",
        ...
        "http://[\\w\\.]*f5y\\.info/[a-zA-Z-]+", "http://[\\w\\.]*starturl\\.com/[a-z_]+", "http://[\\w\\.]*2s8\\.org/[0-9a-z]+", "http://[\\w\\.]*kno\\.li/[0-9a-z]+", "http://[\\w\\.]*elurl\\.com/[0-9a-z]+", "http://[\\w\\.]*wapurl\\.co\\.uk/\\?[0-9A-Z]+", "http://[\\w\\.]*micurl\\.com/[a-zA-Z]+", "http://[\\w\\.]*urlcantik\\.com/[a-z0-9]+", "http://[\\w\\.]*0845\\.com/[a-zA-Z0-9]+", "http://[\\w\\.]*piurl\\.com/[a-z0-9]+", "http://[\\w\\.]*tren\\.tk/[a-z0-9]+", "http://[\\w\\.]*twurl\\.nl/[a-z0-9]+", "http://[\\w\\.]*shortlinks\\.co\\.uk/[0-9a-z]+", "http://[\\w\\.]*rubyurl\\.com/[0-9a-zA-Z]+", "http://[\\w\\.]*u\\.nu/[0-9a-z]+", "http://(www\\.)?hex\\.io/(?!contact|user|javascript|api)[\\w]+", "http://short\\.redirect\\.am/\\?[\\w]+", "http://[\\w\\.]*2li\\.ru//[a-z0-9]+", "https?://[\\w\\.]*goo\\.gl/[A-Za-z0-9]+", "http://(www\\.)?u\\.to/[A-Za-z0-9\\-]+",

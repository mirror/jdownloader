...
public class Rdrctr extends PluginForDecrypt {
    ...
    public static String[] getAnnotationUrls() {
        ...
        // note: bit.ly hosted domains (owned by other services but using bit.ly platform) will have '_bit' cookie
        String[] list = { "https?://feedproxy\\.google\\.com/~r/.+", "http://cur\\.bz/[A-Za-z0-9]+", "http://(www\\.)?awe\\.sm/[A-Za-z0-9]+", "http://(www\\.)?pip\\.bz/[A-Za-z0-9]+", "http://(www\\.)?ovh\\.to/[A-Za-z0-9]+", "http://(www\\.)?po\\.st/[A-Za-z0-9]+", "http://(www\\.)?share-films\\.net/redirect\\.php\\?url=[a-z0-9]+", "http://(www\\.)?fburls\\.com/\\d+\\-[A-Za-z0-9]+", "http://(www\\.)?umquetenha\\.org/protecao/resolve\\.php\\?link=.{2,}", "http://(www\\.)?mblink\\.info/\\?id=\\d+", "https?://t\\.co/[a-zA-Z0-9]+", "http://(de\\.)?shrk\\.biz/\\w+", "https?://go\\.madmimi\\.com/redirects/[a-zA-Z0-9]+\\?pa=\\d+", "http://[\\w\\.]*?alturl\\.com/[a-z0-9]+", "http://click\\.tf/[a-zA-Z0-9]{8}", "http://(?:www\\.)?ssh\\.yt/[a-zA-Z0-9]+", "http://(www\\.)?rapidsky\\.net/[A-Za-z0-9]+", "https?://(www\\.)?yhoo\\.it/[\\w]+",
                "https?://(\\w\\.)?proton\\.biz/aralara\\.php\\?link=[a-z0-9]+", "http://(www\\.)?otrkeyfinder\\.com/index\\.php\\?page=goto_mirror\\&otrkey=[^<>\"/]+\\.otrkey\\&search=[a-f0-9]+\\&mirror=\\d+", "http://[\\w\\.]*smarturl\\.it/[A-Za-z0-9]+", "http://[\\w\\.]*westernlink\\.co/l/[A-Za-z0-9]+", "http://[\\w\\.]*sharingdb\\.com/[a-z0-9]+", "http://(www\\.)?ift\\.tt/[a-zA-Z0-9]+", "https?://(www\\.)?doujin\\.us/link/\\d+/\\d+", "http://(www\\.)?(share\\.wf|links\\.tc)/[A-Za-z0-9]+", "https?://(www\\.)?urlm\\.in/[a-zA-Z0-9]+", "http://(www\\.)?cutmy\\.name/(?!#|.+\\.php)(u/[a-f0-9]{6,8}|[a-z0-9]+)", "https?://(www\\.)?tinyw\\.in/[a-zA-Z0-9]+", "http://(www\\.)?baidu\\.com/link\\?url=[A-Za-z0-9\\-_]+", "http://(www\\.)?sharedpartners\\.com/in/\\d+/\\d+", "http://(www\\.)?relink\\.ws/[A-Za-z0-9]+", "http://(www\\.)?clck\\.ru/(d/[A-Za-z0-9\\-_]+|[A-Za-z0-9\\-_]+)",
                "https?://(?:www\\.)?goo\\.gl/[A-Za-z0-9]+", "https?://[\\w\\.]*youtu\\.be/[a-z_A-Z0-9\\-]+", "http://[\\w\\.]*readthis\\.ca(/[a-zA-Z0-9]+)?", "http://[\\w\\.]*redirects\\.ca(/[a-zA-Z0-9]+)?", "http://[\\w\\.]*goshrink\\.com(/[a-zA-Z0-9]+)?", "http://[\\w\\.]*clickthru\\.ca(/[a-zA-Z0-9]+)?", "http://[\\w\\.]*atu\\.ca(/[a-zA-Z0-9]+)?", "http://[\\w\\.]*easyurl\\.net(/[a-zA-Z0-9]+)?", "http://[\\w\\.]*redirect\\.wayaround\\.org/[a-zA-Z0-9]+/(.*)", "http://[\\w\\.]*rurl\\.org(/[a-zA-Z0-9]+)?", "http://(www\\.)?tinyurl\\.com/(?!favicon|preview)[a-z0-9]+(/[a-z0-9]+)?", "http://[\\w\\.]*smarturl\\.eu/\\?[a-zA-Z0-9]+", "http://[\\w\\.]*linkmize\\.com(/[a-zA-Z0-9]+)?", "http://go2\\.u6e\\.de/[a-zA-Z0-9]+", "http://[\\w\\.]*shrinkify\\.com/[a-zA-Z0-9]+", "http://[\\w\\.]*s7y\\.com/[a-zA-Z0-9]+", "http://[\\w\\.]*rln\\.me/[0-9a-zA-Z]+", "http://[\\w\\.]*sp2\\.ro/[0-9a-zA-Z]+",
                "http://[\\w\\.]*s7y.us/[a-zA-Z0-9]+", "http://[\\w\\.]*ow\\.ly/[\\w]+", "http://(www\\.)?(bit\\.ly|maticulo\\.us|trib\\.al|ab\\.co)/[\\w]+", "http://[\\w\\.]*vb\\.ly/[\\w]+", "http://[\\w\\.]*ponyurl\\.com/[\\w]+", "http://[\\w\\.]*budurl\\.com/[a-zA-Z0-9]+", "http://(www\\.)?yep\\.it/(?!preview|stat|favicon|css|js|apipage|go|yepsrc|contacts|about|cloud|icon|rssfeed)[A-Za-z0-9]+", "http://[\\w\\.]*urlite\\.com/[\\d]+", "http://[\\w\\.]*urlcini\\.com/[\\w]+", "http://[\\w\\.]*tra\\.kz/[\\w_\\-,()*:]+", "http://[\\w\\.]*tiny\\.pl/[\\w]+", "http://[\\w\\.]*clop\\.in/[a-zA-Z0-9]+", "http://[\\w\\.]*linkth\\.at/[a-z]+", "http://[\\w\\.]*url(Pass|pass)\\.com/[0-9a-z]+", "http://[\\w\\.]*bacn\\.me/[0-9a-z]+", "http://[\\w\\.]*moourl\\.com/[a-zA-Z0-9]+", "http://[\\w\\.]*thnlnk\\.com/[a-zA-Z0-9]+/[a-zA-Z0-9]+/[0-9]+", "http://[\\w\\.]*editurl\\.com/[a-z0-9]+",
                "http://[\\w\\.]*ri\\.ms/[a-z0-9]+", "http://[\\w\\.]*gelen\\.org/[0-9]+", "http://[\\w\\.]*pettyurl\\.com/[0-9a-z]+", "http://[\\w\\.]*9mmo\\.com/[a-z0-9]+", "http://[\\w\\.]*bmi-group\\.99k\\.org/go\\.php\\?id=[0-9]+", "http://[\\w\\.]*\\.decenturl\\.com/[a-z0-9.-]+", "http://[\\w\\.]*shor7\\.com/\\?[A-Z]+", "http://[\\w\\.]*f5y\\.info/[a-zA-Z-]+", "http://[\\w\\.]*starturl\\.com/[a-z_]+", "http://[\\w\\.]*(2s8\\.org|kno\\.li)/[0-9a-z]+", "http://[\\w\\.]*elurl\\.com/[0-9a-z]+", "http://[\\w\\.]*wapurl\\.co\\.uk/\\?[0-9A-Z]+", "http://[\\w\\.]*micurl\\.com/[a-zA-Z]+", "http://[\\w\\.]*urlcantik\\.com/[a-z0-9]+", "http://[\\w\\.]*0845\\.com/[a-zA-Z0-9]+", "http://[\\w\\.]*piurl\\.com/[a-z0-9]+", "http://[\\w\\.]*tren\\.tk/[a-z0-9]+", "http://[\\w\\.]*twurl\\.nl/[a-z0-9]+", "http://[\\w\\.]*shortlinks\\.co\\.uk/[0-9a-z]+", "http://[\\w\\.]*urlal\\.com/[0-9a-z]+",
                "http://[\\w\\.]*urloid\\.com/[0-9a-z]+", "http://[\\w\\.]*rubyurl\\.com/[0-9a-zA-Z]+", "http://[\\w\\.]*kl\\.am/[0-9A-Z]+", "http://[\\w\\.]*u\\.nu/[0-9a-z]+", "http://(www\\.)??hex\\.io/(?!contact|user|javascript|api)[\\w]+", "http://short\\.redirect\\.am/\\?[\\w]+", "http://[\\w\\.]*2li\\.ru//[a-z0-9]+", "http://[\\w\\.]*goo\\.gl/[A-Za-z0-9]+", "http://(www\\.)?unite\\.ws/download/och/\\d+/", "http://(www\\.)?id2\\.tryjav\\.com/.+", "http://(www\\.)?u\\.to/[A-Za-z0-9\\-]+", "http://(www\\.)?up\\.ht/[A-Za-z0-9]+", "http://(www\\.)?romsite\\.net/download\\.php\\?id=\\d+\\&s=[a-z0-9]{1,4}\\&f=[a-z0-9]{1,5}", "http://(www\\.)?t\\.ymlp\\d+\\.com/[a-z0-9]+/click\\.php", "http://(www\\.)?lowlifeinc\\.us2\\.list-manage\\.com/track/click\\?u=[a-z0-9]+\\&id=[a-z0-9]+\\&e=[a-z0-9]+", "http://(www\\.)?metalwarez\\.com/link/\\d+", "http://(www\\.)?shorlink\\.net/s/[A-Za-z0-9]+",
                "http://(www\\.)?likejav\\.com/file/[a-z0-9]+", "https?://chilp\\.it/\\??\\w{6}", "http://(www\\.)?sflk\\.in/\\w{11}", "http://(www\\.)?dai\\.ly/[A-Za-z0-9]+", "http://(www\\.)?db\\.tt/[A-Za-z0-9]+", "http://(www\\.)?0url\\.in/[A-Za-z0-9]+/", "http://(www\\.)?artofx\\.org/[a-z0-9]+", "http://(www\\.)?ewe\\.h1\\.ru/[A-Za-z0-9\\-_]+/[^<>\"/]+" };

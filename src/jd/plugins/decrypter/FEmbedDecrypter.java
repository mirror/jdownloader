...
public class FEmbedDecrypter extends PluginForDecrypt {
    ...
    public static List<String[]> getPluginDomains() {
        ...
        /* 2021-11-16 */
        ret.add(new String[] { "watch-jav-english.live", "dutrag.com", "nekolink.site", "pornhole.club", "javip.pro", "javlove.club", "javguru.tk", "diasfem.com", "cloudrls.com", "embedaio.com", "fakyutube.com", "javhdfree.icu", "fembed-hd.com", "suzihaza.com", "mambast.tk", "javpoll.com", "fembed9hd.com" });
        return ret;
    }
    ...
    public ArrayList<DownloadLink> decryptIt(final CryptedLink param, ProgressController progress) throws Exception {
        ...
        if (response != null) {
            if (!Boolean.TRUE.equals(response.get("success"))) {
                final String msg = (String) response.get("data");
                if (!StringUtils.isEmpty(msg)) {
                    logger.info("Link offline because: " + msg);
                }

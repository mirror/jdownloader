...
public class InstaGramComDecrypter extends PluginForDecrypt {
    ...
    protected class InstagramMetadata {
        ...
        public FilePackage getFilePackage() {
            ...
            // use PROPERTY_PACKAGE_KEY because different user may result in same package name after name cleanup
            final String cachedUserID = getCachedUserID(getUsername());
            fp.setProperty(FilePackage.PROPERTY_PACKAGE_KEY, cachedUserID != null ? cachedUserID : this.getPackageName());
            return fp;
        }

...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "mangadex.org" }, urls = { "https?://(www\\.)?mangadex\\.(org|cc)/chapter/\\d+" })
public class MangadexOrg extends antiDDoSForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink parameter, ProgressController progress) throws Exception {
        ...
        getPage("https://mangadex.cc/api/?id=" + chapterID + "&type=chapter");
        ...
        if (StringUtils.isNotEmpty(mangaID)) {
            getPage("https://mangadex.cc/api/?id=" + mangaID + "&type=manga");

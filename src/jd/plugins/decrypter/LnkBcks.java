...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filesonthe.net", "cash4files.com", "seriousdeals.net", "any.gs", "goneviral.com", "ultrafiles.net", "miniurls.co", "tinylinks.co", "yyv.co", "realfiles.net", "youfap.com", "linkgalleries.net", "thesefiles.com", "urlpulse.net", "viraldatabase.com", "seriousfiles.com", "ubucks.net", "thesegalleries.com", "seriousurls.com", "baberepublic.com", "qvvo.com", "linkbucks.com", "linkseer.net", "ubervidz.com", "uberpicz.com", "zxxo.net", "ugalleries.net", "picturesetc.net", "allanalpass.com" }, urls = { "http://([0-9a-fA-F]+(\\d+)?)\\.filesonthe\\.net/?", "http://([0-9a-fA-F]+(\\d+)?)\\.cash4files\\.com/?", "http://([0-9a-fA-F]+(\\d+)?)\\.seriousdeals\\.net/?", "http://([0-9a-fA-F]+(\\d+)?)\\.any\\.gs/?", "http://([0-9a-fA-F]+(\\d+)?)\\.goneviral\\.com/?", "http://(www\\.)?[a-z0-9]+\\.ultrafiles\\.net",
        "http://(www\\.)?[a-z0-9]+\\.miniurls\\.co", "http://[\\w\\.]*?tinylinks\\.co(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[0-9a-fA-F]+\\.yyv\\.co/?", "http://[\\w\\.]*?realfiles\\.net(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?youfap\\.com(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?linkgalleries\\.net(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?thesefiles\\.com(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?urlpulse\\.net(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?viraldatabase\\.com(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?seriousfiles\\.com(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?ubucks\\.net(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?thesegalleries\\.com(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?seriousurls\\.com(/link/[0-9a-fA-F]+(/\\d+)?)?",
        "http://(www\\.)?(baberepunlic\\.com/(link/[0-9a-zA-Z]+(/\\d+)?|url/.+)|(?!www\\.)[a-z0-9]+\\.baberepunlic\\.com)", "http://[\\w\\.]*?qvvo\\.com(/link/[0-9a-zA-Z]+(/\\d+)?)?", "http://(www\\.)?(linkbucks\\.com/(link/[0-9a-zA-Z]+(/\\d+)?|url/.+)|(?!www\\.|forums\\.)[a-z0-9]+\\.linkbucks\\.com)", "http://([0-9a-fA-F]+(\\d+)?)\\.linkseer\\.net/?", "http://([0-9a-fA-F]+(\\d+)?)\\.ubervidz\\.com/?", "http://([0-9a-fA-F]+(\\d+)?)\\.uberpicz\\.com/?", "http://([0-9a-fA-F]+(\\d+)?)\\.zxxo\\.net/?", "http://([0-9a-fA-F]+(\\d+)?)\\.ugalleries\\.net/?", "http://([0-9a-fA-F]+(\\d+)?)\\.picturesetc\\.net/?", "http://([0-9a-fA-F]+(\\d+)?)\\.allanalpass\\.com/?"

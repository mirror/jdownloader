...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "multisharex.com" }, urls = { "http://[\\w\\.]*?multisharex\\.com/\\?f=[a-z0-9]+" }, flags = { 0 })
public class MultiShareXCom extends PluginForDecrypt {

    public MultiShareXCom(PluginWrapper wrapper) {
        super(wrapper);
    }

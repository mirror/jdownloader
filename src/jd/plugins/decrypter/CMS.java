...
public class CMS extends PluginForDecrypt {
    ...
    public static String[] getAnnotationNames() {
        return new String[] { "top-hitz.com", "fettrap.com", "omega-music.com", "hardcoremetal.biz", "hardcoremetal.bz", "saugking.net", "porn-traffic.net", "sceneload.to", "serienfreaks.to", "warez-load.com", "byte.to", "dream-team.bz/cms", "ebook-hell.to", "pirate-loads.to", "filefarm.biz", "cineload.ws", "ddl-heaven.net" };
    }

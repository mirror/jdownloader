...
public class PornvideohostCom extends PornEmbedParser {
    public PornvideohostCom(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "pornvideost.com" });
        return ret;
    }
    ...
    protected String getParseSource(final Browser br) {
        ...
        /* They're trying to break common parsers --> Fix html */
        html = html.replaceAll("/embed/#", "");

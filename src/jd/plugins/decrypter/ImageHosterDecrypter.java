...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "imagebam.com", "imagevenue.com", "imageshack.us", "photobucket.com", "freeimagehosting.net", "pixhost.org" }, urls = { "http://[\\w\\.]*?imagebam\\.com/image/[a-z0-9]+", "http://[\\w\\.]*?img[0-9]+\\.imagevenue\\.com/img\\.php\\?image=.+", "http://[\\w\\.]*?img[0-9]{1,4}\\.imageshack\\.us/i/[a-z]+\\.[a-zA-Z]{1,3}/", "http://[\\w\\.]*?media\\.photobucket.com/image/.+\\..{3,4}\\?o=[0-9]+", "http://[\\w\\.]*?freeimagehosting\\.net/image\\.php\\?.*?\\..{3,4}", "http://[\\w\\.]*?pixhost\\.org/show/[0-9]+/.*?\\.{3,4}" }, flags = { 0, 0, 0, 0, 0, 0 })

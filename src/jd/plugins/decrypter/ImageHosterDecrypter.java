...
names = { "image2you.ru", "picsee.net", "pichost.me", "imagecurl.com", "otofotki.pl", "bigimage.cz", "twitpic.com", "imgserve.net", "imgpizza.com", "pic4you.ru", "tuspics.net", "pic4free.org", "imagetwist.com", "postimage.org", "pimpandhost.com", "turboimagehost.com", "imagehyper.com", "imagebam.com", "freeimagehosting.net", "pixhost.org", "sharenxs.com", "9gag.com" },

urls = { "http://(?:www\\.)?image2you\\.ru/\\d+/\\d+/", "http://(www\\.)?picsee\\.net/\\d{4}-\\d{2}-\\d{2}/.*?\\.html", "http://(www\\.)?pichost\\.me/\\d+", "http://(?:www\\.)?imagecurl\\.com/viewer\\.php\\?file=[\\w-]+\\.[a-z]{2,4}", "http://img\\d+\\.otofotki\\.pl/[A-Za-z0-9\\-_]+\\.jpg\\.html", "http://bigimage\\.cz/image/\\d+\\.html", "https?://(www\\.)?twitpic\\.com/show/[a-z]+/[a-z0-9]+", "http://(www\\.)?imgserve\\.net/img\\-[a-z0-9]+\\.html", "http://(www\\.)?imgpizza\\.com/viewer\\.php\\?file=[^<>\"/]+", "http://(www\\.)?pic4you\\.ru/\\d+/\\d+/", "http://(www\\.)?tuspics\\.net/[a-z0-9]{12}", "http://(www\\.)?pic4free\\.org/\\?v=[^<>\"/]+", "http://(www\\.)?imagetwist\\.com/[a-z0-9]{12}", "http://(www\\.)?postim(age|g)\\.org/image/[a-z0-9]+", "http://(www\\.)?pimpandhost\\.com/image/(show/id/\\d+|\\d+\\-(original|medium|small)\\.html)",
        "http://(www\\.)?turboimagehost\\.com/p/\\d+/.*?\\.html", "http://(www\\.)?(img\\d+|serve)\\.imagehyper\\.com/img\\.php\\?id=\\d+\\&c=[a-z0-9]+", "http://[\\w\\.]*imagebam\\.com/(image|gallery)/[a-z0-9]+", "http://[\\w\\.]*?freeimagehosting\\.net/image\\.php\\?.*?\\..{3,4}", "http://(www\\.)?pixhost\\.org/show/\\d+/.+", "http://(www\\.)?sharenxs\\.com/view/\\?id=[a-z0-9-]+", "https?://(www\\.)?9gag\\.com/gag/\\d+" },
...
public class ImageHosterDecrypter extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(final CryptedLink param, final ProgressController progress) throws Exception {
        ...
        if (parameter.contains("imagebam.com")) {
        ...
        } else if (new Regex(parameter, Pattern.compile(".+postim(age|g)\\.org/.+", Pattern.CASE_INSENSITIVE)).matches()) {
            br.setFollowRedirects(true);
            ...
            if (finallink == null) {
                finallink = br.getRegex("\"(http://[0-9\\.]+/stream\\.php\\?id=\\d+)\"").getMatch(0);
            }
            if (finallink == null) {
        ...
        } else if (parameter.contains("bigimage.cz/")) {
            br.getPage(parameter);
            if (br.containsHTML("class=\"flash-msg f-error\"")) {
                logger.info("Link offline: " + parameter);
                try {
                    decryptedLinks.add(this.createOfflinelink(parameter));
                } catch (final Throwable e) {
            ...
            finallink = br.getRegex("(\\'|\")(http://bigimage\\.cz/photos/\\d+\\.[a-z0-9]+)(\\'|\")").getMatch(1);

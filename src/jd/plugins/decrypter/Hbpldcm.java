...
@DecrypterPlugin(revision = "$Revision: 7185 $", interfaceVersion = 2, names = { "hubupload.com" }, urls = { "http://[\\w\\.]*?hubupload\\.com/files/[\\w]+/[\\w]+/(.*)"}, flags = { 0 })


public class Hbpldcm extends PluginForDecrypt {

    public Hbpldcm(PluginWrapper wrapper) {
        super(wrapper);
    }

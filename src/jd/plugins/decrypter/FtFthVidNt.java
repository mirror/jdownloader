 ...
 * @author raztoki
 */
@DecrypterPlugin(revision = "$Revision: 32430 $", interfaceVersion = 2, names = { "footfetishvideos.net" }, urls = { "https?://(?:www\\.)?footfetishvideos\\.net/(?:file/[a-z0-9]{14}|[^/\\s]+-siterip/?)" }, flags = { 0 })

...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "couchtuner.cloud" }, urls = { "https?://(www\\.)?(?:watch-online\\.xyz|couchtuner\\.(?:cloud|click|host|website|top|fun|me|network|vip)|2mycouchtuner\\.me|mycouchtuner\\.li|1couchtuner\\.(?:club|me|xyz)|icouchtuner\\.(?:club|me|xyz))/.+" })

...
//by pspzockerscene
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "xali.com" }, urls = { "http://[\\w\\.]*?xali\\.com\\?site=protect&id[0-9]+" }, flags = { 0 })
public class XliCm extends PluginForDecrypt {

    public XliCm(PluginWrapper wrapper) {
        super(wrapper);
    }

...
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "mega.co.nz" }, urls = { "https?://(www\\.)?mega\\.(co\\.)?nz/(file|folder)/[a-zA-Z0-9]+(#|%23)[a-zA-Z0-9_,\\-%]{16,}" })
public class RewriteMegaConz extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink parameter, ProgressController progress) throws Exception {
        ...
        final String parts[] = new Regex(parameter.getCryptedUrl(), "(file|folder)/([a-zA-Z0-9]+)(?:#|%23)([a-zA-Z0-9_,\\-%]{16,})").getRow(0);

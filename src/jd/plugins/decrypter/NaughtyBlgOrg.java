...
public class NaughtyBlgOrg extends PluginForDecrypt {
    ...
    private static final String INVALIDLINKS = "http://(www\\.)?naughtyblog\\.org/(category|linkex|feed|\\d{4}|tag|free\\-desktop\\-strippers|list\\-of\\-all\\-siterips|contact\\-us|how\\-to\\-download\\-files|siterips)";

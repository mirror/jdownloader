...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "evilshare.com" }, urls = { "http://[\\w\\.]*?evilshare\\.com/[0-9a-z]{12}" }, flags = { 0 })
public class EvilShareCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST = "http://evilshare.com";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "beehd.net" }, urls = { "https?://(www\\.)?beehd\\.net/(embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class BeehdNet extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://beehd.net";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(beehd\\.net)";
    /*
    ...
    @SuppressWarnings("deprecation")
    public BeehdNet(PluginWrapper wrapper) {
        super(wrapper);

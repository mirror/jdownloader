...
public class PutlockerWs extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://www.putlocker.ws/";
    }

    /** Clone of site: putlocker.com */
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        final Regex fInfo = br.getRegex("<h1>([^<>]*?)<strong>\\( ([^<>\"]*?) \\)</strong>");
    ...
    public void handleFree(final DownloadLink downloadLink) throws Exception, PluginException {
        ...
        br.postPage(br.getURL(), "freeuser=yes&confirm=Continue+as+Free+User");
    ...
    private String getVideoLink() throws PluginException, IOException {
        return br.getRegex("url: \\'(http://[^<>\"]*?)\\'").getMatch(0);
    }

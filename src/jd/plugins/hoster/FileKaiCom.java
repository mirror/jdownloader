...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "filekai.com" }, urls = { "https?://(www\\.)?filekai\\.com/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class FileKaiCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://filekai.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(filekai\\.com)";
     ...
     * */
    public FileKaiCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

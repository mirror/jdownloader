...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "nornar.com" }, urls = { "https?://(www\\.)?nornar\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class NornarCom extends PluginForHost {
    ...
    private static final String  DOMAINS                      = "(nornar\\.com)";

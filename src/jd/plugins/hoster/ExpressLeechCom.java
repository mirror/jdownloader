...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "4upld.com", "expressleech.com" }, urls = { "https?://(www\\.)?4upld\\.com/[A-Za-z0-9]+", "fh453g94enwhgdbfrbJD1_remove_me_ghtnrtzjrj" }, flags = { 2, 0 })
public class ExpressLeechCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        /* Old links == offline */
        if (link.getDownloadURL().matches("https?://(www\\.)?expressleech\\.com/((vid)?embed-)?[a-z0-9]{12}")) {

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "expressleech.com" }, urls = { "https?://(www\\.)?expressleech\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ExpressLeechCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "The file you were looking for could not be found|Possible causes of this error could be").matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[1] == null) {
            fileInfo[1] = new Regex(correctedBR, "<font style=\"color:darkred\">[^<>\"/]*?</font> \\[([^<>\"/]*?)\\]<").getMatch(0);
        }

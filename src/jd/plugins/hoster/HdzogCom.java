...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "hdzog.com" }, urls = { "http://(www\\.)?hdzog\\.com/videos/\\d+/[a-z0-9\\-]+/" }, flags = { 0 })
public class HdzogCom extends PluginForHost {

    public HdzogCom(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    // Tags:
    // protocol: no https
    // other: special: Removed filesize check

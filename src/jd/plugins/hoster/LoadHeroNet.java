...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "loadhero.net" }, urls = { "http://(www\\.)?loadhero\\.net/[A-Za-z0-9]+" }, flags = { 2 })
public class LoadHeroNet extends PluginForHost {

    public LoadHeroNet(PluginWrapper wrapper) {
        super(wrapper);
        this.enablePremium("http://loadhero.net/register.html");
    }
    ...
    private final String  MAINPAGE  = "http://loadhero.net";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        final Regex fileInfo = br.getRegex("<th class=\"descr\">[\t\n\r ]+<strong>([^<>\"]*?) \\((\\d+(\\.\\d+)? [A-Za-z]{1,5})\\)<br/>");

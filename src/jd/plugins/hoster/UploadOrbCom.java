...
@HostPlugin(revision = "$Revision: 16154 $", interfaceVersion = 2, names = { "uploadorb.com" }, urls = { "https?://(www\\.)?uploadorb\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class UploadOrbCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://uploadorb.com";
    ...
    // mods: dllink regex
    // free: 20 chunks, unlimited max dl
    // premium:
    // protocol: no https
    // captchatype: null
    // other: no redirects
    ...
    public UploadOrbCom(PluginWrapper wrapper) {
        super(wrapper);
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                ...
                if (dllink == null) {
                    ...
                    if (dllink == null) {
                        dllink = new Regex(correctedBR, "<FORM METHOD=\"LINK\" ACTION=\"([^\"<>]+)\">").getMatch(0);
                        if (dllink == null) {

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filehook.com" }, urls = { "http://(www\\.)?filehook\\.com/[a-z0-9]{12}" }, flags = { 2 })
public class FileHookCom extends PluginForHost {
    ...
    public int getMaxSimultanPremiumDownloadNum() {
        // Max 10 connections at all, max 2 chunks per download
        return 5;
    }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filehook.com" }, urls = { "http://(www\\.)?filehook\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileHookCom extends PluginForHost {

    public FileHookCom(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(COOKIE_HOST + "/premium.html");
    }

    // XfileSharingProBasic Version 2.0.1.0, added a special filesize regex,
    // added 2 dllink regexes
    @Override
    ...
    private static final String COOKIE_HOST   = "http://filehook.com";
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) filesize = new Regex(BRBEFORE, "class=\"file_label\">File Size : </span><span class=\"file_code\">(.*?)</span>").getMatch(0);
            }
        }
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        doFree(downloadLink, true, -2, false);
    }
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                ...
                if (dllink == null) {
                    ...
                    if (dllink == null) {
                        dllink = new Regex(BRBEFORE, "<td bgcolor=\"#E8E8E8\"><font size=\"2\">\\&nbsp;<a href=\"(http://.*?)\"").getMatch(0);
                        if (dllink == null) {

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "imgah.com" }, urls = { "https?://(www\\.)?imgah\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ImgAhCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://imgah.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(imgah\\.com)";
    ...
    public ImgAhCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 17298 $", interfaceVersion = 2, names = { "syfiles.com" }, urls = { "https?://(www\\.)?syfiles\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class SyFilesCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://syfiles.com";
    ...
    public SyFilesCom(PluginWrapper wrapper) {
        super(wrapper);
        ...
        if (fileInfo[0] == null) {
            ...
            if (fileInfo[0] == null) {
                ...
                if (fileInfo[0] == null) {
                    ...
                    if (fileInfo[0] == null) {
                        fileInfo[0] = new Regex(correctedBR, "File: (<[^>]+> ?)+?([^<>\"\\']+)").getMatch(1);

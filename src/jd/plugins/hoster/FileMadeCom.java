...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filemade.com" }, urls = { "http://(www\\.)?filemade\\.com/(?!faq|register|login|terms|report_file|up|forgot)[a-z0-9]+" }, flags = { 0 })
public class FileMadeCom extends PluginForHost {
    ...
    // YetiShareBasic Version 0.2.0-psp
    // mods:
    // non account: 1 * 1 (UNTESTED)
    ...
    private final String        MAINPAGE                 = "http://filemade.com";

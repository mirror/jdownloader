...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "megaup.net" }, urls = { "https?://(?:www\\.)?megaup\\.net/[A-Za-z0-9]+" })
public class MegaupNet extends antiDDoSForHost {
    public MegaupNet(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * mods: premium untested, set FREE account limits<br />
     * limit-info:<br />
     * captchatype: null<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://megaup.net";
    private final String                   domains                                      = "(megaup\\.net)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        /* 2018-10-26: Special: Set final filename here as server returns urlencoded string which can lead to extremely long filenames */

...
public class DatopornCo extends XFileSharingProBasic {
    public DatopornCo(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * other:<br />
     */
    private static String[] domains = new String[] { "datoporn.co", "dato.porn" };

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "invitationfile.com" }, urls = { "https?://(www\\.)?invitationfile\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class InvitationfileCom extends PluginForHost {
    ...
    // mods: extra filename- and extra premiumonly RegEx

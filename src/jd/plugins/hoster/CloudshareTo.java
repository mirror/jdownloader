...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "cloudshare.to" }, urls = { "https?://(?:www\\.)?cloudshare\\.to/(?:embed\\-)?[a-z0-9]{12}" })
public class CloudshareTo extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://cloudshare.to".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:cloudshare\\.to)";
     ...
     * limit-info: 2018-08-27: Premium untested, set FREE account limits<br />
    ...
    public CloudshareTo(PluginWrapper wrapper) {
        super(wrapper);

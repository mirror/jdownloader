...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "iboner.com", "yobt.tv", "bigxvideos.com" }, urls = { "http://(www\\.)?iboner\\.com/content/\\d+/[a-z0-9\\-]+\\.html", "http://(www\\.)?yobt\\.tv/content/\\d+/[a-z0-9\\-]+\\.html", "http://(www\\.)?bigxvideos\\.com/content/\\d+/[a-z0-9\\-]+\\.html" })

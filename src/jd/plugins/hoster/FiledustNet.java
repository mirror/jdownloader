...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filedust.net" }, urls = { "https?://(www\\.)?filedust\\.net/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FiledustNet extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://filedust.net";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(filedust\\.net)";
    ...
    // mods: waitTime[Added another RegEx]
    // limit-info:
    // protocol: no https
    // captchatype: solvemedia
    // other: solvemedia + pre-download waittime = skippable
    ...
    public FiledustNet(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "creafile.net" }, urls = { "https?://(www\\.)?creafile\\.net/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 2 })
...
public class CreaFileNet extends PluginForHost {
    ...
    private final String               DOMAINS                      = "(creafile\\.net)";

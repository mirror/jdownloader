...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "videodd.net" }, urls = { "https?://(www\\.)?videodd\\.net/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class VideoDdNet extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://videodd.net";
    // domain names used within download links.
    private final String               DOMAINS                      = "(videodd\\.net)";
     ...
     * */
    public VideoDdNet(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

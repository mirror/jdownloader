...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "labload.com" }, urls = { "https?://(www\\.)?labload\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class LabLoadCom extends PluginForHost {

    public LabLoadCom(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(mainpage + "/upgrade." + type);
    }

    // For sites which use this script: http://www.yetishare.com/
    // YetiShareBasic V2-0.4.0-psp
    // mods:
    // limit-info:
    // protocol: no https
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://labload.com";
    private final String         domains                                      = "(labload\\.com)";

...
@HostPlugin(revision = "$Revision: 17148 $", interfaceVersion = 2, names = { "spaceha.com" }, urls = { "https?://(www\\.)?spaceha\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class SpaceHaCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://spaceha.com";
    ...
    public SpaceHaCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void checkErrors(DownloadLink theLink, boolean checkAll, String passCode) throws NumberFormatException, PluginException {
        ...
        // <font class="err">You have reached the download-limit for free-users.<br>Get your own Premium-account now!<br>(Or wait 25
        // seconds)</font>
        /** Wait time reconnect handling */
        if (new Regex(correctedBR, "(You have reached the download(\\-| )limit|You have to wait)").matches()) {
            // adjust this regex to catch the wait time string for COOKIE_HOST
            String WAIT = new Regex(correctedBR, "((You have reached the download(\\-| )limit.+OR wait|You have to wait)[^<>]+)").getMatch(0);

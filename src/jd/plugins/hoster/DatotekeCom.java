...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "datoteke.com" }, urls = { "https?://(?:www\\.)?datoteke\\.com/[A-Za-z0-9]+" }, flags = { 2 })
public class DatotekeCom extends antiDDoSForHost {

    public DatotekeCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://datoteke.com";
    private final String         domains                                      = "(datoteke\\.com)";

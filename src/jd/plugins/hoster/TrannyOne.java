...
public class TrannyOne extends antiDDoSForHost {
    ...
    public String getAGBLink() {
        return "https://www.tranny.one/pages/terms.html";
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        String filename = br.getRegex("data-title=\"([^\"]+)\"").getMatch(0);
        dllink = br.getRegex("data-videolink=\"(http[^\"]+)").getMatch(0);
    ...
    public void handleFree(final DownloadLink link) throws Exception {
        ...
        if (!looksLikeDownloadableContent(br.getHttpConnection())) {

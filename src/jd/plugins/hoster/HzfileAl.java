...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "hzfile.al" }, urls = { "https?://(?:www\\.)?hzfile\\.(?:al|asia)/(?:embed\\-)?[a-z0-9]{12}" })
public class HzfileAl extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://hzfile.al";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(hzfile\\.al)";
     ...
     * other: Is related to erafile.com<br />
     */
    ...
    public HzfileAl(PluginWrapper wrapper) {
        super(wrapper);

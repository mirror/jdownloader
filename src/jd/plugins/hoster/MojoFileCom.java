...
@HostPlugin(revision = "$Revision: 16172 $", interfaceVersion = 2, names = { "mojofile.com" }, urls = { "https?://(www\\.)?mojofile\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class MojoFileCom extends PluginForHost {
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        doFree(downloadLink, false, 0, "freelink");
    }

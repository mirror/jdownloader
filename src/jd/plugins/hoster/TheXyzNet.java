...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "thexyz.net" }, urls = { "https?://(www\\.)?thexyz\\.net/[a-z0-9]{12}" }, flags = { 0 })
public class TheXyzNet extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://thexyz.net";
    ...
    public TheXyzNet(PluginWrapper wrapper) {
        super(wrapper);

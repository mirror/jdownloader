...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "imgve.com" }, urls = { "https?://(?:www\\.)?imgve\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ImgveCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://imgve.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(imgve\\.com)";
    ...
    public ImgveCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "upshared.com" }, urls = { "https?://(www\\.)?upshared\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class UpSharedCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://upshared.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(upshared\\.com)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filemoney.com" }, urls = { "https?://(www\\.)?filemoney\\.com/(vidembed\\-)?[a-z0-9]{12}" })
public class FileMoneyCom extends PluginForHost {
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        /** Ticket Time */
        final String ttt = new Regex(correctedBR, ">Wait(?: |<br/>)<[^<>]+>(\\d+)</span>").getMatch(0);
        if (ttt != null) {

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "embedload.com" }, urls = { "http://(www\\.)?embedload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class EmbedLoadCom extends PluginForHost {

    public EmbedLoadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST  = "http://embedload.com";

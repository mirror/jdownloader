...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "davvas.com" }, urls = { "https?://(www\\.)?davvas\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class DavvasCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://davvas.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(davvas\\.com)";
    ...
    public DavvasCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 25962 $", interfaceVersion = 2, names = { "files2share.ch" }, urls = { "https?://(www\\.)?files2share\\.ch/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FilesTwoShareCh extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://files2share.ch";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(files2share\\.ch)";
    ...
    public FilesTwoShareCh(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        if (space == null) {
            space = new Regex(correctedBR, "Storage<.*?>([0-9\\.]+) of \\d+ (KB|MB|GB|TB)?</span>").getRow(0);
        }
        ...
        final String availabletraffic = new Regex(correctedBR, "Traffic available.*?>([^<>\"\\']+)</span></td>").getMatch(0);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "lumfile.com" }, urls = { "z77iojtjftjrDELETE_MEfh65iiubf_MOVED_TO_TeraFileCo_PLUGINrei5754dfrghrghrhijnfdwihjdwiojn" }, flags = { 2 })

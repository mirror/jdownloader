...
public class GamesDatabaseCom extends YetiShareCore {
    public GamesDatabaseCom(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info: 2021-09-29: No limits at all <br />
     * captchatype-info: 2021-09-29: null<br />
     * other: <br />
     */
    ...
    public String[] scanInfo(final DownloadLink link, final String[] fileInfo) {
        /* 2021-09-29: Special */
        fileInfo[1] = br.getRegex(">Filesize\\s*:\\s*<p>([^<>\"]+)</p>").getMatch(0);

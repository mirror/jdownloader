...
public class PlayedTo extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://played.to";
    ...
    public PlayedTo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (correctedBR.contains(">Video is processing now")) {
            throw new PluginException(LinkStatus.ERROR_TEMPORARILY_UNAVAILABLE, "Video not ready to stream yet", 5 * 60 * 1000l);
        }
        if (dllink == null) {
    ...
    public void checkServerErrors() throws NumberFormatException, PluginException {
        ...
        if (new Regex(correctedBR, "Wrong IP").matches()) {

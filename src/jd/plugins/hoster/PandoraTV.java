...
public class PandoraTV extends PluginForHost {
    ...
    public void handleFree(final DownloadLink downloadLink) throws Exception {
        ...
        final Random rnddummy = new Random();
        ...
        final String rc = KEY_EncryptionCreate("RC", "cookie");
    ...
    private String KEY_EncryptionCreate(final String fun, final String value) throws Exception {

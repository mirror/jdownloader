...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "loshare.com","www.loshare.com" }, urls = { "http://oshar(e|a)\\.com/download\\.php\\?id=[a-zA-Z0-9_-]+","http://www\\.oshar(e|a)\\.com/download\\.php\\?id=[a-zA-Z0-9_-]+"  }, flags = { 0,0 })

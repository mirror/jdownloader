...
@HostPlugin(revision = "$Revision: 16510 $", interfaceVersion = 2, names = { "squillion.com" }, urls = { "https?://(www\\.)?squillion\\.com/[a-z0-9]{12}" }, flags = { 0 })
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (filename == null) {
            ...
            if (filename == null) {
                ...
                if (filename == null) {
                    filename = new Regex(br, "Download File:? ?(<[^>]+> ?)+?([^<>\"\\']+)").getMatch(1);
                }
            }
        }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "dosyaupload.com" }, urls = { "https?://(?:www\\.)?dosyaupload\\.com/[A-Za-z0-9]+" })
public class DosyauploadCom extends antiDDoSForHost {
    public DosyauploadCom(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * mods:<br />
     * limit-info: 2017-11-22: No limits at all<br />
     * protocol: no https<br />
     * captchatype: 2017-11-22: null<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://dosyaupload.com";
    private final String                   domains                                      = "(dosyaupload\\.com)";

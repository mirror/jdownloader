...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "jumbload.com" }, urls = { "https?://(?:www\\.)?jumbload\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class JumbloadCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://jumbload.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(jumbload\\.com)";
     ...
     * mods: doFree[method_free-fix]<br />
     * limit-info:<br />
    ...
    public JumbloadCom(PluginWrapper wrapper) {
        super(wrapper);

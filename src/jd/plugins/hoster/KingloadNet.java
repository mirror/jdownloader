...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "kingload.net" }, urls = { "https?://(?:www\\.)?kingload\\.net/[A-Za-z0-9]+" })
public class KingloadNet extends PluginForHost {

    public KingloadNet(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * YetiShareBasic Version 0.8.0-psp<br />
     * mods:<br />
     * limit-info:<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://kingload.net";
    private final String                   domains                                      = "(kingload\\.net)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "rapidstone.com" }, urls = { "https?://(?:www\\.)?rapidstone\\.com/[A-Za-z0-9]+" })
public class RapidstoneCom extends PluginForHost {
     ...
     * YetiShareBasic Version 1.0.0-psp<br />
     * mods:<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://rapidstone.com";

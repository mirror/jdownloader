...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "ifilehosting.net" }, urls = { "http://(www\\.)?ifilehosting\\.net/download\\.php\\?id=[A-Z0-9]+" }, flags = { 0 })
public class IFileHostingNet extends PluginForHost {

    public IFileHostingNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST     = "http://ifilehosting.net";

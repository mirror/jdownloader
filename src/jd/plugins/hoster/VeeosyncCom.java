...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "veeosync.com" }, urls = { "https?://(?:www\\.)?veeosync\\.com/[A-Za-z0-9]+" })
public class VeeosyncCom extends PluginForHost {
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://veeosync.com";
    private final String                   domains                                      = "(veeosync\\.com)";

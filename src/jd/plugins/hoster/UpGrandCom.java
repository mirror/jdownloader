...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "upgrand.com" }, urls = { "https?://(www\\.)?upgrand\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class UpGrandCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://upgrand.com";
    ...
    public UpGrandCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[1] == null) {
            ...
            if (fileInfo[1] == null) fileInfo[1] = new Regex(correctedBR, "</font>[ ]+\\(([^<>\"\\'/]+)\\)(.*?)</font>").getMatch(0);
            if (fileInfo[1] == null) fileInfo[1] = new Regex(correctedBR, "<font style.*?>([\\d\\.]+ ?(KB|MB|GB))</font>").getMatch(0);

...
public class ShareonlineIs extends UnknownHostingScriptCore {
    public ShareonlineIs(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public static String[] domains = new String[] { "share-online.is" };

...
@HostPlugin(revision = "$Revision: 16141 $", interfaceVersion = 2, names = { "upthe.net" }, urls = { "https?://(www\\.)?upthe\\.net/[a-z0-9]{12}" }, flags = { 0 })
public class UpTheNet extends PluginForHost {
    ...
    // mods: long timeouts
    // free: 20 chunks * maxdl(untested, set to 5)
    // premium:
    // protocol: http + https

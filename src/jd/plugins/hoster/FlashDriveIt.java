...
public class FlashDriveIt extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "The file you were looking for could not be found, sorry for any inconvenience|Possible causes of this error could be").matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

        ...
        synchronized (LOCK) {
            try {
                ...
                if (useOldLoginMethod) {
                    br.postPage(this.getProtocol() + this.getHost() + "/login/", "submit=&submitme=1&redirect=&username=" + Encoding.urlEncode(account.getUser()) + "&password=" + Encoding.urlEncode(account.getPass()));

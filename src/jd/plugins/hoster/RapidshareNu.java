...
public class RapidshareNu extends UnknownHostingScriptCore {
    public RapidshareNu(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public static String[] domains = new String[] { "rapidshare.nu" };

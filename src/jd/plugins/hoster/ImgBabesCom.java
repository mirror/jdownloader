...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "imgbabes.com" }, urls = { "https?://(www\\.)?imgbabes\\.com/[a-z0-9]{12}" }) 
public class ImgBabesCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://imgbabes.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(imgbabes\\.com)";
    ...
    public ImgBabesCom(PluginWrapper wrapper) {
        super(wrapper);

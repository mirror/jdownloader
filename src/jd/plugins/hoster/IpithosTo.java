...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "ipithos.to" }, urls = { "https?://(www\\.)?ipithos\\.to/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class IpithosTo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://ipithos.to";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(ipithos\\.to)";
    /*
    ...
    @SuppressWarnings("deprecation")
    public IpithosTo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|File Not Found|>The file expired|glyphicon\\-download\"></span> <small>\\(\\)</small>)").matches()) {

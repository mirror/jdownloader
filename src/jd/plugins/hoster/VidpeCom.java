...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vidpe.com" }, urls = { "https?://(www\\.)?vidpe\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class VidpeCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://vidpe.com";
    ...
    public VidpeCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, Pattern.compile("(No such file|>File Not Found<|>The file was removed by|Reason (of|for) deletion:\n|<img src=\"http://www\\.upmorefiles\\.com/img/No\\-File\\.png\">)", Pattern.CASE_INSENSITIVE)).matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

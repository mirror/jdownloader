...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "coreimg.net" }, urls = { "https?://(?:www\\.)?coreimg\\.net/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class CoreimgNet extends PluginForHost {

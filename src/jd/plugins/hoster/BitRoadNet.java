...
@HostPlugin(revision="$Revision", interfaceVersion=1, names = { "bitroad.net" }, urls = { "http://[\\w\\.]*?(bitroad\\.net|filemashine\\.com|friendlyfiles\\.net|vip4sms\\.com)/download/[A-Fa-f0-9]+" }, flags = { 0 })

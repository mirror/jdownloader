...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "oteupload.com" }, urls = { "https?://(www\\.)?oteupload\\.com/[a-z0-9]{12}" }, flags = { 2 })
public class OteUploadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private static final String  COOKIE_HOST                  = "https://www.oteupload.com";
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(br, "You have requested.*?https?://(www\\.)?" + this.getHost() + "/[A-Za-z0-9]{12}/(.*?)</font>").getMatch(1);
            if (fileInfo[0] == null) {

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "letitload.com" }, urls = { "https?://(www\\.)?letitload\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class LetitloadCom extends PluginForHost {

    public LetitloadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://letitload.com";
    private final String         domains                                      = "(letitload\\.com)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadion.com" }, urls = { "https?://(?:www\\.)?uploadion\\.com/[A-Za-z0-9]+" })
public class UploadionCom extends PluginForHost {

    public UploadionCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://uploadion.com";
    private final String                   domains                                      = "(uploadion\\.com)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filecloud.cc" }, urls = { "https?://(www\\.)?filecloud\\.cc/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FileCloudCc extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://filecloud.cc";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(filecloud\\.cc)";
    ...
    // mods: correctBR[Removed one RegEx as it removed filename from html], checkErrors[Added one more premiumonly text]
    // limit-info:
    // protocol: no https
    ...
    public FileCloudCc(PluginWrapper wrapper) {
        super(wrapper);

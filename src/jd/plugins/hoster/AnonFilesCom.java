...
public class AnonFilesCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        br.getPage("https://api.anonfiles.com/v1/info/" + new Regex(link.getDownloadURL(), "([a-z0-9]{32})$").getMatch(0));
    ...
    public void handleFree(final DownloadLink downloadLink) throws Exception, PluginException {
        ...
        String dllink = br.getRegex("\"(https?://[a-z0-9\\-\\.]+\\.anon\\.[a-z0-9\\-\\.]+/[^<>\"]*?)\"").getMatch(0);
        if (dllink == null) {
            dllink = this.br.getRegex("href=\"(http[^<>\"]*?)\" class=\"download_button\"").getMatch(0);
        }
        if (dllink == null) {
            throw new PluginException(LinkStatus.ERROR_PLUGIN_DEFECT);
        }

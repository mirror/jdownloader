...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "chronos.to" }, urls = { "https?://(www\\.)?chronos\\.to/(embed\\-)?[a-z0-9]{12}" })
public class ChronosTo extends antiDDoSForHost {

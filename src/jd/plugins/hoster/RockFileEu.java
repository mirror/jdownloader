...
public class RockFileEu extends antiDDoSForHost {
    ...
    private static final String  DOMAINS                      = "(rockfile\\.eu|rockfileserver\\.eu)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (br.getURL().contains("/?op=login&redirect=")) {
            ...
            try {
                ...
                getPage(altbr, "https://" + NICE_HOST + "/?op=report_file&id=" + fuid);
    ...
    public void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null && VIDEOHOSTER_2) {
            try {
                ...
                final String embed_access = "https://" + NICE_HOST + "/embed-" + fuid + ".html";
        ...
        for (i1 = 0; i1 < repeat1; i1++) {
            ...
            if (dllink == null) {
                ...
                for (i2 = 0; i2 < repeat2; i2++) {
                    ...
                    /* Captcha START */
                    if (correctedBR.contains("var capCodeV") && !correctedBR.contains("/recaptcha/api/")) {
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        if (availabletraffic == null) {
            availabletraffic = new Regex(correctedBR, "Traffic available today:</td><td><b>([^<>\"]+)</b>").getMatch(0);
        }

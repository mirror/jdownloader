...
public class FileNukeNet extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://filenuke.net";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(filenuke\\.net)";
    /*
    ...
    /* Linktypes */
    private static final String            TYPE_EMBED                      = "https?://[A-Za-z0-9\\-\\.]+/embed\\-[a-z0-9]{12,32}";
    private static final String            TYPE_NORMAL                     = "https?://[A-Za-z0-9\\-\\.]+/[a-z0-9]{12,32}";
    ...
    @SuppressWarnings("deprecation")
    public FileNukeNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String getDllink() {
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                /* Sometimes used for streaming */
                dllink = new Regex(correctedBR, "addVariable\\(\\'file\\', \\'(http[^<>\"]*?)\\'\\)").getMatch(0);
            }
        }
        if (dllink == null && IMAGEHOSTER) {

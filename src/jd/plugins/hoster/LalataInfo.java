...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "sindema.info" }, urls = { "https?://(www\\.)?(lalata|sindema)\\.info/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class LalataInfo extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://sindema.info";
    // domain names used within download links.
    private final String               DOMAINS                      = "((lalata|sindema)\\.info)";
    ...
    // protocol: no https
    // captchatype: null
    // other: no redirects, need to be registered to use the site now..
    // mods:

...
public class GoogleDrive extends PluginForHost {
    ...
    private String getDirecturl(final DownloadLink link, final Account account) throws PluginException {
        if (this.isGoogleDocument(link)) {
            ...
            if (forcedDocumentFinalDownloadlink != null) {
                ...
                /**
                 * Default google docs download format. </br> Not all Google Documents are downloadable as .zip files!
                 */
    ...
    private String getStreamDownloadurl(final Browser br, final DownloadLink link, final Account account) throws PluginException, IOException, InterruptedException {
        ...
        try {
            ...
            if (errorcodeStr != null) {
                ...
                /**
                 * This reason varies depending on the language of the google account in use / header preferred language. </br> It would be
                 * a huge effort to differ between different errormessages so at this moment we will only rely on the error-code.
                 */
                ...
                if (errorCode == 100) {
                    ...
                    /**
                     * Similar to file-download mode: File is definitely not streamable at this moment! </br> Reasons for that may vary and
                     * there can be different reasons given for the same error-code. </br> The original file could still be downloadable via
                     * account but maybe not at this moment.
                     */
    ...
    /**
     * 2021-02-02: Unfinished work! </br> TODO: Add settings for apiID and apiSecret </br>
     */

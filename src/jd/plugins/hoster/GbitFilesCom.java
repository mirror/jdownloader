...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "gbitfiles.com" }, urls = { "https?://(www\\.)?gbitfiles\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class GbitFilesCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://gbitfiles.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(gbitfiles\\.com)";
    ...
    // mods: using mass linkchecker because links can't be checked the normal
    // way
    // non account: 1 * 20
    ...
    public GbitFilesCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 17148 $", interfaceVersion = 2, names = { "gbitfiles.com" }, urls = { "https?://(www\\.)?gbitfiles\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class GbitFilesCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://gbitfiles.com";

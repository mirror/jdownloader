...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "basicupload.com" }, urls = { "https?://(www\\.)?basicupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class BasicUploadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://basicupload.com";

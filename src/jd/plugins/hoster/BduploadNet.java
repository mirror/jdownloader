...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "bdupload.net" }, urls = { "https?://(www\\.)?bdupload\\.net/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class BduploadNet extends PluginForHost {

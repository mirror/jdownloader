...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "1gbpsbox.com" }, urls = { "https?://(?:www\\.)?1gbpsbox\\.com/[A-Za-z0-9]+" }, flags = { 2 })
public class OnegbpsboxCom extends antiDDoSForHost {

    public OnegbpsboxCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://1gbpsbox.com";
    private final String         domains                                      = "(1gbpsbox\\.com)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "mxua.com" }, urls = { "https?://(www\\.)?mxua\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class MxuaCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://mxua.com";
    private static final String  NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    // domain names used within download links.
    private static final String  DOMAINS                      = "(mxua\\.com|seoter\\.com|mxuafiles\\.com)";
    ...
    // mods:requestFileInformation [Access downloadUrl with ".htm" at the end]
    // limit-info:
    // protocol: no https
    // captchatype: 4dignum
    // other:
    ...
    public MxuaCom(PluginWrapper wrapper) {
        super(wrapper);

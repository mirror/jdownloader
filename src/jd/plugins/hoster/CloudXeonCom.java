...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "cloudxeon.com" }, urls = { "http://(www\\.)?cloudxeon\\.com/(?!faq|register|login|terms|report_file|plugins|index|changelog)[a-z0-9]+" }, flags = { 0 })
public class CloudXeonCom extends PluginForHost {

    public CloudXeonCom(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    private final String        MAINPAGE                 = "http://cloudxeon.com";

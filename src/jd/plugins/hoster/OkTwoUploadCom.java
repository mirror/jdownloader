...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "ok2upload.com" }, urls = { "https?://(www\\.)?ok2upload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class OkTwoUploadCom extends PluginForHost {
    ...
    public OkTwoUploadCom(PluginWrapper wrapper) {
        super(wrapper);

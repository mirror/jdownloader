...
@HostPlugin(revision = "$Revision: 17148 $", interfaceVersion = 2, names = { "gptfile.com" }, urls = { "https?://(www\\.)?gptfile\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class GptFileCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://gptfile.com";
    ...
    public GptFileCom(PluginWrapper wrapper) {
        super(wrapper);

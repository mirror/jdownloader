...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "dropapk.com" }, urls = { "https?://(?:www\\.)?dropapk\\.com/(?:embed\\-)?[a-z0-9]{1,12}" })
public class DropapkCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "https://dropapk.com";

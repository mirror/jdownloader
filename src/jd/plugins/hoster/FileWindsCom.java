...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filewinds.com" }, urls = { "https?://(www\\.)?filewinds\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FileWindsCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://filewinds.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(filewinds\\.com)";
    ...
    // free account: 1 * maxdlsFREE
    // premium account: untested, set FREE limits
    // protocol: no https
    // captchatype: 4dignum
    // other:
    ...
    public FileWindsCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[1] == null) {
            fileInfo[1] = new Regex(correctedBR, "\\[<font style=\"color:#114\">([^<>\"]*?)</font>\\]").getMatch(0);
        }

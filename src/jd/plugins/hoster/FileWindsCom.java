...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filewinds.com" }, urls = { "https?://(www\\.)?filewinds\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FileWindsCom extends PluginForHost {
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[1] == null) {
            fileInfo[1] = new Regex(correctedBR, "\\[<font style=\"color:#2859DF\">(\\d+\\.\\d+ (KB|MB|GB))</font>\\]").getMatch(0);
        }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filehost.pw" }, urls = { "https?://(www\\.)?filehost\\.pw/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FileHostPw extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://filehost.pw";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(filehost\\.pw)";
    ...
    // mods: various changes, do NOT upgrade!
    // limit-info: untested because final dllinks timed out --> Set standard limits
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public FileHostPw(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "type=\"hidden\" name=\"fname\" value=\"(.*?)\"").getMatch(0);
        }
        // if (fileInfo[0] == null) {
        // fileInfo[0] = br.getRegex("type=\"hidden\" name=\"fname\" value=\"(.*?)\"").getMatch(0);
        // }
        if (fileInfo[1] == null) {

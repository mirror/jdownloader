...
public class SwatUploadCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://swatupload.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(swatupload\\.com|wolfup\\.net)";
    ...
    public SwatUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|>invalid license_key<|>Mod license violation<)").matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

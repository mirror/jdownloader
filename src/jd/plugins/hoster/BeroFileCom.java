...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "berofile.com" }, urls = { "https?://(www\\.)?berofile\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class BeroFileCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://berofile.com";
    private static final String  NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    // domain names used within download links.
    private static final String  DOMAINS                      = "(berofile\\.com|snakeupload\\.com)";
    ...
    public BeroFileCom(PluginWrapper wrapper) {
        super(wrapper);

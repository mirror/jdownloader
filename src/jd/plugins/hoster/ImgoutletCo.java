...
public class ImgoutletCo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://imgoutlet.co";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(imgoutlet\\.com|imgoutlet\\.co)";
    ...
    public String rewriteHost(String host) {
        if ("imgoutlet.com".equals(getHost())) {
            if (host == null || "imgoutlet.com".equals(host)) {
                return "freakshare.co";
            }
        }
    ...
    public ImgoutletCo(PluginWrapper wrapper) {
        super(wrapper);
        ...
        if (dllink == null && IMAGEHOSTER) {
            ...
            do {
                ...
                if (imghost_next_form != null) {
                    ...
                    imghost_next_form = jd.plugins.hoster.ImgmazeCom.fixImghost_next_form(br, imghost_next_form);

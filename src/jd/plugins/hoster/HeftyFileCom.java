...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "heftyfile.com" }, urls = { "https?://(www\\.)?heftyfile\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class HeftyFileCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://heftyfile.com";
    ...
    public HeftyFileCom(PluginWrapper wrapper) {
        super(wrapper);

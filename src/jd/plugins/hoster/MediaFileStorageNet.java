...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "multishared.me" }, urls = { "https?://(www\\.)?(mediafilestorage\\.net|multishared\\.me)/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
@SuppressWarnings("deprecation")
public class MediaFileStorageNet extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://multishared.me";
    // domain names used within download links.
    private final String               DOMAINS                      = "(mediafilestorage\\.net|multishared\\.me)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "fileinz.com" }, urls = { "https?://(www\\.)?fileinz\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FileinzCom extends PluginForHost {
    ...
    public FileinzCom(PluginWrapper wrapper) {
        super(wrapper);

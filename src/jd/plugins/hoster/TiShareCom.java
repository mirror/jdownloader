...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "tishare.com" }, urls = { "https?://(www\\.)?tishare\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class TiShareCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://tishare.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(tishare\\.com)";

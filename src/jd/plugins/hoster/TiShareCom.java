...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "tishare.com" }, urls = { "https?://(www\\.)?tishare\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class TiShareCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private static final String        COOKIE_HOST                  = "http://tishare.com";
    // domain names used within download links.
    private static final String        DOMAINS                      = "(tishare\\.com)";
     ...
     * */
    public TiShareCom(PluginWrapper wrapper) {
        super(wrapper);

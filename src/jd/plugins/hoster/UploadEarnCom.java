...
public class UploadEarnCom extends PluginForHost {
    public UploadEarnCom(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium("");
    }
    ...
    public String getAGBLink() {
        return "https://upload-earn.com/page/tos";
    }

    private static List<String[]> getPluginDomains() {
        final List<String[]> ret = new ArrayList<String[]>();
        // each entry in List<String[]> will result in one PluginForHost, Plugin.getHost() will return String[0]->main domain
        ret.add(new String[] { "upload-earn.com" });
        return ret;
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        String filesize = br.getRegex("\"[^\"]+\" style=\"[^\"]+\">[^<>]+</a></td>\\s*<td class=\"text-center\">([^<>\"]+)</td>").getMatch(0);
    ...
    private void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            final Form freeform = br.getFormbyKey("referer");
            if (freeform == null) {
            ...
            final Form freeform2 = br.getFormbyActionRegex(".+/download");
            if (freeform2 == null) {
                logger.warning("Failed to find freeform2");
                throw new PluginException(LinkStatus.ERROR_PLUGIN_DEFECT);
            }
            /* 2020-02-18: Skip ~15 seconds of pre-download-waittime here */

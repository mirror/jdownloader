...
@HostPlugin(revision = "$Revision: 17148 $", interfaceVersion = 2, names = { "animegoon.com" }, urls = { "https?://(www\\.)?animegoon\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class AnimeGoonCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://animegoon.com";
    ...
    public AnimeGoonCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "hippohosted.com" }, urls = { "http://(www\\.)?hippohosted\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class HippoHostedCom extends PluginForHost {
    ...
    /* Other constants */
    private final String         MAINPAGE                                     = "http://hippohosted.com";

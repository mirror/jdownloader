...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "lemuploads.com" }, urls = { "https?://(www\\.)?lemuploads\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class LemUploadsCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://lemuploads.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(lemuploads\\.com)";
     ...
     * */
    public LemUploadsCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "files2upload.net" }, urls = { "https?://(www\\.)?files2upload\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FilesTwoUploadNet extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://files2upload.net";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(files2upload\\.net)";

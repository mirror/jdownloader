...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "bezsms.org" }, urls = { "https?://(www\\.)?bezsms\\.org/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class BezsmsOrg extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://bezsms.org";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(bezsms\\.org)";
    ...
    public BezsmsOrg(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vidd.tv" }, urls = { "https?://(www\\.)?vidd\\.tv/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ViddTv extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://vidd.tv";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(vidd\\.tv)";
    /* Linktypes */
    ...
    // mods: waittime before download1, other waittime RegEx
    // limit-info:
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public ViddTv(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        if (ttt == null) {
            ttt = new Regex(correctedBR, "<span id=\"[a-z0-9]+\">(\\d+)</span> seconds</span>").getMatch(0);
        }
        if (ttt != null) {

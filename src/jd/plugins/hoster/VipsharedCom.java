...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vip-shared.com" }, urls = { "https?://(?:www\\.)?vip\\-shared\\.com/[A-Za-z0-9]+" })
public class VipsharedCom extends PluginForHost {

    public VipsharedCom(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * mods: requestFileInformation[Added one extra filename RegEx]<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://vip-shared.com";
    private final String                   domains                                      = "(vip\\-shared\\.com)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        if (available_CHECK_OVER_INFO_PAGE) {
            ...
            if (filename == null) {
                /* 2016-11-09: Special */
                filename = this.br.getRegex(">([^<>\"]+) Informações<").getMatch(0);
            }
            if (filename == null) {

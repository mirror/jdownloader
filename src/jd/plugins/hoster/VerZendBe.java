...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "verzend.be" }, urls = { "https?://(www\\.)?verzend\\.be/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class VerZendBe extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://verzend.be";
    // domain names used within download links.
    private final String               DOMAINS                      = "(verzend\\.be)";
    ...
    // protocol: no https
    // captchatype: null
    // other: no redirects, videohoster bypasses limit

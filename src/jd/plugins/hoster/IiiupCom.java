...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "iiiup.com" }, urls = { "https?://(www\\.)?iiiup\\.com/[A-Za-z0-9]+" }, flags = { 2 })
public class IiiupCom extends PluginForHost {

    public IiiupCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    // mods: force login on every download
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://iiiup.com";
    private final String         domains                                      = "(iiiup\\.com)";

...
@HostPlugin(revision = "$Revision: 17424 $", interfaceVersion = 2, names = { "ishareupload.com" }, urls = { "https?://(www\\.)?ishareupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class IShareUploadCom extends PluginForHost {
    ...
    // mods:
    // non account: 1 (no resume) * unlimted? (20h wait betwen files)
    // free account:
    // premium account:
    // protocol: no https

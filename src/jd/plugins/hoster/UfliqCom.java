...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "ufliq.com" }, urls = { "https?://(www\\.)?ufliq\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class UfliqCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://ufliq.com";
    ...
    public UfliqCom(PluginWrapper wrapper) {
        super(wrapper);

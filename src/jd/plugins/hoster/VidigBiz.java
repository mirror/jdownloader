...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vidig.biz" }, urls = { "https?://(www\\.)?vidig\\.biz/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class VidigBiz extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String            COOKIE_HOST                  = "http://vidig.biz";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    // domain names used within download links.
    private static final String            DOMAINS                      = "(vidig\\.biz)";
    ...
    public VidigBiz(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        link.setFinalFileName(fileInfo[0].trim() + ".flv");
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "id=\"file_title\">([^<>\"]*?)</td>").getMatch(0);
            if (fileInfo[0] == null) {
    ...
    public void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null && VIDEOHOSTER) {
            try {
                ...
                getPage(COOKIE_HOST + "/embed-" + fuid + ".html");

...
@HostPlugin(revision = "$Revision: 15600 $", interfaceVersion = 2, names = { "sugarsync.com" }, urls = { "https?://(www\\.)?sugarsync\\.com/pf/D[\\d\\_]+" }, flags = { 0 })
public class SugarSyncCom extends PluginForHost {
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        String dllink = "https://www.sugarsync.com/pf/" + uid + "?directDownload=true";

...
public class FileddCom extends antiDDoSForHost {
    /* 1st domain = current domain! */
    public static String[] domains = new String[] { "filedd.com" };
    ...
    private final String         COOKIE_HOST                        = ("http://www." + domains[0]).replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    ...
    public FileddCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        // br.getHeaders().put("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8");

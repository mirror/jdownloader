...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "xtilourbano.info" }, urls = { "https?://(www\\.)?xtilourbano\\.info/[a-z0-9]{12}" }, flags = { 0 })
public class XtiloUrbanoInfo extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://xtilourbano.info";
    ...
    public XtiloUrbanoInfo(PluginWrapper wrapper) {
        super(wrapper);

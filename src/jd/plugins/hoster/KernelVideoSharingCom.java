...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "webcamsbabe.com", "privat-zapisi.biz" }, urls = { "https?://(?:www\\.)?webcamsbabe\\.com/videos/\\d+\\-[a-z0-9\\-]+\\.html", "https?://(?:www\\.)?privat-zapisi\\.biz/videos/\\d+\\-[a-z0-9\\-]+\\.html" })

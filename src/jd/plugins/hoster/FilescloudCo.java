...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "filescloud.co" }, urls = { "https?://(?:www\\.)?filescloud\\.co/(?:embed\\-)?[a-z0-9]{12}" })
public class FilescloudCo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://filescloud.co";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(filescloud\\.co)";
     ...
     * mods:<br />
     * limit-info: 2017-01-20:Untested as all final URLs lead to response 403<br />
    ...
    @SuppressWarnings("deprecation")
    public FilescloudCo(PluginWrapper wrapper) {
        super(wrapper);

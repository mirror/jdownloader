...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "toofile.com" }, urls = { "https?://(?:www\\.)?toofile\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class ToofileCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://toofile.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:toofile\\.com)";
     ...
     ****************************
     * mods:<br />
     * limit-info: Premium untested, set FREE account limit<br />
    ...
    public ToofileCom(PluginWrapper wrapper) {
        super(wrapper);

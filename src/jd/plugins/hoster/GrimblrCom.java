...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "grimblr.com" }, urls = { "https?://(?:www\\.)?grimblr\\.com/[A-Za-z0-9]+" })
public class GrimblrCom extends PluginForHost {

    public GrimblrCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://grimblr.com";
    private final String                   domains                                      = "(grimblr\\.com)";

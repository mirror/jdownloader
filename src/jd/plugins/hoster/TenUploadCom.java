...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "10upload.com" }, urls = { "http://(www\\.)?10upload\\.com/[a-z0-9]{12}" }, flags = { 2 })
public class TenUploadCom extends PluginForHost {
    ...
    // XfileSharingProBasic Version 2.3.0.1, added 1 filesize regex, replaced
    // premiumtext & edited expire-regex
    @Override
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) filesize = new Regex(BRBEFORE, "<strong>File size:</strong> (.*?)<br>").getMatch(0);
            }
        }

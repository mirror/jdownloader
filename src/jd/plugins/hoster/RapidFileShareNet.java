...
@HostPlugin(revision = "$Revision: 17639 $", interfaceVersion = 2, names = { "rapidfileshare.net" }, urls = { "https?://(www\\.)?rapidfileshare\\.net/[a-z0-9]{12}" }, flags = { 0 })
public class RapidFileShareNet extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://rapidfileshare.net";
    ...
    public RapidFileShareNet(PluginWrapper wrapper) {
        super(wrapper);

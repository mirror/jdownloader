...
public class MiraVideosNet extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://www.miravideos.net/contact_us.html";
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (br.getURL().contains("miravideos.net/404.php") || br.getHttpConnection().getResponseCode() == 404) {
        ...
        if (DLLINK == null) {
            DLLINK = br.getRegex("\"file\":[\t\n\r ]+\"(http://(www\\.)?miravideos\\.net/[^<>\"]*?)\"").getMatch(0);
        }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "epload.co" }, urls = { "https?://(?:www\\.)?epload\\.co/(?:embed\\-)?[a-z0-9]{12}" })
public class EploadCo extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://epload.co".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:epload\\.co)";
    ...
    public EploadCo(PluginWrapper wrapper) {
        super(wrapper);

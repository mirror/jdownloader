...
public class PornHubCom extends PluginForHost {
    ...
    public void init() {
        ...
        try {
            Class.forName("org.appwork.utils.net.httpconnection.SSLSocketStreamOptionsModifier");
    ...
    public void clean() {
        try {
            ...
            if (modifier != null) {
                HTTPConnectionImpl.removeSSLSocketStreamOptionsModifier((SSLSocketStreamOptionsModifier) modifier);
                modifier = null;
            }
        }
    }

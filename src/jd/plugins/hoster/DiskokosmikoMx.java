...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "diskokosmiko.mx" }, urls = { "http://diskokosmikodecrypted\\.com/\\d+" })
public class DiskokosmikoMx extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://diskokosmiko.mx/terms-of-service";
    }
    ...
    private static final String MAINPAGE = "http://diskokosmiko.mx";

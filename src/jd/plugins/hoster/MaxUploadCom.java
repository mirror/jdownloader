...
public class MaxUploadCom extends PluginForHost {
    ...
    private static final String MAINPAGE      = "http://www.maxupload.com";
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        dl = jd.plugins.BrowserAdapter.openDownload(br, downloadLink, getLink, "task=download", true, 0);

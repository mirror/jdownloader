...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "wstream.video" }, urls = { "https?://(?:www\\.)?wstream\\.video/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class WstreamVideo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://wstream.video";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(wstream\\.video)";
    ...
    public WstreamVideo(PluginWrapper wrapper) {
        super(wrapper);

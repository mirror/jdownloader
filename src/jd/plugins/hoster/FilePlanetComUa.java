...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "fileplanet.com.ua" }, urls = { "https?://(www\\.)?fileplanet\\.com\\.ua/[a-z0-9]{12}" }, flags = { 0 })
public class FilePlanetComUa extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) filesize = new Regex(correctedBR, ">Size:</font> <b>([^<>\"\\']+)</b></h3").getMatch(0);
        }
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        doFree(downloadLink, true, -5, true);
    }
    ...
    public void doFree(DownloadLink downloadLink, boolean resumable, int maxchunks, boolean getLinkWithoutLogin) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            if (correctedBR.contains("\"download1\"")) {
                br.postPage(downloadLink.getDownloadURL(), "op=download1&usr_login=&id=" + fid + "&fname=" + Encoding.urlEncode(downloadLink.getName()) + "&referer=&method_free=Free+Download");
                doSomething();
                checkErrors(downloadLink, false, passCode);
            }
            dllink = getDllink();
        ...
        if (dllink == null) {
            ...
            br.getPage("http://fileplanet.com.ua/?op=download2&id=" + fid + "&s=" + s + "&ajax=1");
            doSomething();
            checkErrors(downloadLink, true, passCode);
            dllink = getDllink();
    ...
    public String getDllink() {
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                ...
                if (dllink == null) {
                    dllink = new Regex(correctedBR, "\"(http://" + this.getHost() + "/d/[a-z0-9]+/[^<>\"\\'/]+)\"").getMatch(0);
                    if (dllink == null) {

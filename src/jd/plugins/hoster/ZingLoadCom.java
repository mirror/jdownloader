...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "zingload.com" }, urls = { "https?://(www\\.)?zingload\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
...
public class ZingLoadCom extends PluginForHost {
    ...
    private final String               DOMAINS                      = "(easybytes\\.to|easybytes\\.com|zingload\\.com)";

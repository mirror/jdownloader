...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "anotheruploads.net" }, urls = { "https?://(www\\.)?anotheruploads\\.net/[A-Za-z0-9]+" }, flags = { 0 })
public class AnotherUploadsNet extends PluginForHost {

    public AnotherUploadsNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://anotheruploads.net";
    private final String         domains                                      = "(anotheruploads\\.net)";

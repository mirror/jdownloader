...
public class XtshareCom extends PluginForHost {
    ...
    public XtshareCom(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Override
    public String getAGBLink() {
        return "http://xtshare.com/tos.php";
    }
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws Exception {
        ...
        br.getPage(dllink);
        if (br.containsHTML("<title>This Video has been removed") || br.getURL().endsWith("404.htm")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
        Form iAmHuman = br.getFormbyProperty("name", "form1");

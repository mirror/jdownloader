...
public class DoneVideoCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://donevideo.com";
    ...
    // In case downloads are not possible because of their adware stuff
    private static final boolean DOWNLOADS_IMPOSSIBLE         = true;
    ...
    public DoneVideoCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (DOWNLOADS_IMPOSSIBLE) {
            link.getLinkStatus().setStatusText("Download not possible");
        }
        return AvailableStatus.TRUE;
    }
    ...
    public void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        if (DOWNLOADS_IMPOSSIBLE) throw new PluginException(LinkStatus.ERROR_FATAL, "Download not possible");

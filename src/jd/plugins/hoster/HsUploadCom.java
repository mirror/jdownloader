...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "hsupload.com" }, urls = { "http://(www\\.)?hsupload\\.(com|net)/\\?dw?=[A-Z0-9]+" }, flags = { 0 })
public class HsUploadCom extends PluginForHost {

    public HsUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Override
    public String getAGBLink() {
        return "http://hsupload.com/";
    }

    public void correctDownloadLink(DownloadLink link) {
        link.setUrlDownload(link.getDownloadURL().replace("hsupload.net/", "hsupload.com/").replace("/?dw=", "?d="));
    }
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        br.getPage(downloadLink.getDownloadURL().replace("hsupload.com/?d=", "hsupload.com/?dw="));

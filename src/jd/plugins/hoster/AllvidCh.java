...
public class AllvidCh extends PluginForHost {
    ...
    // other: special: video-title inside html is crypted!
    ...
    @SuppressWarnings("deprecation")
    public AllvidCh(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "<h3 class=\"nomargin\" id[\t\n\r ]*?=\"title\">([^<>\"]*?)</h3>").getMatch(0);
        }

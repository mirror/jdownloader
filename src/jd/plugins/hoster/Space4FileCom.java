...
public class Space4FileCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST   = "http://space4file.com";

    public boolean              NOPREMIUM     = false;

    public Space4FileCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    // XfileSharingProBasic Version 2.1.1.2, added 1 filesize regex, skipped
    // waittime on reCaptcha handling
    @Override
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) filesize = new Regex(BRBEFORE, "<b>\\| (.*?)</b>").getMatch(0);
            }
        }

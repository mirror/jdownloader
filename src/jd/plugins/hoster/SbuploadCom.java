...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "sbupload.com" }, urls = { "https?://(?:www\\.)?(?:sbupload|usersdownload)\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class SbuploadCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://usersdownload.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(usersdownload\\.com)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "downflow.net" }, urls = { "https?://(www\\.)?downflow\\.net/[a-z0-9]{12}" })
public class DownFlowNet extends PluginForHost {
    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://downflow.net";
    ...
    // mods: extra errorhandling before downloadstart
    // non account: 1 * 1
    // free account:
    // premium account:
    // protocol: no https
    ...
    public DownFlowNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>Not Found<|>File Not Found<|>The file was removed by|Reason (of|for) deletion:\n)").matches()) {

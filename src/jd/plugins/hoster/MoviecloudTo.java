...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "moviecloud.to" }, urls = { "https?://(?:www\\.)?moviecloud\\.to/[A-Za-z0-9]+" }, flags = { 0 })
public class MoviecloudTo extends PluginForHost {

    public MoviecloudTo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://moviecloud.to";
    private final String         domains                                      = "(moviecloud\\.to)";

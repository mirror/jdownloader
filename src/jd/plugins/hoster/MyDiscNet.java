...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "mydisc.net" }, urls = { "https?://(www\\.)?mydisc\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class MyDiscNet extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://mydisc.net";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(mydisc\\.net)";
    ...
    public MyDiscNet(PluginWrapper wrapper) {
        super(wrapper);

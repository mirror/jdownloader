...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "upafile.com" }, urls = { "https?://(www\\.)?upafile\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class UpaFileCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://upafile.com";
    ...
    public UpaFileCom(PluginWrapper wrapper) {
        super(wrapper);

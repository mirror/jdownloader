...
public class UploadhiveCom extends XFileSharingProBasic {
    public UploadhiveCom(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info: 2020-06-02: No limits at all <br />
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "uploadhive.com" });
        return ret;
    }

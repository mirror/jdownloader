...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "wdfiles.ru" }, urls = { "https?://(?:www\\.)?wdfiles\\.ru/[A-Za-z0-9]+" }, flags = { 0 })
public class WdfilesRu extends PluginForHost {
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://wdfiles.ru";
    private final String                   domains                                      = "(wdfiles\\.ru)";

...
public class ModsbaseCom extends antiDDoSForHost {
    /* 1st domain = current domain! */
    public static String[] domains = new String[] { "modsbase.com", "uploadfiles.eu", "modsbasedl.com" };
     ...
     * limit-info: 2019-01-29: Premium untested, set FREE account limits<br />
     * captchatype: 2019-01-29: null<br />
     * other:<br />
     */
    @Override
    ...
    public String rewriteHost(String host) {
        if (host == null || "uploadfiles.eu".equals(host)) {
            return "modsbase.com";
        }
    ...
    public ModsbaseCom(PluginWrapper wrapper) {
        super(wrapper);

...
public class ImagePorterCom extends PluginForHost {
    ...
    // XfileSharingProBasic Version 2.5.0.7, added 2 dllink regexes
    @Override
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                ...
                if (dllink == null) {
                    ...
                    if (dllink == null) {
                        dllink = new Regex(BRBEFORE, "HREF=\"javascript:bookilsfx\\(\\)\" ><img src=\"(http://.*?)\"").getMatch(0);
                        if (dllink == null) {
                            dllink = new Regex(BRBEFORE, "\"(http://img\\d+\\.imageporter\\.com/i/\\d+/[a-z0-9]{12}.*?)\"").getMatch(0);
                            if (dllink == null) {

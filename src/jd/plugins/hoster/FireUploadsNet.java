...
@HostPlugin(revision = "$Revision: 16650 $", interfaceVersion = 2, names = { "fireuploads.net" }, urls = { "https?://(www\\.)?fireuploads\\.net/[a-z0-9]{12}" }, flags = { 0 })
public class FireUploadsNet extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://fireuploads.net";
    ...
    public FireUploadsNet(PluginWrapper wrapper) {
        super(wrapper);

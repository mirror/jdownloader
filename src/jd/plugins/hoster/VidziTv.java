...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vidzi.tv" }, urls = { "https?://(www\\.)?vidzi\\.tv/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class VidziTv extends PluginForHost {
    ...
    public String getDllink() {
        ...
        if (dllink == null) dllink = new Regex(correctedBR, "file: \"(http://[^<>\"]*?\\.mp4)\"").getMatch(0);
        return dllink;
    }

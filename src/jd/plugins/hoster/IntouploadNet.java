...
public class IntouploadNet extends antiDDoSForHost {
    /* 1st domain = current domain! */
    public static String[] domains = new String[] { "intoupload.net" };
    ...
    public IntouploadNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String getFnameViaAbuseLink(final Browser br, final DownloadLink dl) throws Exception {
        ...
        if (StringUtils.isEmpty(filename)) {
            filename = br.getRegex(">Filename</label>\\s*?<div[^>]+><span>([^<>\"]+)</span>").getMatch(0);
        }
        return filename;
    }

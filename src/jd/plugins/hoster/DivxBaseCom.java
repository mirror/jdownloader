...
@HostPlugin(revision = "$Revision: 16216 $", interfaceVersion = 2, names = { "divxbase.com" }, urls = { "https?://(www\\.)?divxbase\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class DivxBaseCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://divxbase.com";
    ...
    public DivxBaseCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "fileupload.pw" }, urls = { "https?://(www\\.)?fileupload\\.pw/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FileuploadPw extends PluginForHost {
    ...
    // mods:
    // limit-info: totally untested, no free downloadable links available and registration closed
    // protocol: no https
    // captchatype: unknown
    // other:

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filefolks.com" }, urls = { "https?://(www\\.)?filefolks\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FilefolksCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://filefolks.com";
    ...
    public FilefolksCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "mediafree.co" }, urls = { "https?://(www\\.)?mediafree\\.co/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class MediaFreeCo extends PluginForHost {
    ...
    public MediaFreeCo(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 16643 $", interfaceVersion = 2, names = { "filestay.com" }, urls = { "https?://(www\\.)?filestay\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileStayCom extends PluginForHost {
    ...
    // mods: checkerrors(premium only file)

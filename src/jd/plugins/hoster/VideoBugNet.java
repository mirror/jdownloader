...
@HostPlugin(revision = "$Revision: 21813 $", interfaceVersion = 2, names = { "videobug.net" }, urls = { "http://(www\\.)?videobug\\.net/embed\\.php\\?.+" }, flags = { 0 })
public class VideoBugNet extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws Exception {
        ...
        dllink = br.getRegex("url: '(http[^']+videobug\\.net%2Fvideos[^']+)").getMatch(0);

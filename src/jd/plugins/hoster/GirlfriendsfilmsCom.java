...
import org.jdownloader.plugins.components.config.EvilangelCoreConfigGirlfriendsfilms;
...
public class GirlfriendsfilmsCom extends EvilangelCore {
    ...
    private static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "girlfriendsfilms.com" });
        return ret;
    }
    ...
    public static String[] getAnnotationUrls() {
        ...
        for (final String[] domains : getPluginDomains()) {
            ret.add("https?://members\\." + buildHostsPatternPart(domains) + "/[a-z]{2}/movie/[^/]+(?:/[A-Za-z0-9\\-_]+)?/\\d+");
        }
    ...
    public Class<? extends EvilangelCoreConfig> getConfigInterface() {
        return EvilangelCoreConfigGirlfriendsfilms.class;
    }
}
...
public class MegaUp1oadNet extends PluginForHost {
    ...
    private final String         COOKIE_HOST                  = "http://megaup1oad.net";
    ...
    // mods:
    // non account: 1(tested with two) * unlimted?
    // free account:
    // premium account:
    // protocol: no https
    // captchatype: 4dignum
    // other: no redirects
    // other: serious connection issues. locked to small chunks to prevent chunk related connection issues.
    ...
    public MegaUp1oadNet(PluginWrapper wrapper) {
        super(wrapper);

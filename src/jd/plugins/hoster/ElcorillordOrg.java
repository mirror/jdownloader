...
@HostPlugin(revision = "$Revision: 17860 $", interfaceVersion = 2, names = { "elcorillord.org" }, urls = { "https?://(www\\.)?elcorillord\\.org/[a-z0-9]{12}" }, flags = { 0 })
public class ElcorillordOrg extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://elcorillord.org";
    ...
    public ElcorillordOrg(PluginWrapper wrapper) {
        super(wrapper);

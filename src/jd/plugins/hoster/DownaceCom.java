...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "downace.com" }, urls = { "https?://(?:www\\.)?downace\\.com/[A-Za-z0-9]+" }, flags = { 2 })
public class DownaceCom extends PluginForHost {
     ...
     * mods: doFree[Added Form handling]<br />
     * limit-info:<br />
     * protocol: https<br />
     * captchatype: null<br />
     * other:<br />
        ...
        if (continue_link != null) {
            ...
            for (int i = 1; i <= 5; i++) {
                ...
                if (i == 1 && continue_link == null && dlform == null) {
                    ...
                    throw new PluginException(LinkStatus.ERROR_PLUGIN_DEFECT);
                } else if (continue_link == null && dlform == null) {

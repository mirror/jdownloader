...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "duckload.co" }, urls = { "https?://(www\\.)?(duckload\\.co|fireloading\\.com)/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class DuckLoadCo extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://duckload.co";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(duckload\\.co|fireloading\\.com)";
    ...
    public DuckLoadCo(PluginWrapper wrapper) {
        super(wrapper);

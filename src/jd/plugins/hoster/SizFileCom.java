...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "sizfile.com" }, urls = { "https?://(www\\.)?sizfile\\.com/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class SizFileCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://sizfile.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(sizfile\\.com)";
    ...
    // captchatype: 4dignum
    // other: no redirects
    // mods: times out a lot... set prepBrowser timeout values
     ...
     * */
    public SizFileCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadman.com" }, urls = { "http://(www\\.)?uploadman\\.com/[a-z0-9]+" }, flags = { 0 })
public class UploadManCom extends PluginForHost {

    public UploadManCom(PluginWrapper wrapper) {
        super(wrapper);
    }

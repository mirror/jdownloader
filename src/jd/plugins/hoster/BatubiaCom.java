...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "batubia.com" }, urls = { "http://(www\\.)?batubia\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class BatubiaCom extends PluginForHost {

    public BatubiaCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST   = "http://batubia.com";

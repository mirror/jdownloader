...
public class FilebonusCom extends antiDDoSForHost {
    /* 1st domain = current domain! */
    public static String[] domains = new String[] { "filebonus.com" };
    ...
    /**
     * DEV NOTES XfileSharingProBasic Version 2.7.8.2<br />
     ****************************
    ...
    public FilebonusCom(PluginWrapper wrapper) {
        super(wrapper);

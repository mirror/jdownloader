...
@HostPlugin(revision = "$Revision: 16510 $", interfaceVersion = 2, names = { "pizzaupload.com" }, urls = { "https?://(www\\.)?pizzaupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class PizzaUploadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://pizzaupload.com";
    ...
    public PizzaUploadCom(PluginWrapper wrapper) {
        super(wrapper);

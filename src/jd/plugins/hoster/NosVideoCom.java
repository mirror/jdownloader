...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "nosvideo.com" }, urls = { "https?://(?:www\\.)?nosvideo\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class NosVideoCom extends PluginForHost {
    ...
    private final String         domains                                      = "(nosvideo\\.com)";
        ...
        try {
            ...
            if (continue_link != null) {
                ...
                for (int i = 1; i <= 5; i++) {
                    ...
                    if (i == 2) {
                        continue_link = "http://nosvideo.com/vj/video.php?u=" + fid + "&w=&h=530";
                    }

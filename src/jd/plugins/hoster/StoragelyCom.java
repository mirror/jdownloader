...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "storagely.com" }, urls = { "https?://(www\\.)?storagely\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class StoragelyCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private static final String        COOKIE_HOST                  = "http://storagely.com";
    // domain names used within download links.
    private static final String        DOMAINS                      = "(storagely\\.com)";
    ...
    // other: no redirects, totalMaxSimFreeDownload not set but hoster has 1.5 hour wait times between free dl's

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadnet.co" }, urls = { "https?://(www\\.)?uploadnet\\.co/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class UploadnetCo extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://uploadnet.co";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(uploadnet\\.co)";
    /* Linktypes */
    ...
    @SuppressWarnings("deprecation")
    public UploadnetCo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        /* Filesize is not given on mainpage */
        // if (fileInfo[1] == null) {

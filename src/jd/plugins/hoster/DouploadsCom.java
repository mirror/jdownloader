...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "douploads.com" }, urls = { "https?://(?:www\\.)?douploads\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class DouploadsCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://douploads.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:douploads\\.com)";
     ...
     ****************************
     * mods:<br />
     * limit-info: 2018-02-09: No limits at all<br />
    ...
    public DouploadsCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String getFnameViaAbuseLink(final Browser br, final DownloadLink dl) throws Exception {
        ...
        return br.getRegex(">Filename.*?>([^<>]*?)</").getMatch(0);
    }

...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "up.msrem.com" }, urls = { "https?://(www\\.)?up\\.msrem\\.com/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class MsremCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://up.msrem.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(msrem\\.com)";
     ...
     * */
    public MsremCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

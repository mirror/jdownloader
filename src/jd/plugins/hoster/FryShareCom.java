...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "fryshare.com" }, urls = { "http://[\\w\\.]*?fryshare\\.com/.+/.+" }, flags = { 0 })
public class FryShareCom extends PluginForHost {

    public FryShareCom(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Override
    public String getAGBLink() {
        return "http://www.fryshare.com/tos.html";
    }
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        br.setCookie("http://www.fryshare.com", "lang", "english");
        ...
        // This filesize regex is specefied for the hoster, everything else is
        // the XFileSharingProBasic Plugin configuratin!
        if (filesize == null) filesize = br.getRegex("File Size:</b>(.*?)</span></td>").getMatch(0);
        if (filename == null) {
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        if (br.containsHTML("You have to wait")) {
            logger.info("Detected waittime #1");
        ...
        if (br.containsHTML("You have reached the download-limit")) {
            logger.info("Detected waittime #2");

...
public class OneLinxNet extends XFileSharingProBasic {
    public OneLinxNet(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * other:<br />
     */
    private static String[] domains = new String[] { "1linx.net", "cloudyfiles.me", "cloudyfiles.co", "cloudyfiles.com", "cloudyfiles.net", "cfiles.me", "cfiles.co", "cfiles.com", "cfiles.net", "businessnews.online", "businessnewslive2018.online", "businessnewscurrent.online" };

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "secureupload.eu" }, urls = { "https?://(www\\.)?secureupload\\.eu/[a-z0-9]{12}" }, flags = { 0 })
public class SecureUploadEu extends PluginForHost {
    ...
    private String[] scanInfo(String[] fileInfo) {
        ...
        if (fileInfo[1] == null) {
            fileInfo[1] = new Regex(correctedBR, " <h3>([^<>\"]*?)</h3>").getMatch(0);
        }

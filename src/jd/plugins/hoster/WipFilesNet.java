...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "wipfiles.net" }, urls = { "https?://(www\\.)?wipfiles\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class WipFilesNet extends PluginForHost {
    ...
    // mods:checkErrors [added new premiumonly regex]
    // non account: 1 * 1

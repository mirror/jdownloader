...
public class CrisShareCom extends PluginForHost {
    ...
    public void checkErrors(final DownloadLink theLink, final boolean checkAll) throws NumberFormatException, PluginException {
        ...
        if (correctedBR.contains("DOWNLOAD is not available at the moment")) {
            throw new PluginException(LinkStatus.ERROR_TEMPORARILY_UNAVAILABLE, "Download not available at the moment", 10 * 60 * 1000l);
        }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "crisshare.com" }, urls = { "https?://(www\\.)?crisshare\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class CrisShareCom extends PluginForHost {

    private String                 correctedBR                  = "";
    private String                 passCode                     = null;
    private static final String    PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String    COOKIE_HOST                  = "http://crisshare.com";
    private static final String    NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String    NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String    DOMAINS                      = "(crisshare\\.com)";
    ...
    // mods: one extra case errorhandling
    // limit-info:
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public CrisShareCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void checkErrors(final DownloadLink theLink, final boolean checkAll) throws NumberFormatException, PluginException {
        ...
        if (correctedBR.contains("DOWNLOAD is not available at the moment")) throw new PluginException(LinkStatus.ERROR_TEMPORARILY_UNAVAILABLE, "Download not available at the moment", 10 * 60 * 1000l);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "keeload.com" }, urls = { "https?://(www\\.)?keeload\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class KeeloadCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://keeload.com";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(keeload\\.com)";
    ...
    public KeeloadCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filedwon.net", "filedwon.com" }, urls = { "https?://(www\\.)?filedwon\\.(com|net|info)/[a-z0-9]{12}", "589ut90j59ujktojhzDELETE_MErf56uj43zgfjz" }, flags = { 2, 0 })
public class FileDwonCom extends PluginForHost {
    ...
    public void checkServerErrors() throws NumberFormatException, PluginException {
        ...
        if (new Regex(correctedBR, "(File Not Found|<h1>404 Not Found</h1>)").matches() || dl.getConnection().getResponseCode() == 404) throw new PluginException(LinkStatus.ERROR_TEMPORARILY_UNAVAILABLE, "Server error 404", 30 * 60 * 1000l);
    }

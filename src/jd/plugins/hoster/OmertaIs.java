...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "omerta.is" }, urls = { "https?://(www\\.)?omerta\\.is/[A-Za-z0-9]+" }, flags = { 0 })
public class OmertaIs extends PluginForHost {
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://omerta.is";
    private final String         domains                                      = "(omerta\\.is)";

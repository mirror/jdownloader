...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "rapidtraffic.pl" }, urls = { "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32423" }) 
    ...
    public void handleMultiHost(final DownloadLink link, final Account account) throws Exception {
        ...
        // error
        {
            ...
            if (br.containsHTML("<div id=\"message\">Ważność linka wygasła.</div>")) {
                ...
                logger.info("Rapidtraffic.pl: previously generated link expired - removing it and restarting download process.");
                link.setProperty("generatedLinkRapidtraffic", null);

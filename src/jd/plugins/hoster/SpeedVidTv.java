...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "speedvid.tv" }, urls = { "https?://(www\\.)?speedvid\\.tv/[a-z0-9]{12}" }, flags = { 0 })
public class SpeedVidTv extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://speedvid.tv";
    ...
    public SpeedVidTv(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "<td colspan=2 id=\"file_title\">[\t\n\r ]+\\&nbsp;\\&nbsp;\\&nbsp;\\&nbsp;\\&nbsp;([^<>\"]*?)</td></tr>").getMatch(0);
        }
        if (fileInfo[1] == null) {

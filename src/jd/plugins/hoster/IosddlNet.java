...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "iosddl.net" }, urls = { "https?://(?:www\\.)?iosddl\\.net/[A-Za-z0-9]+" })
public class IosddlNet extends antiDDoSForHost {
     ...
     * mods:<br />
     * limit-info: 2018-04-12: Untested as site was very slow<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://iosddl.net";
    private final String                   domains                                      = "(iosddl\\.net)";

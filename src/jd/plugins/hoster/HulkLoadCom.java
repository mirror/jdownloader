...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "hulkload.com" }, urls = { "https?://(www\\.)?hulkload\\.com/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 2 })
...
public class HulkLoadCom extends PluginForHost {
    ...
    private final String               DOMAINS                      = "(hulkload\\.com)";
     ...
     * */
    public HulkLoadCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

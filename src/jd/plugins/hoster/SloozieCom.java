...
public class SloozieCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (downloadLink.getDownloadURL().matches(PICLINK)) {
            ...
            filename = Encoding.htmlDecode(filename) + ".flv";
        }
    ...
    public void handleFree(final DownloadLink downloadLink) throws Exception {
        ...
        if (!downloadLink.getDownloadURL().matches(PICLINK)) throw new PluginException(LinkStatus.ERROR_FATAL, "Sloozie videos aren't downloadable yet, plugin is not yet 100% finished!");

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "vidgot.com" }, urls = { "https?://(?:www\\.)?vidgot\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class VidgotCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://vidgot.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(vidgot\\.com)";
     ...
     * mods: scanInfo[Added one more filename RegEx]<br />
     * limit-info:<br />
    ...
    public VidgotCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadify.net" }, urls = { "https?://(?:www\\.)?uploadify\\.net/[A-Za-z0-9]+" })
public class UploadifyNet extends PluginForHost {
     ...
     * mods:<br />
     * limit-info: 2017-01-20: Premium untested, set FREE account limits<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://uploadify.net";
    private final String                   domains                                      = "(uploadify\\.net)";
    ...
    private static final int               free_MAXDOWNLOADS                            = 21;
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        if (!br.containsHTML(">\\s*(?:PAID USER|USUARIO DE PAGO)\\s*</")) {

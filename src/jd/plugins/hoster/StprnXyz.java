...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "stprn.xyz" }, urls = { "https?://(?:www\\.)?stprn\\.xyz/(?:plugins/mediaplayer/site/_embed\\.php\\?u=)?[A-Za-z0-9]+" })
public class StprnXyz extends antiDDoSForHost {
    public StprnXyz(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://stprn.xyz";
    private final String                   domains                                      = "(stprn\\.xyz)";

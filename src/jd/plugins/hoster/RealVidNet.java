...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "realvid.net" }, urls = { "https?://(www\\.)?realvid\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class RealVidNet extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://realvid.net";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(realvid\\.net)";
    ...
    // protocol: no https
    // captchatype: null
    // other: VIDEOHOSTER_2- and normal downloadlinks are equal in size and fileextension
    ...
    public RealVidNet(PluginWrapper wrapper) {
        super(wrapper);

...
names = { "upmorefiles.com", "cloudyload.com", "dotsemper.com", "icyfiles.com", "vidpe.com", "idup.in", "clouds.to", "zuzufile.com", "hostfil.es", "onlinedisk.ru", "fileduct.com", "frogup.com", "filejumbo.com", "dump.ru", "fileshawk.com", "vidstream.us", "filezpro.com", "fileupper.com", "speedy-share.net", "files.ge", "gbitfiles.com", "xtilourbano.info", "allbox4.com", "arab-box.com", "farmupload.com", "filedefend.com", "fileomg.com", "filesega.com", "kupload.org", "multishare.org", "98file.com", "wantload.com", "esnips.com", "batshare.com", "uload.to", "share76.com", "filemates.com", "stahnu.to", "filestock.ru", "uploader.pl", "mach2upload.com", "megaunload.net", "bonpoo.com", "modovideo.com", "bitoman.ru", "maknyos.com", "upgrand.com", "pigsonic.com", "filevelocity.com", "filebite.cc", "filegaze.com", "ddldrive.com", "fileforth.com", "files-save.com", "media-4.me", "backupload.net",
        ...
        "ddlanime.com", "mountfile.com", "platinshare.com", "megavideo.com", "megaupload.com", "cum.com", "zshare.net", "uploading4u.com", "megafree.kz", "batubia.com", "upload24.net", "files.namba.kz", "datumbit.com", "fik1.com", "fileape.com", "filezzz.com", "imagewaste.com", "fyels.com", "gotupload.com", "sharehub.com", "sharehut.com", "filesurf.ru", "openfile.ru", "letitfile.ru", "tab.net.ua", "uploadbox.com", "supashare.net", "usershare.net", "skipfile.com", "10upload.com", "x7.to", "uploadking.com", "uploadhere.com", "fileshaker.com", "vistaupload.com", "groovefile.com", "enterupload.com", "xshareware.com", "xun6.com", "yourupload.de", "youshare.eu", "mafiaupload.com", "addat.hu", "archiv.to", "bigupload.com", "biggerupload.com", "bitload.com", "bufiles.com", "cash-file.net", "combozip.com", "duckload.com", "exoshare.com", "file2upload.net", "filebase.to", "filebling.com",
        "filecrown.com", "filefrog.to", "filefront.com", "filehook.com", "filestage.to", "filezup.com", "fullshare.net", "gaiafile.com", "keepfile.com", "kewlshare.com", "lizshare.net", "loaded.it", "loadfiles.in", "megarapid.eu", "megashare.vn", "metahyper.com", "missupload.com", "netstorer.com", "nextgenvidz.com", "piggyshare.com", "profitupload.com", "quickload.to", "quickyshare.com", "share.cx", "sharehoster.de", "shareua.com", "speedload.to", "upfile.in", "ugotfile.com", "upload.ge", "uploadmachine.com", "uploady.to", "uploadstore.net", "vspace.cc", "web-share.net", "yvh.cc", "x-files.kz" },

urls = { "https?://(www\\.)?upmorefiles\\.com/[a-z0-9]{12}", "http://(www\\.)?cloudyload\\.com/[A-Za-z0-9]+(~f)?", "https?://(www\\.)?dotsemper\\.com/(embed\\-)?[a-z0-9]{12}", "http://(www\\.)?icyfiles\\.com/[a-z0-9]+", "https?://(www\\.)?vidpe\\.com/[a-z0-9]{12}", "https?://(www\\.)?idup\\.in/[a-z0-9]{12}", "https?://(www\\.)?clouds\\.to/[a-z0-9]{12}", "https?://(www\\.)?zuzufile\\.com/[a-z0-9]{12}", "http://(www\\.)?hostfil\\.es/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "http://(www\\.)?onlinedisk\\.ru/(file|view)/[0-9]+", "https?://(www\\.)?fileduct\\.com/[a-z0-9]{12}", "http://(www\\.)?frogup\\.com/plik/pokaz/[^<>\"/]*?/[0-9]+", "http://(www\\.)?filejumbo\\.com/Download/[A-Z0-9]+", "http://(www\\.)?dump\\.ru/file/[0-9]+", "http://(www\\.)?fileshawk\\.com/files/[A-Za-z0-9]+\\.html", "https?://(www\\.)?vidstream\\.us/[a-z0-9]{12}",
        "https?://(www\\.)?filezpro\\.com/[a-z0-9]{12}", "http://(www\\.)?fileupper\\.com/[a-z0-9]{12}", "http://(www\\.)?speedy\\-share\\.net/(?!faq|register|login|terms|report_file|plugins)[a-z0-9]+", "http://[\\w\\.]*?files\\.ge/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "https?://(www\\.)?gbitfiles\\.com/[a-z0-9]{12}", "https?://(www\\.)?xtilourbano\\.info/[a-z0-9]{12}", "https?://(www\\.)?allbox4\\.com/(\\-embed)?[a-z0-9]{12}", "https?://(www\\.)?arab\\-box\\.com/[a-z0-9]{12}", "https?://(www\\.)?farmupload\\.com/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?filedefend\\.com/[a-z0-9]{12}", "https?://(www\\.)?fileomg\\.com/[a-z0-9]{12}", "https?://(www\\.)?filesega\\.com/[a-z0-9]{12}", "https?://(www\\.)?kupload\\.org/[a-z0-9]{12}", "https?://(www\\.)?multishare\\.org/file/[a-z0-9]{12}/.*?\\.html",
        "https?://(www\\.)?98file\\.com/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?wantload\\.com/[a-z0-9]{12}", "http://(www\\.)?esnips\\.com/((ns)?doc/[a-z0-9\\-]+|displayimage\\.php\\?[\\w\\&\\=]+)", "https?://(www\\.)?batshare\\.com/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?uload\\.to/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?share76\\.com/[a-z0-9]{12}(/[^<>\"/]+)?", "https?://(www\\.)?filemates\\.com/(vidembed\\-)?[a-z0-9]{12}", "http://(www\\.)?stahnu\\.to/files/get/[A-Za-z0-9]+/[A-Za-z0-9_\\-% ]+", "http://(www\\.)?filestock\\.ru/[a-z0-9]{12}", "http://[\\w\\.]*?uploader.pl/([a-z]{2}/)?file/\\d+/", "http://[\\w\\.]*?mach2upload\\.com/files/[A-Za-z0-9]+\\.html", "http://(www\\.)?megaunload\\.net/index\\.php/files/get/[A-Za-z0-9_\\-]+", "http://(www\\.)?app04\\.bonpoo\\.com/cgi\\-bin/download\\?fid=[A-Z0-9]+",
        "http://(www\\.)?modovideo\\.com/video(\\.php)?\\?v=[a-z0-9]+", "http://(www\\.)?bitoman\\.ru/download/\\d+\\.html", "https?://(www\\.)?maknyos\\.com/[a-z0-9]{12}", "https?://(www\\.)?upgrand\\.com/[a-z0-9]{12}", "https?://(www\\.)?pigsonic\\.com/[a-z0-9]{12}", "https?://(www\\.)?filevelocity\\.com/[a-z0-9]{12}", "https?://(www\\.)?filebite\\.cc/[a-z0-9]{12}", "https?://(www\\.)?filegaze\\.com/[a-z0-9]{12}", "https?://(www\\.)?ddldrive\\.com/[a-z0-9]{12}", "https?://(www\\.)?fileforth\\.com/[a-z0-9]{12}", "http://(www\\.)?files\\-save\\.com/(fr|en)/download\\-[a-z0-9]{32}\\.html", "http://(www\\.)?media\\-4\\.me/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "https?://(www\\.)?backupload\\.net/[a-z0-9]{12}", "http://(www\\.)?upafacil\\.com/(file/\\d+/|\\?d=)[\\w\\-\\.]+", "https?://(www\\.)?filedownloads\\.org/[a-z0-9]{12}",
        "http://(www\\.)?filesector\\.cc/f/[A-Z0-9]+/", "http://(www\\.)?netuploaded\\.com/[a-z0-9]{12}", "https?://(www\\.)?squillion\\.com/[a-z0-9]{12}", "https?://(www\\.)?sharebees\\.com/(vidembed\\-)?[a-z0-9]{12}", "http://(www\\.)?filetobox\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "http://(www\\.)?fufox\\.(com|net)/\\?d=[A-Za-z0-9]+", "http://(www\\.)?mojedata\\.sk/[A-Za-z0-9_]+", "https?://(www\\.)?grupload\\.com/[a-z0-9]{12}", "http://[\\w\\.]*?stickam\\.com/viewMedia\\.do\\?mId=\\d+", "http://(www\\.)?gimmedatnewjoint\\.com/play/\\d+/", "http://(www\\.)?dup\\.co\\.il/(file\\.php\\?akey=|v/)[\\w]{14}", "http://(www\\.)?eazyupload\\.net/(download/)?[A-Za-z0-9]+", "http://(www\\.)?depoindir\\.com/files/get/[A-Za-z0-9]+", "http://[\\w\\.]*?own3d\\.tv/(.*?/)?(video|watch)/\\d+", "http://(www\\.)?drop\\.st/[A-Za-z0-9]+",
        "http://(www\\.)?favupload\\.com/(video|file|audio)/\\d+/", "http://(www\\.)?anonstream\\.com/get_[A-Za-z0-9]+", "https?://(www\\.)?odsiebie\\.pl/[a-z0-9]{12}", "https?://(www\\.)?shareupload\\.com/[a-z0-9]{12}", "http://(www\\.)?filebeer\\.info/(\\d+~f|[A-Za-z0-9]+)", "http://(www\\.)?streamratio\\.com/(files|get)/[A-Za-z0-9]+(/[^<>\"/]+)?\\.html", "http://[\\w\\.]*?uploadfloor\\.com/[a-z0-9]{12}", "https?://(www\\.)?venusfile\\.com/[a-z0-9]{12}", "https?://(www\\.)?welload\\.com/[a-z0-9]{12}", "https?://(www\\.)?upaj\\.pl/[a-z0-9]{12}", "http://(www\\.)?shareupload\\.net/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es|de)/)?file/[0-9]+/)", "https?://(www\\.)?tsarfile\\.com/[a-z0-9]{12}", "http://(www\\.)?omegave\\.org/[a-z0-9]{12}", "http://((www\\.)?(fsx|mfs\\.hu/download\\.php\\?s=\\d+\\&d=[^<>\"]+\\&h=[a-z0-9]+|s.*?\\.(fsx|mfs)\\.hu/.+/.+))",
        "http://(www\\.)?kiwiload\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es|de)/)?file/[0-9]+/)", "https?://(www\\.)?gbmeister\\.com/[a-z0-9]{12}", "http://(www\\.)?filesharing88\\.net/public/(?!(faq|register|login|terms|report_file|aboutus|contact|forgot|help|inthenews|privacy|upgrade)\\.html)[a-z0-9]+(?!~|%7Ef)", "https?://(www\\.)?fileza\\.net/[a-z0-9]{12}", "https?://(www\\.)?filecloud\\.ws/[a-z0-9]{12}", "https?://(www\\.)?filesome\\.com/[a-z0-9]{12}", "https?://(www\\.)?filehost\\.ws/[a-z0-9]{12}", "https?://(www\\.)?filemade\\.com?/[a-z0-9]{12}", "https?://(www\\.)?bloonga\\.com/[a-z0-9]{12}", "http://(www\\.)?zettaupload\\.com/(?!file_category|latest_file|wklej|terms|report_file|partners|contact|faq|login|register)[a-z0-9]+", "https?://(www\\.)?(aa\\.vg|aavg\\.net)/[a-z0-9]{12}", "http://(www\\.)?freeporn\\.com/(video/\\d+/|[a-z0-9\\-_]+\\-\\d+)",
        "http://(www\\.)?bitbonus\\.com/download/[A-Za-z0-9\\-]+", "https?://(www\\.)?sharebeats\\.com/[a-z0-9]{12}", "http://(www\\.)?vidhost\\.me/\\?dw?=[A-Z0-9]+", "https?://(www\\.)?filetechnology\\.com/[a-z0-9]{12}", "http://[\\w\\.]*?badongo\\.com/.*(file|vid|cvid|audio|pic)/[0-9]+(/[0-9]+)?", "https?://(www\\.)?uptorch\\.com/\\?d=[A-Z0-9]{9}", "http://(www\\.)?videoveeb\\.(com|net)/\\?dw?=[A-Z0-9]+", "http://(www\\.)?fileupped\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "https?://(www\\.)?repofile\\.com/[a-z0-9]{12}", "https?://(www\\.)?filemsg\\.com/[a-z0-9]{12}", "https?://(www\\.)?dopeshare\\.com/[a-z0-9]{12}", "https?://(www\\.)?filefat\\.com/[a-z0-9]{12}", "http://(www\\.)?fileplayground\\.com/[a-z0-9]{12}", "https?://(www\\.)?fileor\\.com/[a-z0-9]{12}", "https?://(www\\.)?aieshare\\.com/[a-z0-9]{12}",
        "http://(www\\.)?q4share\\.com/[a-z0-9]{12}", "http://(www\\.)??share\\-now\\.net/{1,}files/\\d+\\-.*?\\.html", "https?://(www\\.)?1hostclick\\.com/[a-z0-9]{12}", "https?://(www\\.)?mummyfile\\.com/[a-z0-9]{12}", "http://(www\\.)?hsupload\\.(com|net)/\\?dw?=[A-Z0-9]+", "https?://(www\\.)?upthe\\.net/[a-z0-9]{12}", "https?://(www\\.)?ufile\\.eu/[a-z0-9]{12}", "http://(www\\.)?(bitroad\\.net|filemashine\\.com|friendlyfiles\\.net|vip4sms\\.com|manuls\\.ru)/download/[A-Fa-f0-9]+", "http://(www\\.)?coolshare\\.cz/stahnout/\\d+", "http://(www\\.)?speedfile\\.cz/((cs|en|de)/)?\\d+/[a-z0-9\\-]+", "https?://(www\\.)?your\\-filehosting\\.com/[a-z0-9]{12}", "http://(www\\.)?brontofile\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "https?://(www\\.)?filestrum\\.com/[a-z0-9]{12}", "https?://(www\\.)?filedove\\.com/[a-z0-9]{12}",
        "https?://(www\\.)?sharpfile\\.com/(?!folder/|banners|contact|images|register|privacy|premium|affiliates|language|resellers)[a-z0-9]{6,12}", "https?://(www\\.)?filerose\\.com/[a-z0-9]{12}", "https?://(www\\.)?filereactor\\.com/[a-z0-9]{12}", "https?://(www\\.)?boltsharing\\.com/[a-z0-9]{12}", "http://(www\\.)?turboupload\\.com/[a-z0-9]+", "http://(www\\.)?(uploads\\.glumbo|glumbouploads)\\.com/[a-z0-9]{12}", "https?://(www\\.)?terabit\\.to/[a-z0-9]{12}", "http://(www\\.)?buckshare\\.com/[a-z0-9]{12}", "https?://(www\\.)?zeusupload\\.com/[a-z0-9]{12}", "https?://(www\\.)?filedino\\.com/[a-z0-9]{12}", "http://(www\\.)?(appscene\\.org|filedude\\.com)/(download/[0-9a-zA-Z]+|download\\.php\\?id=\\d+)", "http://(www\\.)?(new\\.)?uptal\\.(com|org)/\\?d=[A-Fa-f0-9]+", "http://(www\\.)?uptal\\.net/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)",
        "http://(www\\.)?file-bit\\.net/[a-z0-9]{12}", "http://(www\\.)?xtshare\\.com/toshare\\.php\\?Id=\\d+(\\&view=[0-9a-f]+)?", "http://(www\\.)?cosaupload\\.org/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es|de)/)?file/[0-9]+/)", "http://(www\\.)?sharing\\-online\\.com/[a-z0-9]{12}", "http://(www\\.)?filestrack\\.com/[a-z0-9]{12}", "http://(www\\.)?shareator\\.net/[0-9a-z]+", "http://(www\\.)?azushare\\.net/[A-Za-z0-9]+/", "https?://(www\\.)?filecosy\\.com/[a-z0-9]{12}", "https?://(www\\.)?monsteruploads\\.eu/[a-z0-9]{12}(/[^<>\"/]*?)?\\.html", "https?://(www\\.)?vidhuge\\.com/[a-z0-9]{12}", "http://(www\\.)?doneshare\\.com/files/details/[a-z0-9\\-]+\\.html", "http://(www\\.)?cixup\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "https?://(www\\.)?animegoon\\.com/[a-z0-9]{12}", "http://(www\\.)?supermov\\.com/(rc|video)/[0-9]+",
        "https?://(www\\.)?ufliq\\.com/[a-z0-9]{12}", "http://(www\\.)?vidreel\\.com/video/[0-9a-zA-Z]+/", "http://(www\\.)?deditv\\.com/(play|gate\\-way)\\.php\\?v=[0-9a-f]+", "http://(www\\.)?(hotshare|supershare)\\.net/(.+/)?(file|audio|video)/.+", "https?://(www\\.)?shareshared\\.com/[a-z0-9]{12}", "http://(www\\.)?uploadville\\.com/[a-z0-9]{12}", "http://(www\\.)?fileserver\\.cc/[a-z0-9]{12}", "http://(www\\.)?bebasupload\\.com/[a-z0-9]{12}", "http://[\\w\\.]*?savefile\\.ro/[\\w]+/?", "http://(www\\.)?ovfile\\.com/[a-z0-9]{12}", "https?://(www\\.)?divxbase\\.com/[a-z0-9]{12}", "https?://(www\\.)?gptfile\\.com/[a-z0-9]{12}", "https?://(www\\.)?dudupload\\.com/[a-z0-9]{12}", "http://(www\\.)?eyvx\\.com/[a-z0-9]{12}", "http://(www\\.)?farshare\\.to/[a-z0-9]{12}", "http://(www\\.)?azsharing\\.com/[a-z0-9]{12}/", "http://(www\\.)?freefilessharing\\.com/[a-z0-9]{12}",
        "https?://(www\\.)?elitedisk\\.com/[a-z0-9]{12}", "http://[\\w\\.]*?freakmov\\.com/(rc|video)/[0-9]+", "http://[\\w\\.]*?(shragle|cloudnator)\\.(com|de)/files/[\\w]+/.*", "http://[\\w\\.]*?filesavr\\.com/[A-Za-z0-9]+(_\\d+)?", "http://(www\\.)?saveufile\\.(in\\.th|com)/car\\.php\\?file=[a-z0-9]+", "https?://(www\\.)?migahost\\.com/[a-z0-9]{12}", "http://[\\w\\.]*?fastfreefilehosting\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "https?://(www\\.)?files2k\\.eu/[a-z0-9]{12}", "https?://(www\\.)?shafiles\\.me/[a-z0-9]{12}", "http://(www\\.)?jalurcepat\\.com/[a-z0-9]{12}", "https?://(www\\.)?(divload|divupload)\\.org/(embed\\-)?[a-z0-9]{12}", "http://(www\\.)?refile\\.net/(d|f)/\\?[\\w]+", "http://[\\w\\.]*?oron\\.com/[a-z0-9]{12}", "http://(www\\.)?wupload\\.[a-z]{1,5}/file/([0-9]+(/.+)?|[a-z0-9]+/[0-9]+(/.+)?)",

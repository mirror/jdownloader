...
names = { "quakefile.com", "wupfile.com", "vdoreel.com", "flazhshare.com", "upmorefiles.com", "cloudyload.com", "dotsemper.com", "icyfiles.com", "vidpe.com", "idup.in", "clouds.to", "zuzufile.com", "hostfil.es", "onlinedisk.ru", "fileduct.com", "frogup.com", "filejumbo.com", "dump.ru", "fileshawk.com", "vidstream.us", "filezpro.com", "fileupper.com", "speedy-share.net", "files.ge", "gbitfiles.com", "xtilourbano.info", "allbox4.com", "arab-box.com", "farmupload.com", "filedefend.com", "fileomg.com", "filesega.com", "kupload.org", "multishare.org", "98file.com", "wantload.com", "esnips.com", "batshare.com", "uload.to", "share76.com", "filemates.com", "stahnu.to", "filestock.ru", "uploader.pl", "mach2upload.com", "megaunload.net", "bonpoo.com", "modovideo.com", "bitoman.ru", "maknyos.com", "upgrand.com", "pigsonic.com", "filevelocity.com", "filebite.cc", "filegaze.com", "ddldrive.com",
...
urls = { "https?://(www\\.)?quakefile\\.com/((vid)?embed\\-)?[a-z0-9]{12}", "https?://(www\\.)?wupfile\\.com/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?vdoreel\\.com/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?flazhshare\\.com/[a-z0-9]{12}", "https?://(www\\.)?upmorefiles\\.com/[a-z0-9]{12}", "http://(www\\.)?cloudyload\\.com/[A-Za-z0-9]+(~f)?", "https?://(www\\.)?dotsemper\\.com/(embed\\-)?[a-z0-9]{12}", "http://(www\\.)?icyfiles\\.com/[a-z0-9]+", "https?://(www\\.)?vidpe\\.com/[a-z0-9]{12}", "https?://(www\\.)?idup\\.in/[a-z0-9]{12}", "https?://(www\\.)?clouds\\.to/[a-z0-9]{12}", "https?://(www\\.)?zuzufile\\.com/[a-z0-9]{12}", "http://(www\\.)?hostfil\\.es/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "http://(www\\.)?onlinedisk\\.ru/(file|view)/[0-9]+", "https?://(www\\.)?fileduct\\.com/[a-z0-9]{12}",
        "http://(www\\.)?frogup\\.com/plik/pokaz/[^<>\"/]*?/[0-9]+", "http://(www\\.)?filejumbo\\.com/Download/[A-Z0-9]+", "http://(www\\.)?dump\\.ru/file/[0-9]+", "http://(www\\.)?fileshawk\\.com/files/[A-Za-z0-9]+\\.html", "https?://(www\\.)?vidstream\\.us/[a-z0-9]{12}", "https?://(www\\.)?filezpro\\.com/[a-z0-9]{12}", "http://(www\\.)?fileupper\\.com/[a-z0-9]{12}", "http://(www\\.)?speedy\\-share\\.net/(?!faq|register|login|terms|report_file|plugins)[a-z0-9]+", "http://[\\w\\.]*?files\\.ge/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "https?://(www\\.)?gbitfiles\\.com/[a-z0-9]{12}", "https?://(www\\.)?xtilourbano\\.info/[a-z0-9]{12}", "https?://(www\\.)?allbox4\\.com/(\\-embed)?[a-z0-9]{12}", "https?://(www\\.)?arab\\-box\\.com/[a-z0-9]{12}", "https?://(www\\.)?farmupload\\.com/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?filedefend\\.com/[a-z0-9]{12}",
        "https?://(www\\.)?fileomg\\.com/[a-z0-9]{12}", "https?://(www\\.)?filesega\\.com/[a-z0-9]{12}", "https?://(www\\.)?kupload\\.org/[a-z0-9]{12}", "https?://(www\\.)?multishare\\.org/file/[a-z0-9]{12}/.*?\\.html", "https?://(www\\.)?98file\\.com/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?wantload\\.com/[a-z0-9]{12}", "http://(www\\.)?esnips\\.com/((ns)?doc/[a-z0-9\\-]+|displayimage\\.php\\?[\\w\\&\\=]+)", "https?://(www\\.)?batshare\\.com/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?uload\\.to/(vidembed\\-)?[a-z0-9]{12}", "https?://(www\\.)?share76\\.com/[a-z0-9]{12}(/[^<>\"/]+)?", "https?://(www\\.)?filemates\\.com/(vidembed\\-)?[a-z0-9]{12}", "http://(www\\.)?stahnu\\.to/files/get/[A-Za-z0-9]+/[A-Za-z0-9_\\-% ]+", "http://(www\\.)?filestock\\.ru/[a-z0-9]{12}", "http://[\\w\\.]*?uploader.pl/([a-z]{2}/)?file/\\d+/",
        "http://[\\w\\.]*?mach2upload\\.com/files/[A-Za-z0-9]+\\.html", "http://(www\\.)?megaunload\\.net/index\\.php/files/get/[A-Za-z0-9_\\-]+", "http://(www\\.)?app04\\.bonpoo\\.com/cgi\\-bin/download\\?fid=[A-Z0-9]+", "http://(www\\.)?modovideo\\.com/video(\\.php)?\\?v=[a-z0-9]+", "http://(www\\.)?bitoman\\.ru/download/\\d+\\.html", "https?://(www\\.)?maknyos\\.com/[a-z0-9]{12}", "https?://(www\\.)?upgrand\\.com/[a-z0-9]{12}", "https?://(www\\.)?pigsonic\\.com/[a-z0-9]{12}", "https?://(www\\.)?filevelocity\\.com/[a-z0-9]{12}", "https?://(www\\.)?filebite\\.cc/[a-z0-9]{12}", "https?://(www\\.)?filegaze\\.com/[a-z0-9]{12}", "https?://(www\\.)?ddldrive\\.com/[a-z0-9]{12}", "https?://(www\\.)?fileforth\\.com/[a-z0-9]{12}", "http://(www\\.)?files\\-save\\.com/(fr|en)/download\\-[a-z0-9]{32}\\.html",
        ...
        "https?://(www\\.)?(ddlanime\\.com|ddlani\\.me)/[a-z0-9]{12}", "http://(www\\.)?mountfile\\.com/file/[a-z0-9]+/[a-z0-9]+", "http://(www\\.)?platinshare\\.com/files/[A-Za-z0-9]+", "http://(www\\.)?megavideo\\.com/(.*?(v|d)=|v/)[a-zA-Z0-9]+", "http://(www\\.)?megaupload\\.com/.*?(\\?|&)d=[0-9A-Za-z]+", "http://(www\\.)?(cum|megaporn|megarotic|sexuploader)\\.com/(.*?v=|v/)[a-zA-Z0-9]+", "http://(www\\.)?zshare\\.net/(download|video|image|audio|flash)/.*", "http://(www\\.)?uploading4u\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)", "http://(www\\.)?megafree\\.kz/file\\d+", "http://(www\\.)?batubia\\.com/[a-z0-9]{12}", "http://(www\\.)?upload24\\.net/[a-z0-9]+\\.[a-z0-9]+", "http://(www\\.)?download\\.files\\.namba\\.kz/files/\\d+", "http://(www\\.)?datumbit\\.com/file/.*?/", "http://(www\\.)?fik1\\.com/[a-z0-9]{12}",

...
public class Offline extends PluginForHost {
    ...
    /**
     * returns the annotation pattern array: 'https?://[\\w\\.\\-]*?(?:domain1|domain2)/.+'
     *
     */
    ...
    private static String getHostsPattern() {
        final String hosts = "https?://(?:[A-Za-z0-9]+\\.)?" + "(?:" + getHostsPatternPart() + ")";
        return hosts;
    }

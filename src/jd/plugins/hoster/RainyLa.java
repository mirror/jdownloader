...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "rainy.la" }, urls = { "https?://(www\\.)?rainy\\.la/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class RainyLa extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://rainy.la";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(rainy\\.la)";
     ...
     * mods: scanInfo[new filename RegEx]<br />
     * limit-info:<br />
    ...
    public RainyLa(PluginWrapper wrapper) {
        super(wrapper);

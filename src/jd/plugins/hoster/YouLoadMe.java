...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "youload.me" }, urls = { "https?://(www\\.)?youload\\.me/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class YouLoadMe extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://youload.me";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(youload\\.me)";
    ...
    public YouLoadMe(PluginWrapper wrapper) {
        super(wrapper);

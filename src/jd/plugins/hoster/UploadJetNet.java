...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadjet.net" }, urls = { "https?://(www\\.)?uploadjet\\.net/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
...
public class UploadJetNet extends PluginForHost {
    ...
    private final String               DOMAINS                      = "(uploadjet\\.net)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (cbr.containsHTML("(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<li>The file (expired|deleted by (its owner|administration))|<h2>File: <font style=\"color:darkred\"></font> \\[<font style=\"color:#114\"></font>\\]</h2>)")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

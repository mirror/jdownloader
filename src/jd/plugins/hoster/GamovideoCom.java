...
public class GamovideoCom extends XFileSharingProBasic {
    public GamovideoCom(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info: 2020-03-24: Untested <br />
    ...
    public static String[] getAnnotationUrls() {
        return GamovideoCom.buildAnnotationUrls(getPluginDomains());
    }
    ...
    public static String[] buildAnnotationUrls(final List<String[]> pluginDomains) {
        ...
        for (final String[] domains : pluginDomains) {
            ret.add("https?://(?:www\\.)?" + buildHostsPatternPart(domains) + "/(?:embed-)?[a-z0-9]{12,}(?:/[^/]+(?:\\.html)?)?");
        }

...
public class StreaminpornXyz extends antiDDoSForHost {
     ...
     * YetiShareBasic Version 1.1.2-psp<br />
     * mods: requestFileInformation[available_CHECK_OVER_INFO_PAGE modification]<br />
     * limit-info:<br />
     * protocol: no https<br />
     * captchatype: 2017-08-04: null<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://streaminporn.xyz";
    private final String                   domains                                      = "(streaminporn\\.xyz)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (available_CHECK_OVER_INFO_PAGE) {
            /* 2017-08-04: Special - info-page is there but it is the main url, we do not have to access the '~i' URL. */
            final boolean actuallyAccessInfoPage = false;
            if (actuallyAccessInfoPage) {

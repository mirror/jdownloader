...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "safesharing.eu" }, urls = { "https?://(www\\.)?safesharing\\.eu/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class SafeSharingEu extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://safesharing.eu";
    private static final String  NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    // domain names used within download links.
    private static final String  DOMAINS                      = "(safesharing\\.eu)";
    ...
    // mods:
    // limit-info: set standard limits, had no downloadlinks and upload was not possible
    // protocol: no https
    ...
    public SafeSharingEu(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) fileInfo[0] = new Regex(correctedBR, "<h3>([^<>\"]*?)</h3>").getMatch(0);
        if (fileInfo[1] == null) {

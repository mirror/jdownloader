...
@HostPlugin(revision = "$Revision: 15600 $", interfaceVersion = 2, names = { "upload.ee" }, urls = { "http://(www\\.)?upload\\.ee/files/\\d+/[^ ]+" }, flags = { 0 })
public class UploadEe extends PluginForHost {
    ...
    public void correctDownloadLink(final DownloadLink link) throws Exception {
        link.setUrlDownload(link.getDownloadURL().replace("://upload", "://www.upload"));
    }

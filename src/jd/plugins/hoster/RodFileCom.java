...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "rodfile.com" }, urls = { "https?://(www\\.)?rodfile\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class RodFileCom extends PluginForHost {
    ...
    public void checkErrors(DownloadLink theLink, boolean checkAll, String passCode) throws NumberFormatException, PluginException {
        ...
        if (new Regex(correctedBR, "(class=\"err\">Your Traffic download today has been finished Upgrade your account to unlimited download daily)").matches()) {
            // one hour wait?

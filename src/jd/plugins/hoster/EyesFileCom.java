...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "eyesfile.com" }, urls = { "https?://(www\\.)?eyesfile\\.com?/[a-z0-9]{12}" }, flags = { 0 })
public class EyesFileCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://eyesfile.co";
    ...
    public void correctDownloadLink(DownloadLink link) {
        link.setUrlDownload(link.getDownloadURL().replace("https://", "http://").replace("eyesfile.com/", "eyesfile.co/"));
    }

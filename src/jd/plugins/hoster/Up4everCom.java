...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "up-4ever.com", "up-4.net" }, urls = { "", "https?://(?:www\\.)?(up\\-4ever\\.com|up\\-4ever\\.net|up-4\\.net)/(?:(?:embed\\-)?[a-z0-9]{12}|d/[A-Za-z0-9]+)" })
public class Up4everCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "https://www.up-4ever.net";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(up\\-4ever\\.com|up-4\\.net|up\\-4ever\\.net|up4ever.download)";

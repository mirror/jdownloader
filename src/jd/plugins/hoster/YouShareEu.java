...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "youshare.eu" }, urls = { "http://(www\\.)?youshare\\.eu/[a-z0-9]{12}" }, flags = { 0 })
public class YouShareEu extends PluginForHost {

    public YouShareEu(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST   = "http://youshare.eu";

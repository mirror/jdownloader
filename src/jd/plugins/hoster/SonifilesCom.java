...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "sonifiles.com" }, urls = { "https?://(?:www\\.)?sonifiles\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class SonifilesCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://sonifiles.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(sonifiles\\.com)";
     ...
     * mods: doFree[download1 Form method_free], waitTime[one new wait RegEx]<br />
     * limit-info:<br />
    ...
    public SonifilesCom(PluginWrapper wrapper) {
        super(wrapper);

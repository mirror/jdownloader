...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filegag.com" }, urls = { "https?://(www\\.)?filegag(plus)?\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
...
public class FileGagCom extends PluginForHost {
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        String availabletraffic = cbr.getRegex("Traffic available.*?:</TD></tr>.+<TD><b>([^<>\"']+)</b>").getMatch(0);

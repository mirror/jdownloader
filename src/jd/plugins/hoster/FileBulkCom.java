...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filebulk.com" }, urls = { "https?://(www\\.)?filebulk\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class FileBulkCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://filebulk.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(filebulk\\.com)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (cbr.containsHTML("(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<li>The file (expired|deleted by (its owner|administration))|>This file is either removed due to copyright claim, FileBulk TOS or is deleted by the uploader.<)")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

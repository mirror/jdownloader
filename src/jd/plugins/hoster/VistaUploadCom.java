...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vistaupload.com" }, urls = { "http://(www\\.)?vistaupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class VistaUploadCom extends PluginForHost {

    public VistaUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST         = "http://vistaupload.com";

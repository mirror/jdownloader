...
public class XFileSharingProBasicOLD extends antiDDoSForHost {
    @Deprecated
    public XFileSharingProBasicOLD(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /**
     * DEV NOTES XfileSharingProBasic Version 2.7.8.7<br />
     ****************************

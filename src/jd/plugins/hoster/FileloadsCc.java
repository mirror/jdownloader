...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "fileloads.cc" }, urls = { "https?://(www\\.)?fileloads\\.cc/[A-Za-z0-9]+" }, flags = { 0 })
public class FileloadsCc extends PluginForHost {
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://fileloads.cc";
    private final String         domains                                      = "(fileloads\\.cc)";

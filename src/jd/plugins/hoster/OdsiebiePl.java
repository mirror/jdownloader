...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "odsiebie.pl" }, urls = { "http://(www\\.)?odsiebie\\.pl/[a-z0-9]{12}" }, flags = { 0 })
public class OdsiebiePl extends PluginForHost {
    ...
    public int getMaxSimultanFreeDownloadNum() {
        // Max connections possible = 2 so we set max download = 1 and max
        // chunks = 2
        return 1;
    }

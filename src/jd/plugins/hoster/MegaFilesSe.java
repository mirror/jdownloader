...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "megafiles.se" }, urls = { "https?://(www\\.)?megafiles\\.se/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class MegaFilesSe extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://megafiles.se";
    // domain names used within download links.
    private final String               DOMAINS                      = "(megafiles\\.se)";

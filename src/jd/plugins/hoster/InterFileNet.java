...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "interfile.net" }, urls = { "https?://(www\\.)?interfile\\.net/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
...
public class InterFileNet extends PluginForHost {
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        final String availabletraffic = cbr.getRegex("Available traffic.*?:</TD><TD[^>]+><b>([^<>\"']+)</b>").getMatch(0);

...
@HostPlugin(revision = "$Revision: 16216 $", interfaceVersion = 2, names = { "movdivx.com" }, urls = { "https?://(www\\.)?movdivx\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class MovDivxCom extends PluginForHost {
    ...
    public MovDivxCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void checkServerErrors() throws NumberFormatException, PluginException {
        ...
        if (new Regex(correctedBR, "(?i)<title>The page is temporarily unavailable</title>").matches()) throw new PluginException(LinkStatus.ERROR_TEMPORARILY_UNAVAILABLE, "Temporarily unavailable. Please try again later", 2 * 60 * 60 * 1000l);

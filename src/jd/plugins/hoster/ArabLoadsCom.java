...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "arabloads.com" }, urls = { "https?://(www\\.)?arabloads\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class ArabLoadsCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://arabloads.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(arabloads\\.com)";

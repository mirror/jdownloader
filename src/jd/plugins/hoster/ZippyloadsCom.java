...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "zippyloads.com" }, urls = { "https?://(?:www\\.)?zippyloads\\.com/[A-Za-z0-9]+" })
public class ZippyloadsCom extends PluginForHost {

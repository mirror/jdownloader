...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "zippyloads.com" }, urls = { "https?://(?:www\\.)?zippyloads\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class ZippyloadsCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://zippyloads.com";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(zippyloads\\.com)";
     ...
     * mods: correctProtocol[Added 'www.']<br />
    ...
    public ZippyloadsCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String correctProtocol(String url) {
        ...
        if (SUPPORTS_HTTPS && SUPPORTS_HTTPS_FORCED) {
            ...
            url = url.replaceFirst("https?://", "http://www.");
        }
        return url;
    }

...
public class RarcloudsCom extends PluginForHost {
    public RarcloudsCom(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium("http://rarclouds.com/vip.php");
    }

    @Override
    public String getAGBLink() {
        return "http://www.rarclouds.com/";
    }

    private static List<String[]> getPluginDomains() {
        final List<String[]> ret = new ArrayList<String[]>();
        // each entry in List<String[]> will result in one PluginForHost, Plugin.getHost() will return String[0]->main domain
        ret.add(new String[] { "rarwp.com", "rarclouds.com" });
        return ret;
    }

    @Override
    public String rewriteHost(final String host) {
        /* 2023-05-03: Main domain has changed from rarclouds.com to rarwp.com */
    ...
    public static String[] getAnnotationUrls() {
        ...
        for (final String[] domains : getPluginDomains()) {
            ret.add("https?://(?:www\\.)?" + buildHostsPatternPart(domains) + "/(?:fs|down2?)/([a-z0-9]+)");
        }

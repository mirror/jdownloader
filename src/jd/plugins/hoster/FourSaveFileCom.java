...
@HostPlugin(revision = "$Revision: 16185 $", interfaceVersion = 2, names = { "4savefile.com" }, urls = { "https?://(www\\.)?4savefile\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FourSaveFileCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://4savefile.com";
        ...
        if (filename == null) {
            ...
            if (filename == null) {
                ...
                if (filename == null) {
                    ...
                    filename = new Regex(correctedBR, "(?i)Download File: ([^<>\"\\'\\(]+)").getMatch(0);
                }
            }
        }
    ...
    public String getDllink() {
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                dllink = new Regex(correctedBR, "This (direct link|download link) will be available for your IP.*?href=[\"\\'](http.*?)[\"\\']{1,2}").getMatch(1);
                if (dllink == null) {

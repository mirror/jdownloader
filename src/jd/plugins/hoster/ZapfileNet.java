...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "zapfile.net" }, urls = { "https?://(?:www\\.)?zapfile\\.net/(?:embed\\-)?[a-z0-9]{12}" })
public class ZapfileNet extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://zapfile.net";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(zapfile\\.net)";
     ...
     * captchatype: 2017-05-31: solvemedia<br />
     * other:<br />
     */
    ...
    public ZapfileNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            if (download1 != null) {
                /* 2017-05-31: Important - remove this key two times! */
    ...
    private void getPage(final Browser br, String page, final boolean correctBr) throws Exception {
        ...
        if (redirect != null && redirect.matches(".+/download$")) {
            /* 2017-05-31: Workaround */
            getPage(redirect);
        }
    }

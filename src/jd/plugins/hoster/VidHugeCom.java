...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vidhuge.com" }, urls = { "https?://(www\\.)?vidhuge\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class VidHugeCom extends PluginForHost {
    ...
    public VidHugeCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        String filesize = new Regex(correctedBR, "<b>File Size :</b>([^<>\"]*?)<br>").getMatch(0);
        if (filesize == null) {

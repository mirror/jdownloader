...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadcore.com" }, urls = { "https?://(www\\.)?uploadcore\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class UploadCoreCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://uploadcore.com";
    ...
    public UploadCoreCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public String getDllink() {
        ...
        if (dllink == null) {
            dllink = new Regex(correctedBR, "\"(http://www\\d+\\.uploadcore\\.com/files/[^<>\"]*?)\"").getMatch(0);
            if (dllink == null) {
                dllink = new Regex(correctedBR, "This Ticket Will be Active For Your Computer For The Following \\d+ hours<br><br>[\t\n\r ]+<a href=\"(http://[^<>\"]*?)\"").getMatch(0);
            }
        }
        return dllink;
    }

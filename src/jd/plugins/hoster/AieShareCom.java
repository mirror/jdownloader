...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "aieshare.com" }, urls = { "https?://(www\\.)?aieshare\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class AieShareCom extends PluginForHost {

    private String              BRBEFORE            = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://aieshare.com";
    ...
    public AieShareCom(PluginWrapper wrapper) {
        super(wrapper);

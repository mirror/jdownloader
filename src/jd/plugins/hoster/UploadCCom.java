...
public class UploadCCom extends PluginForHost {
    ...
    private static final String  DOMAINS                      = "(uploadc\\.com|uploadc\\.ch)";
    ...
    public String rewriteHost(String host) {
        if ("uploadc.com".equals(getHost())) {
            if (host == null || "uploadc.com".equals(host)) {
                return "uploadc.ch";
            }
        }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|File Not Found|This file has been removed due)").matches()) {
    ...
    public void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            if (download1 == null) {
                download1 = br.getFormbyProperty("name", "frmdownload");
            }
            if (download1 != null) {

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadc.com" }, urls = { "https?://(www\\.)?uploadc\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class UploadCCom extends PluginForHost {
    ...
    private static final String  DOMAINS                      = "(uploadc\\.com)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|File Not Found|This file has been removed due)").matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
    ...
    public void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            if (download1 == null) download1 = br.getFormbyProperty("name", "frmdownload");
            if (download1 != null) {

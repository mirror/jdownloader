...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "gulfup.co" }, urls = { "https?://(?:www\\.)?gulfup\\.co/(?:embed\\-)?[a-z0-9]{12}" })
public class GulfupCo extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://gulfup.co".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:gulfup\\.co)";
    ...
    public GulfupCo(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "welload.com" }, urls = { "https?://(www\\.)?welload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class WelLoadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://welload.com";
    ...
    public WelLoadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(long timeBefore, DownloadLink downloadLink) throws PluginException {
        ...
        /** Ticket Time */
        final String ttt = new Regex(correctedBR, "id=\"countdown_str\" style=\"font\\-size:32px;\">Wait <span id=\"[a-z0-9]+\">(\\d+)</span>").getMatch(0);
        if (ttt != null) {

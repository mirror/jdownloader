...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "tradingporn.com" }, urls = { "https?://(www\\.)?tradingporn\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class TradingPornCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://tradingporn.com";
    ...
    public TradingPornCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dl.getConnection().getContentType().contains("html")) {
            ...
            if (dl.getConnection().getResponseCode() == 401) throw new PluginException(LinkStatus.ERROR_TEMPORARILY_UNAVAILABLE, "Server error 401", 5 * 60 * 1000l);

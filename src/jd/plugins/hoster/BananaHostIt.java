...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "bananahost.it" }, urls = { "https?://(www\\.)?bananahost\\.it/[a-z0-9]{12}" }, flags = { 0 })
public class BananaHostIt extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://bananahost.it";
    ...
    public BananaHostIt(PluginWrapper wrapper) {
        super(wrapper);

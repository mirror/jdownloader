...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filedap.com" }, urls = { "https?://(www\\.)?filedap\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FiledapCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://filedap.com";
    private static final String  NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    // domain names used within download links.
    private static final String  DOMAINS                      = "(filedap\\.com)";
    ...
    public FiledapCom(PluginWrapper wrapper) {
        super(wrapper);

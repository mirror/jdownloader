...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "intoload.com" }, urls = { "https?://(www\\.)?intoload\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class IntoloadCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://intoload.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(intoload\\.com)";
    /* Linktypes */
    ...
    public IntoloadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        if (ttt == null) {
            ttt = new Regex(correctedBR, "id=\"countdown_str\" class=\"counterag\"><span id=\"[A-Za-z0-9]+\">(\\d+)</span>").getMatch(0);
        }
        if (ttt != null) {

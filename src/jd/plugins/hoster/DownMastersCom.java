...
public class DownMastersCom extends PluginForHost {
    ...
    public void handleMultiHost(DownloadLink link, Account acc) throws Exception {
        ...
        if (br.containsHTML("No htmlCode read")) {
            throw new PluginException(LinkStatus.ERROR_TEMPORARILY_UNAVAILABLE, "Unknown error, please report this to the downmasters.com support!");
        }
        ...
        try {
            ...
            /* unknown error, we disable multiple chunks */
            if (e.getLinkStatus() != LinkStatus.ERROR_RETRY && link.getBooleanProperty(DownMastersCom.NOCHUNKS, false) == false) {
                link.setProperty(DownMastersCom.NOCHUNKS, Boolean.valueOf(true));
                throw new PluginException(LinkStatus.ERROR_RETRY);
            }
            throw e;

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "imgtiger.org" }, urls = { "https?://(?:www\\.)?imgtiger\\.org/(?:embed\\-)?[a-z0-9]{12}" })
public class ImgtigerOrg extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://imgtiger.org";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(imgtiger\\.org)";
     ...
     * mods: correctBR[removed one cleanup RegEx]<br />
     * limit-info:<br />
    ...
    public ImgtigerOrg(PluginWrapper wrapper) {
        super(wrapper);

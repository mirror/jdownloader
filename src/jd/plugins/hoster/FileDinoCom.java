...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filedino.com" }, urls = { "http://(www\\.)?filedino\\.com/[a-z0-9]{12}" }, flags = { 0 })
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) filesize = new Regex(BRBEFORE, ">File Size : </span><span class=\"runninggreysmall\">(.*?)</span>").getMatch(0);
            }
        }

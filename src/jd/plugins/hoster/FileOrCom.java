...
@HostPlugin(revision = "$Revision: 16510 $", interfaceVersion = 2, names = { "fileor.com" }, urls = { "https?://(www\\.)?fileor\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileOrCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private final String        COOKIE_HOST         = "http://fileor.com";
    ...
    // captchatype: 4dignum
    // other: no redirects
    // TODO: delete plugin after may 2012.
    ...
    public FileOrCom(PluginWrapper wrapper) {
        super(wrapper);

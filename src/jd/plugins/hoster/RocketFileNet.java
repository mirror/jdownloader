...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "rocketfile.net" }, urls = { "https?://(www\\.)?rocketfile\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class RocketFileNet extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://rocketfile.net";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(rocketfile\\.net)";
    ...
    public RocketFileNet(PluginWrapper wrapper) {
        super(wrapper);

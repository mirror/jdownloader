...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "streamit.to" }, urls = { "https?://(www\\.)?streamit\\.to/[A-Za-z0-9]+" }, flags = { 0 })
public class StreamItTo extends PluginForHost {

    public StreamItTo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://streamit.to";
    private final String         domains                                      = "(streamit\\.to)";

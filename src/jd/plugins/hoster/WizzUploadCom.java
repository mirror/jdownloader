...
@HostPlugin(revision = "$Revision: 19090 $", interfaceVersion = 2, names = { "wizzupload.com" }, urls = { "https?://(www\\.)?wizzupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class WizzUploadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://wizzupload.com";
    ...
    public WizzUploadCom(PluginWrapper wrapper) {
        super(wrapper);

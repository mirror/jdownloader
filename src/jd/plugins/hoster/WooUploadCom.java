...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "wooupload.com" }, urls = { "https?://(www\\.)?wooupload\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class WooUploadCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://wooupload.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(wooupload\\.com)";

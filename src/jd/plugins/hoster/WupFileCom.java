...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "wupfile.com" }, urls = { "https?://(www\\.)?wupfile\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class WupFileCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://wupfile.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(wupfile\\.com)";
    ...
    public WupFileCom(PluginWrapper wrapper) {
        super(wrapper);

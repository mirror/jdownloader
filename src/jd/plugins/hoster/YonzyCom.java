...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "yonzy.com" }, urls = { "https?://(www\\.)?yonzy\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class YonzyCom extends PluginForHost {

    public YonzyCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://yonzy.com";
    private final String         domains                                      = "(yonzy\\.com)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        if (available_CHECK_OVER_INFO_PAGE) {
            ...
            filename = br.getRegex("(Filename|File Name):[\t\n\r ]+</td>[\t\n\r ]+<td class=\"responsiveInfoTable\">([^<>\"]*?) \\&nbsp;\\&nbsp;<").getMatch(1);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "senseless.tv" }, urls = { "https?://(www\\.)?senseless\\.tv/[a-z0-9]{12}" }, flags = { 0 })
public class SenseLessTv extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private static final String  COOKIE_HOST                  = "http://senseless.tv";
    ...
    // mods:removed filesize regexes as it's never given
    // non account: 10 * 1
    ...
    public SenseLessTv(PluginWrapper wrapper) {
        super(wrapper);

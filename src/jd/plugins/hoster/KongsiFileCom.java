...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "kongsifile.com" }, urls = { "https?://(www\\.)?kongsifile\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class KongsiFileCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://kongsifile.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(kongsifile\\.com)";
    ...
    public KongsiFileCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filegig.com" }, urls = { "http://(www\\.)?filegig\\.com/[a-z0-9]+" }, flags = { 2 })
public class FileGigCom extends PluginForHost {

    public FileGigCom(PluginWrapper wrapper) {
        super(wrapper);
        this.enablePremium("http://www.filegig.com/register.html");
    }
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (br.getURL().contains("filegig.com/error.html")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

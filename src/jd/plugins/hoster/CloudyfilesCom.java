...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "cloudyfiles.com" }, urls = { "https?://(?:www\\.)?cloudyfiles\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class CloudyfilesCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://cloudyfiles.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(cloudyfiles\\.com)";

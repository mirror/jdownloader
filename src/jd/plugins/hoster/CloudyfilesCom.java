...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "cloudyfiles.com" }, urls = { "https?://(?:www\\.)?cloudyfiles\\.com/[A-Za-z0-9]+" })
public class CloudyfilesCom extends PluginForHost {
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://cloudyfiles.com";
    private final String                   domains                                      = "(cloudyfiles\\.com)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        if (available_CHECK_OVER_INFO_PAGE) {
            ...
            /* 2016-11-03: Special: Sometimes we get crippled results with the 2nd RegEx so use this one first */

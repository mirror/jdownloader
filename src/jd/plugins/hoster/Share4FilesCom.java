...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "share4files.com" }, urls = { "http://(www\\.)?share4files\\.com/files/[A-Za-z0-9]+\\.html" }, flags = { 2 })
public class Share4FilesCom extends PluginForHost {

    public Share4FilesCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String MAINPAGE     = "http://www.share4files.com";
    private static final String FILENOTFOUND = ">The file you have requested does not exist";
    private static final String APIKEY       = "y0mIcXOWbSH6cKxzo9cF9GpQnoskFWW";

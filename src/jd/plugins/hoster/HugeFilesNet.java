...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "hugefiles.net" }, urls = { "https?://(www\\.)?hugefiles\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class HugeFilesNet extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://hugefiles.net";

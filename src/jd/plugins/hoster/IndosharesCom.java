...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "indoshares.com" }, urls = { "https?://(?:www\\.)?indoshares\\.com/[A-Za-z0-9]+" })
public class IndosharesCom extends PluginForHost {

    public IndosharesCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://indoshares.com";
    private final String                   domains                                      = "(indoshares\\.com)";

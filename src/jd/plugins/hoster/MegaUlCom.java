...
@HostPlugin(revision = "$Revision: 16510 $", interfaceVersion = 2, names = { "megaul.com" }, urls = { "https?://(www\\.)?megaul\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class MegaUlCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://megaul.com";
    ...
    // mods:
    // non account: 1 (no resume) * unlimited (could only find 3 links to test with)
    // free account:
    // premium account:
    ...
    public MegaUlCom(PluginWrapper wrapper) {
        super(wrapper);

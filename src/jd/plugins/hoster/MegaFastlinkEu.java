...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "megafastlink.eu" }, urls = { "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32323" }, flags = { 2 })
public class MegaFastlinkEu extends PluginForHost {
     ...
     */
    private String                                         hostPublicDomain   = "megafastlink.eu";

    public MegaFastlinkEu(PluginWrapper wrapper) {
        super(wrapper);

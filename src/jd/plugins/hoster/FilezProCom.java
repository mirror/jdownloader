...
@HostPlugin(revision = "$Revision: 16216 $", interfaceVersion = 2, names = { "filezpro.com" }, urls = { "https?://(www\\.)?filezpro\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FilezProCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://filezpro.com";
    ...
    // mods:
    // non account: 1 (resume off) * 1 (untested: enforced until proven
    // otherwise)
    // free account:
    // premium account:
    ...
    public FilezProCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void checkErrors(DownloadLink theLink, boolean checkAll, String passCode) throws NumberFormatException, PluginException {
        ...
        if (new Regex(correctedBR, "(You're using all download slots for IP|Your IP reached.+connection limit</a>, please try again later\\.)").matches()) { throw new PluginException(LinkStatus.ERROR_IP_BLOCKED, null, 10 * 60 * 1001l); }

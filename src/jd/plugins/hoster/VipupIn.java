...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vipup.in" }, urls = { "https?://(?:www\\.)?vipup\\.in/[A-Za-z0-9]+" }, flags = { 0 })
public class VipupIn extends PluginForHost {

    public VipupIn(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://vipup.in";
    private final String         domains                                      = "(vipup\\.in)";

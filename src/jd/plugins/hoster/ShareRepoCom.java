...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "sharerepo.com" }, urls = { "https?://(www\\.)?sharerepo\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ShareRepoCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://sharerepo.com";
    ...
    private String[] scanInfo(String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "<h3>([^<>\"]*?)\\&nbsp; <small>").getMatch(0);
        }
        if (fileInfo[1] == null) {

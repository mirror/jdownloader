...
@HostPlugin(revision = "$Revision: 16216 $", interfaceVersion = 2, names = { "fileduct.com" }, urls = { "https?://(www\\.)?fileduct\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileDuctCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://fileduct.com";
    ...
    // mods: rm correctDownloadLink,
    // non account: 1 chunk * unlimited
    // free account:
    // premium account:
    // protocol: http + https
    // captchatype: null
    ...
    public FileDuctCom(PluginWrapper wrapper) {
        super(wrapper);

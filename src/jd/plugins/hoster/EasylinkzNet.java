...
public class EasylinkzNet extends antiDDoSForHost {
    public EasylinkzNet(PluginWrapper wrapper) {
        super(wrapper);
        this.enablePremium(mainpage + "/upgrade." + type);
    }

    /* 1st domain = current domain! */
    public static String[] domains = new String[] { "easylinkz.net" };
    ...
    /* Basic constants */
    private final String                   mainpage                                     = ("http://" + domains[0]).replaceFirst("https?://", supportshttps_FORCED ? "https://" : "http://");
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        /* 2019-01-16: Special: Server returns urlencoded filenames so let's set the final filename here. */

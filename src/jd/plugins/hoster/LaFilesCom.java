...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "lafiles.com" }, urls = { "https?://(www\\.)?lafiles\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class LaFilesCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, Pattern.compile("(No such file|>File Not Found<|>The file was removed by|Reason (of|for) deletion:\n|\\[<font style=\"color:#114\"></font>\\])", Pattern.CASE_INSENSITIVE)).matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filefat.com" }, urls = { "http://(www\\.)?filefat\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileFatCom extends PluginForHost {
    ...
    // XfileSharingProBasic Version 2.1.1.4, added 1 filesize regex
    @Override
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) filesize = new Regex(BRBEFORE, ">File Size : </font><font style=\"font-size:14px;\">(.*?)</font>").getMatch(0);
            }
        }

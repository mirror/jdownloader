...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "downgb.com" }, urls = { "https?://(www\\.)?downgb\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class DowngbCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://downgb.com";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(downgb\\.com)";
    /*
    ...
    // mods:
    // limit-info: free (+free account) untested, set standard limits
    // protocol: no https
    // captchatype: unknown
    // other:
    ...
    @SuppressWarnings("deprecation")
    public DowngbCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "yousuwp.com" }, urls = { "https?://(?:www\\.)?yousuwp\\.com/file\\-[0-9]+\\.html" })
public class YousuwpCom extends PluginForHost {
    public YousuwpCom(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium("http://www.yousuwp.com/upgrade.html");
    }

    @Override
    public String getAGBLink() {
        return "http://www.yousuwp.com/terms.php";
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        String filename = br.getRegex("<div class=\"span8\">\\s*?<h1>([^<>\"]+)</h1>").getMatch(0);
        if (filename == null) {
            /* Fallback */
            filename = getFID(link);
        }
        String filesize = br.getRegex("<div class=\"header_content\">文件大小：([^<>\"]+)<").getMatch(0);

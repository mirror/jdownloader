...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "bl.st" }, urls = { "https?://(www\\.)?bl\\.st/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class BlSt extends PluginForHost {
    ...
    // mods: requestFileInformation[Added another FNF text], checkErrors[Added another premiumonly text]

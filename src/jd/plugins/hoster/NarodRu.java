...
public class NarodRu extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws IOException, InterruptedException, PluginException {
        ...
        if (br.containsHTML("<title>404</title>") || br.containsHTML("Файл удален с сервиса") || br.containsHTML("Закончился срок хранения файла\\.") || br.containsHTML("(class=\"b\\-download\\-virus\\-note\">|Файл заблокирован администрацией сервиса, скачать его нельзя)")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

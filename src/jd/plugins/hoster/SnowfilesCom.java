...
public class SnowfilesCom extends XFileSharingProBasic {
    public SnowfilesCom(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info: 2019-05-08: No limits at all<br />
     * captchatype-info: 2019-05-08: null<br />
     * other:<br />
     */
    private static String[] domains = new String[] { "snowfiles.com" };

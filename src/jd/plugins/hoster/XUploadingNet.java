...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "xuploading.net" }, urls = { "https?://(www\\.)?xuploading\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class XUploadingNet extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://xuploading.net";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(xuploading\\.net)";
    ...
    public XUploadingNet(PluginWrapper wrapper) {
        super(wrapper);

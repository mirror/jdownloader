...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "oload.net" }, urls = { "https?://(?:www\\.)?oload\\.net/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class OloadNet extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://oload.net";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(oload\\.net)";
    ...
    public OloadNet(PluginWrapper wrapper) {
        super(wrapper);

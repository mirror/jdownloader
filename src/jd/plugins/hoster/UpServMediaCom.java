...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "upservmedia.com" }, urls = { "https?://(www\\.)?upservmedia\\.com/[A-Za-z0-9]+" }, flags = { 2 })
public class UpServMediaCom extends PluginForHost {

    public UpServMediaCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://upservmedia.com";
    private final String         domains                                      = "(upservmedia\\.com)";
    ...
    /* Known errors */
    private static final String  url_ERROR_SIMULTANDLSLIMIT                   = ".+(e=You\\+have\\+reached\\+the\\+maximum\\+concurrent\\+downloads|Vous\\+avez\\+atteint\\+le\\+nombre\\+de\\+t%C3%A9l%C3%A9chargement\\+simultan%C3%A9|Vous\\+avez\\+atteint\\+le\\+nombre\\+de\\+téléchargement\\+simultané).+";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        if (available_CHECK_OVER_INFO_PAGE) {
            ...
            filename = br.getRegex("(?:Filename|Nom Du Fichier):[\t\n\r ]+</td>[\t\n\r ]+<td(?: class=\"responsiveInfoTable\")?>([^<>\"]*?)<").getMatch(0);
            ...
            filesize = br.getRegex("(?:Filesize|Taille):[\t\n\r ]+</td>[\t\n\r ]+<td(?: class=\"responsiveInfoTable\")?>([^<>\"]*?)<").getMatch(0);
        } else {
    ...
    private void handleErrors() throws PluginException {
        ...
        } else if (br.getURL().matches(url_ERROR_SIMULTANDLSLIMIT)) {

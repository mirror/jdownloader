...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "megafiles.us" }, urls = { "https?://(?:www\\.)?megafiles\\.us/(?:embed\\-)?[a-z0-9]{12}" })
public class MegafilesUs extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://megafiles.us";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(megafiles\\.us)";
     ...
     * mods:<br />
     * limit-info: 2017-07-19: premium untested, set FREE account limits<br />
    ...
    public MegafilesUs(PluginWrapper wrapper) {
        super(wrapper);

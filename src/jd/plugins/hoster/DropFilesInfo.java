...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "dropfiles.info" }, urls = { "http://(www\\.)?dropfiles\\.info/(en/)?download\\.php\\?id=[A-Z0-9]+" }, flags = { 0 })
public class DropFilesInfo extends PluginForHost {

    public DropFilesInfo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST     = "http://dropfiles.info";
    ...
    public void correctDownloadLink(DownloadLink link) {
        link.setUrlDownload(link.getDownloadURL().replaceAll("/(en|ru|fr|es|de)/download", "/download"));
    }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "filesisland.com" }, urls = { "https?://(?:www\\.)?filesisland\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class FilesislandCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://filesisland.com";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(filesisland\\.com)";
     ...
     * mods:<br />
     * limit-info: 2017-03-08: Premium untested, set FREE account limits<br />
    ...
    public FilesislandCom(PluginWrapper wrapper) {
        super(wrapper);

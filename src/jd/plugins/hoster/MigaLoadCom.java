...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "migaload.com" }, urls = { "https?://(www\\.)?migaload\\.com/up/[a-z0-9]{12}" }, flags = { 0 })
public class MigaLoadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://migaload.com";
    ...
    public MigaLoadCom(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(COOKIE_HOST + "/up/premium.html");
    }

...
public class AusfileCom extends antiDDoSForHost {
    ...
    private void correctBR() throws NumberFormatException, PluginException {
        ...
        regexStuff.add("(<[^>]* style\\s*=(\"|')color:#\\w+\\2[^>]*>\\s*Wrong captcha\\s*<\\s*/\\s*span\\s*>)");

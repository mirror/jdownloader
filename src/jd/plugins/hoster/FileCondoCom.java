...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filecondo.com" }, urls = { "http://(www\\.)?filecondodecrypted\\.com/download_regular_active\\.php\\?file=[A-Za-z0-9]+\\&part=\\d+" }, flags = { 0 })

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "isra.cloud" }, urls = { "https?://(?:www\\.)?isra\\.cloud/(?:embed\\-)?[a-z0-9]{12}" })
public class IsraCloud extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://isra.cloud".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:isra\\.cloud)";
     ...
     * limit-info: all untested as everything is premiumonly, set default limits<br />
    ...
    public IsraCloud(PluginWrapper wrapper) {
        super(wrapper);

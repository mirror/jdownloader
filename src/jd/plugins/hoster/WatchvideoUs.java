...
public class WatchvideoUs extends XFileSharingProBasic {
    public WatchvideoUs(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info: 2019-10-01: Set default connection limits as they use HLS for streaming. Multiple downloads however are possible. <br />
     * captchatype-info: 2019-10-01: null<br />
     * other:<br />
     */
    public static List<String[]> getPluginDomains() {
        final List<String[]> ret = new ArrayList<String[]>();
        // each entry in List<String[]> will result in one PluginForHost, Plugin.getHost() will return String[0]->main domain
        ret.add(new String[] { "watchvideo.us", "watchvideo2.us" });
        return ret;
    }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "watchvideo.us" }, urls = { "https?://(www\\.)?watchvideo2?\\.us/(?:embed\\-)?[a-z0-9]{12}" })
public class WatchvideoUs extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://watchvideo.us";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(watchvideo\\.us)";
     ...
     * mods: scanInfo[One extra filename RegEx], requestFileInformation[Added default file extension .mp4]<br />
     * limit-info:<br />
    ...
    public void correctDownloadLink(final DownloadLink link) {
        ...
        logger.info("NICE_HOST:" + NICE_HOST);
    ...
    public WatchvideoUs(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (inValidate(fileInfo[0])) {
            fileInfo[0] = new Regex(correctedBR, "<div id=\"content\" class=\"left\">[\t\n\r ]*?<h2>([^<>\"]+)</h2>").getMatch(0);
        }

...
public class NiraFileCom extends PluginForHost {
    ...
    private static final String  DOMAINS                      = "(nirafile\\.com|sapoor\\.in)";
    ...
    // mods:correctBR [Removed regex]
    // limit-info: untested because of timeouts
    // protocol: no https
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|File Deleted \\- not found)").matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

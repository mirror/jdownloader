...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "iuploadfiles.com" }, urls = { "https?://(www\\.)?iuploadfiles\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class IUploadFilesCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://iuploadfiles.com";
    ...
    public IUploadFilesCom(PluginWrapper wrapper) {
        super(wrapper);

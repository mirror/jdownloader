...
@HostPlugin(revision = "$Revision: 17424 $", interfaceVersion = 2, names = { "galaxy-file.com" }, urls = { "https?://(www\\.)?galaxy\\-file\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class GalaxyFileCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://galaxy-file.com";
    ...
    public GalaxyFileCom(PluginWrapper wrapper) {
        super(wrapper);

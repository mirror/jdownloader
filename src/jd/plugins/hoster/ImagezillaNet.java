...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "imagezilla.net" }, urls = { "https?://(?:www\\.)?imagezilla\\.net/show/([^/]+)" })
public class ImagezillaNet extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        if (br.getHttpConnection().getResponseCode() == 404 || br.containsHTML(">The requested image does not")) {
        ...
        dllink = link.getPluginPatternMatcher().replace("/show/", "/images/");
        if (filename == null) {

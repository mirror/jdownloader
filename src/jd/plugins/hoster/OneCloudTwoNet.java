...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "1cloud2.net" }, urls = { "https?://(?:www\\.)?1cloud2\\.net/(?:embed\\-)?[a-z0-9]{12}" })
public class OneCloudTwoNet extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://1cloud2.net".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:1cloud2\\.net)";
    ...
    public OneCloudTwoNet(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "megaporn.com/video", "cum.com" }, urls = { "NEVERUSETHISREGEXFORANYTHING", "http://[\\w\\.]*?(cum|megaporn|megarotic|sexuploader)\\.com/(.*?v=|v/)[a-zA-Z0-9]+" }, flags = { 2, 2 })
public class CumCom extends PluginForHost {

    private static String       agent     = RandomUserAgent.generate();
    private final static Object LOGINLOCK = new Object();

    public CumCom(PluginWrapper wrapper) {
        super(wrapper);
        this.enablePremium("http://www.cum.com/?c=premium");
    }
    ...
    private void antiJDBlock(Browser br) {
        try {
            ...
            br.setCookie("http://www.cum.com", "l", "en");
        } catch (Throwable e) {
    ...
    public void correctDownloadLink(DownloadLink link) throws Exception {
        link.setUrlDownload(link.getDownloadURL().replaceAll("(megaporn|megarotic|sexuploader)\\.com", "cum.com"));
    }

    /*
     * decrypts the crypted link from com un = input
     */
    ...
    public AccountInfo fetchAccountInfo(Account account) throws Exception {
        ...
        br.getPage("http://www.cum.com/?c=account");
    ...
    public String getAGBLink() {
        return "http://www.cum.com/?c=terms";
    }
    ...
    public void handleFree(DownloadLink link) throws Exception {
        ...
        brc.getPage("http://www.cum.com/video/xml/videolink.php?v=" + ID);
        if (brc.containsHTML("hd=\"1\"")) {
            ...
            url = "http://www" + s + ".cum.com/files/" + decrypt(un, Integer.parseInt(k1), Integer.parseInt(k2)) + "/";
        }
    ...
    public void handlePremium(DownloadLink downloadLink, Account account) throws Exception {
        ...
        brc.getPage("http://www.cum.com/video/xml/player_login.php?u=" + br.getCookie("http://www.cum.com", "user") + "&v=" + getDownloadID(downloadLink));
    ...
    public boolean isPremium(final Account account, final Browser br, final boolean refresh, boolean cloneBrowser) throws IOException {
        synchronized (LOGINLOCK) {
            ...
            if (account.getBooleanProperty("typeknown", false) == false || refresh) {
                ...
                brc.getPage("http://www.cum.com/?c=account");
    ...
    public void login(final Account account, final boolean cookielogin) throws IOException, PluginException {
        ...
        synchronized (LOGINLOCK) {
            ...
            if (cookielogin && user != null) {
                this.br.setCookie("http://www.cum.com", "l", "en");
                this.br.setCookie("http://www.cum.com", "user", user);
                return;
            } else {
                if (account.getUser().trim().equalsIgnoreCase("cookie")) {
                    this.setBrowserExclusive();
                    this.br.setCookie("http://www.cum.com", "l", "en");
                    this.br.setCookie("http://www.cum.com", "user", account.getPass());
                    this.br.getPage("http://www.cum.com/");
                } else {
                    this.setBrowserExclusive();
                    this.br.setCookie("http://www.cum.com", "l", "en");
                    this.br.getPage("http://www.cum.com/?s=account");
                    this.br.postPage("http://www.cum.com/?s=account", "login=1&username=" + Encoding.urlEncode(account.getUser()) + "&password=" + Encoding.urlEncode(account.getPass()));
                }
                user = this.br.getCookie("http://www.cum.com", "user");
                this.br.setCookie("http://www.cum.com", "user", user);
    ...
    public AvailableStatus requestFileInformation(DownloadLink parameter) throws Exception {
        ...
        Browser brc = br.cloneBrowser();
        brc.getPage("http://www.cum.com/video/xml/videolink.php?v=" + getDownloadID(parameter));

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "sunexenus.com" }, urls = { "https?://(?:www\\.)?sunexenus\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class SunexenusCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://sunexenus.com";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(sunexenus\\.com)";

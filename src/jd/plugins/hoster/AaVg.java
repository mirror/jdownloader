...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "aavg.net", "aa.vg" }, urls = { "https?://(www\\.)?(aa\\.vg|aavg\\.net)/[a-z0-9]{12}", "rfhgirdjgvt5uzbrjhELETEMEgztjzhkj" }, flags = { 0, 0 })
public class AaVg extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://aa.vg";
    ...
    public void correctDownloadLink(DownloadLink link) {
        link.setUrlDownload(link.getDownloadURL().replace("https://", "http://").replace("aa.vg/", "aavg.net/"));
    }
    ...
    public AaVg(PluginWrapper wrapper) {
        super(wrapper);

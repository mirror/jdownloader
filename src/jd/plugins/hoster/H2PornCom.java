...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "h2porn.com" }, urls = { "http://(www\\.)?h2porn\\.com/videos/[a-z0-9\\-_]+" }, flags = { 0 })
public class H2PornCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://h2porn.com/legal.php#TermsOfService";
    }

    @Override
    public int getMaxSimultanFreeDownloadNum() {
        // Max 3 connections at all
        return 1;
    }

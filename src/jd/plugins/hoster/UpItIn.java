...
@HostPlugin(revision = "$Revision: 14918 $", interfaceVersion = 2, names = { "upit.in" }, urls = { "http://(www\\.)?upit\\.in/[a-z0-9]{12}(\\.html|/.+)?" }, flags = { 0 })
public class UpItIn extends PluginForHost {
    ...
    private static final String COOKIE_HOST         = "http://upit.in";

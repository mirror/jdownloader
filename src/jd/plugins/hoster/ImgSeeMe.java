...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "imgsee.me" }, urls = { "https?://(www\\.)?imgsee\\.me/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ImgSeeMe extends PluginForHost {
    ...
    // mods: using mass-linkcheck because no filename/size is given
    // limit-info:
    // protocol: no https

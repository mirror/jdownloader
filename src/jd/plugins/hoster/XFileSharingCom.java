...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "xfilesharing.com" }, urls = { "http://[\\w\\.]*?xfilesharing\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })
public class XFileSharingCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST = "http://xfilesharing.com";

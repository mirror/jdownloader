...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "cloudnes.com" }, urls = { "https?://(www\\.)?cloudnes\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class CloudNesCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://cloudnes.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(cloudnes\\.com)";
    ...
    public CloudNesCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 16216 $", interfaceVersion = 2, names = { "prefiles.com" }, urls = { "https?://(www\\.)?prefiles\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class PreFilesCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://prefiles.com";

...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "videofox.net" }, urls = { "https?://(www\\.)?videofox\\.net/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class VideoFoxNet extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://videofox.net";
    // domain names used within download links.
    private final String               DOMAINS                      = "(videofox\\.net)";
     ...
     * */
    public VideoFoxNet(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

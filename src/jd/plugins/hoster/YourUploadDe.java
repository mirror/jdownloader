...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "yourupload.de" }, urls = { "http://(www\\.)?yourupload\\.de/[a-z0-9]{12}" }, flags = { 0 })
public class YourUploadDe extends PluginForHost {

    private String              BRBEFORE            = "";

    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST         = "http://yourupload.de";

    private static final String MAINTENANCE         = ">This server is in maintenance mode";

    private static final String MAINTENANCEUSERTEXT = "This server is under Maintenance";

    public YourUploadDe(PluginWrapper wrapper) {
        super(wrapper);

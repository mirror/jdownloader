...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "keepshare.net" }, urls = { "http://(www\\.)?keepshare\\.net/(?!faq|register|login|terms|report_file|upgrade)[a-z0-9]+" }, flags = { 0 })
public class KeepShareNet extends PluginForHost {
    ...
    private final String        MAINPAGE                 = "http://keepshare.com";

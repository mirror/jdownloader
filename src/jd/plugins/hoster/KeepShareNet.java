...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "keepshare.net" }, urls = { "https?://(www\\.)?keepshare\\.net/[A-Za-z0-9]+" }, flags = { 0 })
public class KeepShareNet extends PluginForHost {
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://keepshare.net";
    private final String         domains                                      = "(keepshare\\.net)";

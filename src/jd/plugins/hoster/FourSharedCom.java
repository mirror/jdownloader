...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "4shared.com" }, urls = { "https?://(www\\.)?4shared(-china)?\\.com/(account/)?(download|get|file|document|photo|video|audio|mp3|office|rar)/.+?/.*" }, flags = { 2 })

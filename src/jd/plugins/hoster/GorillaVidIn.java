...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "gorillavid.in" }, urls = { "https?://(www\\.)?gorillavid\\.in/[a-z0-9]{12}" }, flags = { 0 })
public class GorillaVidIn extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (br.getURL().contains("gorillavid.in/404.html") || new Regex(correctedBR, "(>File Not Found<|>404 \\- Not Found<)").matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

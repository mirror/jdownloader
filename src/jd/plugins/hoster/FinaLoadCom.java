...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "finaload.com" }, urls = { "http://(www\\.)?finaload\\.com/(?!faq|register|login|terms|report_file)[a-z0-9]+" }, flags = { 0 })
public class FinaLoadCom extends PluginForHost {

    public FinaLoadCom(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    private final String  MAINPAGE  = "http://finaload.com";

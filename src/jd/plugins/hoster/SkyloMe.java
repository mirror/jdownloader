...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "skylo.me" }, urls = { "http://(www\\.)?skylo\\.me/[a-z]{2}\\.php\\?Id=[0-9a-f]+" }, flags = { 32 })
public class SkyloMe extends PluginForHost {

    private String DLLINK;

    public SkyloMe(PluginWrapper wrapper) {
        super(wrapper);
    }

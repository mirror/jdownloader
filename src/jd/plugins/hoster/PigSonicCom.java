...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "pigsonic.com" }, urls = { "https?://(www\\.)?pigsonic\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class PigSonicCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, Pattern.compile("(No such file|>File Not Found<|>The file was removed by|Reason (of|for) deletion:\n|Possible causes of this error could be|The file you were looking for could <b>NOT BE FOUND|>SEARCHING FILE)", Pattern.CASE_INSENSITIVE)).matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

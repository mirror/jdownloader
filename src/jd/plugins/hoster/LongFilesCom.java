...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "longfiles.com" }, urls = { "https?://(www\\.)?longfiles\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class LongFilesCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://longfiles.com";

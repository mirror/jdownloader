...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "fastupload.org" }, urls = { "https?://(www\\.)?fastupload\\.org/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FastUploadOrg extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://fastupload.org";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(fastupload\\.org)";
    ...
    // mods:scanInfo [Added 1 filename regex]
    // limit-info:
    // protocol: no https
    ...
    public FastUploadOrg(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "style=\"font\\-size:22px;color:#04aed9;\">([^<>\"]*?)</span>").getMatch(0);
        }
        if (fileInfo[1] == null) {

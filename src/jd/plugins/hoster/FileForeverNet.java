...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "fileforever.net" }, urls = { "https?://(www\\.)?fileforever\\.net/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FileForeverNet extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://fileforever.net";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(fileforever\\.net)";
    ...
    // mods: scanInfo: removed generic filesize failover as filesize is not provided in first html
    // limit-info:
    // protocol: no https
    ...
    public FileForeverNet(PluginWrapper wrapper) {
        super(wrapper);

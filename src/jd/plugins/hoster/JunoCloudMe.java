...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "junocloud.me" }, urls = { "https?://(www\\.)?junocloud\\.me/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 2 })
...
public class JunoCloudMe extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (cbr.containsHTML("(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<li>The file (expired|deleted by (its owner|administration))|>Size: </p>)")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
    ...
    private void checkServerErrors() throws NumberFormatException, PluginException {
        if (cbr.containsHTML("No file")) throw new PluginException(LinkStatus.ERROR_FATAL, "Server error: 'no file'");

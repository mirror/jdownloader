...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "junocloud.me" }, urls = { "https?://(www\\.)?junocloud\\.me/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class JunoCloudMe extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://junocloud.me";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(junocloud\\.me)";
    ...
    // mods: added download forms action and changed waittime regex
    // non account: 2 * 1
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        if (account.getBooleanProperty("nopremium")) {
            ...
            // Expire date is on mainpage only
            getPage("http://junocloud.me/home.html");
            ...
            if (expire != null) ai.setValidUntil(TimeFormatter.getMilliSeconds(expire, "dd MMMM yyyy", Locale.ENGLISH));
            try {
                maxPrem.set(1);
                account.setMaxSimultanDownloads(maxPrem.get());

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "rusfolder.ru", "ifolder.ru" }, urls = { "http://([a-z\\.-]*?\\.)?(rusfolder\\.(net|ru|com)|ifolder\\.ru|files\\.metalarea\\.org)/\\d+", "IFOLDERISNOWRUSFOLDER" }, flags = { 0, 0 })

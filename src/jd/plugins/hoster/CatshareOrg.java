...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "catshare.org" }, urls = { "https?://(www\\.)?catshare\\.org/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class CatshareOrg extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://catshare.org";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(catshare\\.org)";
     ...
     * mods:<br />
     * limit-info: untested, set standard limits<br />
    ...
    public CatshareOrg(PluginWrapper wrapper) {
        super(wrapper);

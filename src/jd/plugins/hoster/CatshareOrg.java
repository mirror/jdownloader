...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "catshare.org" }, urls = { "https?://(www\\.)?catshare\\.org/(?:embed\\-)?[a-z0-9]{12}" })
public class CatshareOrg extends antiDDoSForHost {

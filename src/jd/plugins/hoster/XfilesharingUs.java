...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "xfilesharing.us" }, urls = { "https?://(?:www\\.)?xfilesharing\\.us/(?:embed\\-)?[a-z0-9]{12}" })
public class XfilesharingUs extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://xfilesharing.us";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(xfilesharing\\.us)";
    ...
    @SuppressWarnings("deprecation")
    public XfilesharingUs(PluginWrapper wrapper) {
        super(wrapper);

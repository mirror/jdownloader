...
public class FileCrownCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST   = "http://filecrown.com";
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (BRBEFORE.contains("<title>404 Not Found</title>")) { throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND); }
    ...
    public void doFree(DownloadLink downloadLink, boolean resumable, int maxchunks, boolean loggedIn) throws Exception, PluginException {
        ...
        if (BRBEFORE.contains(";background:#ccc;text-align")) {
            ...
            recaptcha = true;
            // Note: Waittime can be skipped when they use reCaptcha

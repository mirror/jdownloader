...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "fileuplo.de" }, urls = { "https?://(www\\.)?fileuplo\\.de/[a-z0-9]{12}" }, flags = { 0 })
public class FileuploDe extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://fileuplo.de";
    ...
    public FileuploDe(PluginWrapper wrapper) {
        super(wrapper);

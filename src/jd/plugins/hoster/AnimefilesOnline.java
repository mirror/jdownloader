...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "animefiles.online" }, urls = { "https?://(?:www\\.)?(?:rabidfiles\\.com|animefiles\\.online)/[A-Za-z0-9]+" })
public class AnimefilesOnline extends antiDDoSForHost {
    public AnimefilesOnline(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public String rewriteHost(String host) {
        if ("rabidfiles.com".equals(host)) {
            return "animefiles.online";
        }
    ...
    private final String                   domains                                      = "(rabidfiles\\.com|animefiles\\.online)";

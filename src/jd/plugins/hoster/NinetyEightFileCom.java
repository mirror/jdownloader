...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "98file.com" }, urls = { "https?://(www\\.)?98file\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class NinetyEightFileCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private static final String        COOKIE_HOST                  = "http://98file.com";
    // domain names used within download links.
    private static final String        DOMAINS                      = "(98file\\.com)";
     ...
     * */
    public NinetyEightFileCom(PluginWrapper wrapper) {
        super(wrapper);

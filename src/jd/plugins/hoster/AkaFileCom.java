...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "akafile.com" }, urls = { "https?://(www\\.)?akafile\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
...
public class AkaFileCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (cbr.containsHTML("(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<li>The file (expired|deleted by (its owner|administration))|the file looks deleted from our dedicated servers)")) {

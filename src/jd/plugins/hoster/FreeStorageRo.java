...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "freestorage.ro" }, urls = { "https?://(www\\.)?freestorage\\.ro/[a-z0-9]{12}" }, flags = { 0 })
public class FreeStorageRo extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://freestorage.ro";
    ...
    public FreeStorageRo(PluginWrapper wrapper) {
        super(wrapper);

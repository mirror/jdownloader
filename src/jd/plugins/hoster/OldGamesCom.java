...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "old-games.com" }, urls = { "http://(?:www\\.)?old\\-games\\.com/(?:getfile|getfree)/\\d+" }, flags = { 0 })
public class OldGamesCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        link.setLinkID(fuid);
        br.getPage("http://www.old-games.com/getfile/" + this.fuid);

...
public class CatShareNet extends PluginForHost {
    ...
    private final boolean  use_api_availablecheck = false;
    ...
    // diabled: 2016-05-09 22:00 CET - API call doesn't return JSON response any longer!
    // @SuppressWarnings({ "deprecation" })
    // @Override

    public boolean checkLinks_DISABLED(final DownloadLink[] urls) {
        ...
        try {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (index == urls.length || links.size() > 0) {
                        break;
                    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (use_api_availablecheck) {
            checkLinks_DISABLED(new DownloadLink[] { downloadLink });
    ...
    public void handleDownloadAPI(final DownloadLink downloadLink, final boolean resumable, final int maxChunks, final boolean premium, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            int wait = 0;
            final String wait_str = PluginJSonUtils.getJson(br, "wait_time");
            if (wait_str != null) {

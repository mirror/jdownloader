...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "files.d-lan.dp.ua" }, urls = { "https?://(?:www\\.)?files\\.d\\-lan\\.dp\\.ua/download\\?file=[a-f0-9]{32}" })
public class FilesDlanDpUa extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        String filename = br.getRegex("Название файла: ([^<>\"]+)</br>").getMatch(0);
    ...
    private void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            dllink = br.getRegex("\"(https?://files\\.d\\-lan\\.dp\\.ua/download\\d+\\.php[^<>\"]+)\"").getMatch(0);

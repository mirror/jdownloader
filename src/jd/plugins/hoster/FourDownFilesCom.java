...
public class FourDownFilesCom extends antiDDoSForHost {
    ...
    // mods: scanInfo[Added one extra filename RegEx]
    ...
    public String rewriteHost(String host) {
        if ("4downfiles.com".equals(getHost()) || "4downfiles.net".equals(getHost())) {
            if (host == null || "4downfiles.com".equals(host) || "4downfiles.net".equals(host)) {
                return "4downfiles.org";
            }
        }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>\\s*(Download )?File Not Found\\s*<|>The file was removed by|Reason for deletion:|<title>Download </)").matches()) {
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "q=([^<>\"]*?)\"").getMatch(0);
        }
        if (fileInfo[1] == null) {

...
public class DirrtysharEs extends antiDDoSForHost {
     ...
     * YetiShareBasic Version 1.1.0-psp<br />
     * mods: getContinueLink[Added some code to prevent grabbing the wrong URL] <br />
     * limit-info: 2017-06-01: premium untested, set FREE account limits<br />
    ...
    private String getContinueLink() {
        ...
        if (continue_link == null) {
            continue_link = br.getRegex("(?:\"|\\')(https?://(www\\.)?" + domains + "/(?!login\\.html)[^<>\"]*?pt=[^<>\"]*?)(?:\"|\\')").getMatch(0);
        }
        if (continue_link == null) {

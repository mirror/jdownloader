...
public class UpFileCom extends XFileSharingProBasic {
    public UpFileCom(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info: 2020-06-17: Premium untested, set FREE limits <br />
     * captchatype-info: 2020-06-17: reCaptchaV2<br />
     * other:<br />
     */
    public static List<String[]> getPluginDomains() {
        final List<String[]> ret = new ArrayList<String[]>();
        // each entry in List<String[]> will result in one PluginForHost, Plugin.getHost() will return String[0]->main domain
        ret.add(new String[] { "up-file.com" });
        return ret;
    }

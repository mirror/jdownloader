...
public class KatfileCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(/images/404(-remove)?.png|No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|File Not Found|>The file expired)").matches()) {
    ...
    private void checkErrors(final DownloadLink theLink, final boolean checkAll) throws NumberFormatException, PluginException {
        ...
        if (correctedBR.contains("Your IP is blacklisted") && correctedBR.contains("Please disconnect your")) {
            throw new PluginException(LinkStatus.ERROR_IP_BLOCKED, "Your IP/VPN/PROXY is blacklisted");
        }

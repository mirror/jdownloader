...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "2backup.net" }, urls = { "http://[\\w\\.]*?2backup\\.net/[a-z0-9]{12}" }, flags = { 0 })
public class TwoBackupNet extends PluginForHost {

    public TwoBackupNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST = "http://2backup.net";

...
public class TktubeCom extends KernelVideoSharingComV2 {
    public TktubeCom(final PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    protected boolean enableFastLinkcheck() {
        /*
         * 2023-05-03: Website doesn't like HEAD-requests. I'm using this as a workaround so direct-URLs are not checked during
         * availablecheck.
         */
        return true;
    }

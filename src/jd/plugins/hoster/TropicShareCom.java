...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "tropicshare.com" }, urls = { "http://(www\\.)?tropicshare\\.com/files/\\d+\\-[^<>\"]+\\.html" }, flags = { 0 })
public class TropicShareCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        link.setDownloadSize(SizeFormatter.getSize(filesize + " GB"));
    ...
    public void handleFree(final DownloadLink downloadLink) throws Exception, PluginException {
        ...
        final String dllink = "http://tropicshare.com/free_download.php?id=" + new Regex(downloadLink.getDownloadURL(), "tropicshare\\.com/files/(\\d+)\\-").getMatch(0);

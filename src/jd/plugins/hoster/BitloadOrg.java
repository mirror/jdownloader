...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "bitload.org" }, urls = { "https?://(?:www\\.)?bitload\\.(?:org|co)/(?:embed\\-)?[a-z0-9]{12}" })
public class BitloadOrg extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://bitload.org";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(bitload\\.org|bitload\\.co)";
     ...
     */
    /* 2017-03-30: Disabled html filesize check! */
     ...
     * mods:<br />
     * limit-info:2017-03-30: premium untested, set FREE account limits<br />
     ...
     * captchatype: 2017-03-30: reCaptchaV2<br />
     * other: 2017-03-30: According to user, former domain is bitload.com (and bitload.it??)<br />
     */
    ...
    public BitloadOrg(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void handlePremium(final DownloadLink downloadLink, final Account account) throws Exception {
        ...
        if (account.getType() == AccountType.FREE) {
            ...
            requestFileInformation(downloadLink);
            doFree(downloadLink, true, -8, PROPERTY_DLLINK_ACCOUNT_FREE);
        } else {
            ...
            logger.info("Final downloadlink = " + dllink + " starting the download...");
            dl = new jd.plugins.BrowserAdapter().openDownload(this.br, downloadLink, dllink, true, -8);
            if (dl.getConnection().getContentType().contains("html")) {
                checkResponseCodeErrors(dl.getConnection());
                logger.warning("The final dllink seems not to be a file!");

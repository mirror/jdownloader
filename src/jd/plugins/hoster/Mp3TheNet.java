...
@HostPlugin(revision = "$Revision: 17298 $", interfaceVersion = 2, names = { "mp3the.net" }, urls = { "https?://(www\\.)?mp3the\\.net/[a-z0-9]{12}" }, flags = { 0 })
public class Mp3TheNet extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://mp3the.net";
    ...
    public Mp3TheNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "<h3>Download:? ([^<>\"\\']+)</h3>").getMatch(0);

...
public class DesufilesCom extends UnknownHostingScriptCore {
    public DesufilesCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public static String[] domains = new String[] { "desufiles.com" };

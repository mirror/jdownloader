...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "cloudvidz.net" }, urls = { "https?://(www\\.)?cloudvidz\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class CloudVidzCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://cloudvidz.net";
    private static final String  NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    // domain names used within download links.
    private static final String  DOMAINS                      = "(cloudvidz\\.net)";

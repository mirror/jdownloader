...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "vodlock.co" }, urls = { "https?://(?:www\\.)?vodlock\\.co/(?:embed\\-)?[a-z0-9]{12}" })
public class VodlockCo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://vodlock.co";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(vodlock\\.co)";
    ...
    public VodlockCo(PluginWrapper wrapper) {
        super(wrapper);

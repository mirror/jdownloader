...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "maxisonic.com" }, urls = { "https?://(www\\.)?maxisonic\\.com/[A-Za-z0-9]+" }, flags = { 2 })
public class MaxisonicCom extends PluginForHost {

    public MaxisonicCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://maxisonic.com";
    private final String         domains                                      = "(maxisonic\\.com)";

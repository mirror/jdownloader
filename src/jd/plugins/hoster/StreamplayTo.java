...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "streamplay.to" }, urls = { "https?://(?:www\\.)?streamplay\\.to/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class StreamplayTo extends PluginForHost {
     ...
     * mods: doFree[waittime before submitting download1 form]<br />
     * limit-info:<br />
    ...
    public StreamplayTo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void handleFree(final DownloadLink downloadLink) throws Exception, PluginException {
        ...
        doFree(downloadLink, true, -6, PROPERTY_DLLINK_FREE);
    }
    ...
    private void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            if (download1 != null) {
                ...
                /* Special - waittime before download1 */

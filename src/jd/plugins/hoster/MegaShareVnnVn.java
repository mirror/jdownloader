...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "megashare.vnn.vn" }, urls = { "http://(www\\.)?megashare\\.vnn\\.vn/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })

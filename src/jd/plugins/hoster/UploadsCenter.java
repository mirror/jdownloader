...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploads.center" }, urls = { "http://(www\\.)?uploads\\.center/[A-Za-z0-9]+" }, flags = { 0 })
public class UploadsCenter extends PluginForHost {

    public UploadsCenter(PluginWrapper wrapper) {
        super(wrapper);
    }

    // For sites which use this script: http://www.yetishare.com/
    // YetiShareBasic Version 0.2.9-psp
    // mods:doFree[Handling for finallink in html code]
    // protocol: no https
    // captchatype: null
    ...
    /* Other constants */
    private final String         MAINPAGE                                     = "http://uploads.center";

...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "rapidstone.com" }, urls = { "https?://(www\\.)?rapidstone\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
...
public class RapidStoneCom extends PluginForHost {
    ...
    private final String               MAINTENANCE                  = ">This server is in maintenance mode|>We are moving to a new datacenter";

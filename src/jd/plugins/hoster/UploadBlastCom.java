...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadblast.com" }, urls = { "https?://(www\\.)?uploadblast\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class UploadBlastCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://uploadblast.com";
    ...
    /** DEV NOTES */
    // XfileSharingProBasic Version 2.5.9.7
    // mods:
    // non account: 2 * 2
    ...
    public UploadBlastCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|deleted from our dedicated servers due to violate our rules|>Mod license violation<)").matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

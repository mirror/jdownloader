...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "xtraupload.net" }, urls = { "https?://(www\\.)?xtraupload\\.net/[A-Za-z0-9]+" }, flags = { 2 })
public class XtrauploadNet extends PluginForHost {

    public XtrauploadNet(PluginWrapper wrapper) {
        super(wrapper);
        this.enablePremium(mainpage + "/upgrade." + type);
    }

    // For sites which use this script: http://www.yetishare.com/
    // YetiShareBasic Version 0.5.6-psp
    // mods:
    // limit-info:
    // protocol: no https
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://xtraupload.net";
    private final String         domains                                      = "(xtraupload\\.net)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "the7sky.info" }, urls = { "https?://(?:www\\.)?the7sky\\.info/[A-Za-z0-9]+" }, flags = { 2 })
public class The7skyInfo extends PluginForHost {

    public The7skyInfo(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * YetiShareBasic Version 0.7.4-psp<br />
     * mods:<br />
     * limit-info: only registered & premium users can download<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://the7sky.info";
    private final String                   domains                                      = "(the7sky\\.info)";
    ...
    private static final String            url_ERROR_PREMIUMONLY                        = "e=You\\+must\\+register\\+for\\+a\\+premium\\+account\\+to|.+/register\\.html.+";

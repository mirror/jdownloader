...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "the7sky.info" }, urls = { "https?://(?:www\\.)?the7sky\\.info/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class The7skyInfo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://the7sky.info";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(the7sky\\.info)";
     ...
     * other: Website used YetiShare before<br />
     */
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        setFUID(link);
        if (this.fuid == null) {
            /* Old urls from YetiShareScript --> definitly Offline */

...
public class VidabcCom extends PluginForHost {
    ...
    private static final String            DOMAINS                            = "(vidabc\\.com)";
     ...
     * mods: scanInfo[Added another filename RegEx]<br />
     * limit-info:<br />
    ...
    @SuppressWarnings("deprecation")
    public VidabcCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (inValidate(fileInfo[0])) {
            /* Special */
            fileInfo[0] = new Regex(correctedBR, "class=\"left\">[\t\n\r ]*?<h2>([^<>\"]+)</h2>").getMatch(0);
        }

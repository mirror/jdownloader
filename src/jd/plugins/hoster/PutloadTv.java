...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "putload.tv" }, urls = { "https?://(?:www\\.)?putload\\.tv/(?:embed\\-)?[a-z0-9]{12}" })
public class PutloadTv extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://putload.tv";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(putload\\.tv)";
    ...
    @SuppressWarnings("deprecation")
    public PutloadTv(PluginWrapper wrapper) {
        super(wrapper);

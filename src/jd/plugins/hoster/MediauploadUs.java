...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "mediaupload.us" }, urls = { "https?://(?:www\\.)?mediaupload\\.us/(?:embed\\-)?[a-z0-9]{12}" })
public class MediauploadUs extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://mediaupload.us";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(mediaupload\\.us)";
    ...
    public MediauploadUs(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "dosya.tv" }, urls = { "https?://(?:www\\.)?dosya\\.tv/[A-Za-z0-9]+" })
public class DosyaTv extends PluginForHost {
     ...
     * mods:<br />
     * limit-info: 2016-11-03: account limits unchecked, set FREE limits<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://dosya.tv";
    private final String                   domains                                      = "(dosya\\.tv)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "bravoteens.com" }, urls = { "http://(www\\.)?bravoteens\\.com/videos/\\d+/[\\w\\-]+/" }, flags = { 0 })
public class BravoTeensCom extends PluginForHost {
    ...
    public BravoTeensCom(final PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (DLLINK == null) {
            DLLINK = br.getRegex("(\\'|\")(http://(www\\.)?bravoteens\\.com/get_file/[^<>\"]*?)(\\'|\")").getMatch(1);
        }

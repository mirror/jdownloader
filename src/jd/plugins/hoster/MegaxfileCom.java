...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "megaxfile.com" }, urls = { "https?://(www\\.)?megaxfile\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class MegaxfileCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://megaxfile.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(megaxfile\\.com)";
    ...
    // mods: scanInfo[Added a new filesize RegEx]
    // limit-info:
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public MegaxfileCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[1] == null) {
            /* First check commented out html */
            fileInfo[1] = br.getRegex("\\[<font style=\"color:#114\">([^<>\"]*?)</font>\\]</h2>").getMatch(0);
        }
        if (fileInfo[1] == null) {

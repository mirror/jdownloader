...
@HostPlugin(revision = "$Revision: 36922 $", interfaceVersion = 2, names = { "ezfiles.net" }, urls = { "https?://(?:www\\.)?ezfiles\\.net/[A-Za-z0-9]+" })
public class EZFiles extends antiDDoSForHost {

    public EZFiles(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://ezfiles.net";
    private final String                   domains                                      = "(ezfiles\\.net)";

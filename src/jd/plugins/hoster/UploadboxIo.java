...
public class UploadboxIo extends antiDDoSForHost {
    /* 1st domain = current domain! */
    public static String[] domains = new String[] { "uploadbox.io" };
    ...
    public UploadboxIo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(final DownloadLink downloadLink, final long timeBefore) throws PluginException {
        ...
        if (ttt == null) {
            /* 2018-12-12: Special */
            ttt = new Regex(correctedBR, "class=\"seconds count\">\\s*?(\\d+)\\s*?<").getMatch(0);
        }
        if (ttt != null) {

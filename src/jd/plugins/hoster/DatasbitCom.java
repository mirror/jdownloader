...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "datasbit.com" }, urls = { "https?://(www\\.)?datasbit\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class DatasbitCom extends PluginForHost {
     ...
     * limit-info: untested due to premiumonly - set standard limits<br />

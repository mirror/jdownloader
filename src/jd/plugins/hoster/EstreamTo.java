...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "estream.to" }, urls = { "https?://(?:www\\.)?estream\\.(?:to|xyz)/(?:embed\\-)?[a-z0-9]{12}" })
public class EstreamTo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://estream.to";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(estream\\.(?:to|xyz))";
    ...
    private static AtomicInteger           totalMaxSimultanFreeDownload       = new AtomicInteger(12);
     ...
     * mods: requestFileInformation[Added another offline RegEx], scanInfo[Added another filename RegEx]<br />
     * limit-info:<br />
    ...
    @SuppressWarnings("deprecation")
    public EstreamTo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|>Reason for deletion:|File Not Found|>The file expired|The file was deleted by administration because)").matches()) {

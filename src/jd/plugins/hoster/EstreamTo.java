...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "estream.to" }, urls = { "https?://(?:www\\.)?estream\\.to/(?:embed\\-)?[a-z0-9]{12}" })
public class EstreamTo extends PluginForHost {
    ...
    private static final String            DOMAINS                            = "(estream\\.to)";

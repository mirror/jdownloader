...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "junkyvideo.com" }, urls = { "https?://(www\\.)?junkyvideo\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class JunkyVideoCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://junkyvideo.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(junkyvideo\\.com)";
    ...
    // mods: getDllink[Added a new RegEx]
    // limit-info: no matter which account type, limits are always the same, probably serverside mistake
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public JunkyVideoCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public String getDllink() {
        ...
        dllink = new Regex(correctedBR, "file:\\'(http://[a-z0-9\\.]+:\\d+/[^<>\"]*?)\\'").getMatch(0);
        return dllink;
    }

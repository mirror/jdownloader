...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "cloudlocker.biz" }, urls = { "https?://(www\\.)?cloudlocker\\.biz/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class CloudLockerBiz extends PluginForHost {
    ...
    private static final String    COOKIE_HOST                  = "http://cloudlocker.biz";
    private static final String    NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String    NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String    DOMAINS                      = "(cloudlocker\\.biz)";

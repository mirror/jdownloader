...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "up4file.com" }, urls = { "https?://(?:www\\.)?up4file\\.com/[A-Za-z0-9]+" })
public class Up4fileCom extends PluginForHost {

    public Up4fileCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://up4file.com";
    private final String                   domains                                      = "(up4file\\.com)";

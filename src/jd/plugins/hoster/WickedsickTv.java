...
public class WickedsickTv extends antiDDoSForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        } else if (!br.containsHTML("id=\"my-player\"")) {
            logger.info("Empty video page --> No downloadable content (?)");
        }
        String filename = br.getRegex("<title>([^<>\"]+) - Wicked Sick</title>").getMatch(0);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploaded.to" ,"ul.to","ul.to"}, urls = { "http://[\\w\\.]*?uploaded\\.to/.*?(file/|\\?id=|&id=)[\\w]+/?","http://[\\w\\.]*?ul\\.to/[\\w\\-]+/.+","http://[\\w\\.]*?ul\\.to/[\\w\\-]+/?" }, flags = { 2,2,2 })

...
public class Uploadedto extends PluginForHost {
    ...
    public void doFree(DownloadLink downloadLink) throws Exception {
        ...
        if (br.containsHTML("err\":\"Leider sind derzeit all unsere verf\\&#252;gbaren Download\\-Slots belegt")) throw new PluginException(LinkStatus.ERROR_HOSTER_TEMPORARILY_UNAVAILABLE, "No free Downloadslots available", 10 * 60 * 1000l);

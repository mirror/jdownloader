...
public class UploadAc extends antiDDoSForHost {
    /* 1st domain = current domain! */
    public static String[] domains = new String[] { "upload.ac", "uploadshub.com", "upload.so", "uplod.ws" };
    ...
    public String rewriteHost(String host) {
        if ("uploadshub.com".equals(getHost()) || "upload.so".equals(getHost()) || "uplod.ws".equals(getHost())) {
            if (host == null || "uploadshub.com".equals(host) || "upload.so".equals(host) || "uplod.ws".equals(host)) {
                return "upload.ac";
            }
        }
     ...
     * limit-info: 2018-10-30: Account limits untested, set FREE limits<br />
    ...
    public UploadAc(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String getFilesizeViaAvailablecheckAlt(final Browser br, final DownloadLink dl) {
        ...
        /* 2018-10-30: Special: Use old "checkfiles" instead of "check_files" */
        ...
        try {
            ...
            if (SUPPORTS_AVAILABLECHECK_ALT_FAST) {
                ...
                final Form checkfiles_form = br.getFormByInputFieldKeyValue("op", "checkfiles");

            ...
            try {
                ...
                if (!loggedInViaCookies) {
                    ...
                    if (!loginCookieOkay && !loginFormOkay && !loginURLOkay) {
                        ...
                        // throw new PluginException(LinkStatus.ERROR_PREMIUM, "\r\nUngültiger Benutzername, Passwort oder login
                        // Captcha!\r\nDu bist dir sicher, dass dein eingegebener Benutzername und Passwort stimmen? Versuche
                        // folgendes:\r\n1. Falls dein Passwort Sonderzeichen enthält, ändere es (entferne diese) und versuche es
                        // erneut!\r\n2. Gib deine Zugangsdaten per Hand (ohne kopieren/einfügen) ein.",
                        // PluginException.VALUE_ID_PREMIUM_DISABLE);
                        // } else if ("pl".equalsIgnoreCase(System.getProperty("user.language"))) {
                        // throw new PluginException(LinkStatus.ERROR_PREMIUM, "\r\nBłędny użytkownik/hasło lub kod Captcha wymagany do
                        // zalogowania!\r\nUpewnij się, że prawidłowo wprowadziłes hasło i nazwę użytkownika. Dodatkowo:\r\n1. Jeśli twoje
                        // hasło zawiera znaki specjalne, zmień je (usuń) i spróbuj ponownie!\r\n2. Wprowadź hasło i nazwę użytkownika
                        // ręcznie bez użycia opcji Kopiuj i Wklej.", PluginException.VALUE_ID_PREMIUM_DISABLE);
                        // } else {
                        // throw new PluginException(LinkStatus.ERROR_PREMIUM, "\r\nInvalid username/password or login captcha!\r\nYou're
                        // sure that the username and password you entered are correct? Some hints:\r\n1. If your password contains special
                        // characters, change it (remove them) and try again!\r\n2. Type in your username/password by hand without copy &
                        // paste.", PluginException.VALUE_ID_PREMIUM_DISABLE);
                        // }
                    }
                }

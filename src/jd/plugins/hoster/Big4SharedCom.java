...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "big4shared.com" }, urls = { "https?://(?:www\\.)?(?:big4shared\\.com|b4sh\\.me)/((?:embed\\-)?[a-z0-9]{12}|d/[A-Z0-9a-z]{1,11})" })
public class Big4SharedCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "https://www.big4shared.com";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(big4shared\\.com|b4sh\\.me)";
    ...
    private static AtomicInteger totalMaxSimultanFreeDownload       = new AtomicInteger(8);
     ...
     * captchatype: 2017-07-28: reCaptchaV2<br />
     * other:<br />
     */
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (SUPPORTS_HTML_FILESIZE_CHECK) {
            if (inValidate(fileInfo[1])) {
                /* 2017-07-28: Special */
                fileInfo[1] = new Regex(correctedBR, "class=\"statd\"></span>\\s*?<span><b>([^<>\"]+)</b>").getMatch(0);
            }
            if (inValidate(fileInfo[1])) {
    ...
    private void checkErrors(final DownloadLink theLink, final boolean checkAll) throws NumberFormatException, PluginException {
        ...
        if (new Regex(correctedBR, "( can download files up to |Upgrade your account to download bigger files|>Upgrade your account to download (?:larger|bigger) files|>The file you requested reached max downloads limit for Free Users|>This file reached max downloads limit|Please Buy Premium To download this file<|This file reached max downloads limit|>This file is available for Premium Users only)").matches()) {

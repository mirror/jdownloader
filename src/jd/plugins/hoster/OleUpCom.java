...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "oleup.com" }, urls = { "https?://(www\\.)?oleup\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class OleUpCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://oleup.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(oleup\\.com)";
    ...
    // mods:
    // limit-info: untested due to timeouts
    // protocol: no https
    ...
    public OleUpCom(PluginWrapper wrapper) {
        super(wrapper);

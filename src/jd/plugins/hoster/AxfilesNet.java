...
@HostPlugin(revision = "$Revision: 34706 $", interfaceVersion = 2, names = { "axfiles.net" }, urls = { "https?://(www\\.)?axfiles\\.net/(embed\\-)?[a-z0-9]{12}" })

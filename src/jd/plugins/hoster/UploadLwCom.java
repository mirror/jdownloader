...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadlw.com" }, urls = { "http://(www\\.)?uploadlw\\.com/(?!faq|register|login|terms|report_file)[a-z0-9]+" }, flags = { 0 })
public class UploadLwCom extends PluginForHost {
    ...
    private final String        MAINPAGE                 = "http://uploadlw.com";

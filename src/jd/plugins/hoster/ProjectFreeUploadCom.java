...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "project-free-upload.com" }, urls = { "https?://(www\\.)?project-free-upload\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
...
public class ProjectFreeUploadCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (cbr.containsHTML("(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<li>The file (expired|deleted by (its owner|administration))|<h3>404 file not found or has been deleted</h3>)")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        final String space[] = cbr.getRegex(">Used space:</td>.*?<td.*?b>([0-9\\.]+) of [0-9\\.]+ (KB|MB|GB|TB)<").getRow(0);

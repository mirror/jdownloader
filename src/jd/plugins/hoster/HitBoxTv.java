...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "hitbox.tv" }, urls = { "http://(www\\.)?hitbox\\.tv/video/\\d+" }, flags = { 0 })
public class HitBoxTv extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        br.getPage("http://www.hitbox.tv/api/media/video/" + new Regex(downloadLink.getDownloadURL(), "(\\d+)$").getMatch(0) + "?autoPlay=true&showHidden=tru");

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "ihostia.com" }, urls = { "https?://(www\\.)?ihostia\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class IHostiaCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://ihostia.com";
    ...
    public IHostiaCom(PluginWrapper wrapper) {
        super(wrapper);

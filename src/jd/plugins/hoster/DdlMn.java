...
@HostPlugin(revision = "$Revision: 17148 $", interfaceVersion = 2, names = { "ddl.mn" }, urls = { "https?://(www\\.)?ddl\\.mn/[a-z0-9]{12}" }, flags = { 0 })
public class DdlMn extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://ddl.mn";
    ...
    // mods:
    // non account: 1 * unlimited? (has very long wait times)
    // free account:
    // premium account:
    // protocol: no https
    // captchatype: 4dignum
    ...
    public DdlMn(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void checkErrors(DownloadLink theLink, boolean checkAll, String passCode) throws NumberFormatException, PluginException {
        ...
        // past tense activity statement, no specific wait time frame given
        if (new Regex(correctedBR, "You have reached the download\\-limit: \\d+ Mb for last \\d+ days<)").matches()) {

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filebigz.com" }, urls = { "https?://(www\\.)?filebigz\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FileBigzCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://filebigz.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(filebigz\\.com)";
    ...
    public FileBigzCom(PluginWrapper wrapper) {
        super(wrapper);

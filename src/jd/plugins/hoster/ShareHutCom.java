...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "sharehut.com" }, urls = { "http://(www\\.)?sharehut\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ShareHutCom extends PluginForHost {

    public ShareHutCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST  = "http://sharehut.com";
    ...
    public int getMaxSimultanFreeDownloadNum() {
        // Max 2 chunks per download, max 2 simultan downloads
        return 2;
    }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "file-speed.com" }, urls = { "https?://(www\\.)?file\\-speed\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileSpeedCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://file-speed.com";
    ...
    public FileSpeedCom(PluginWrapper wrapper) {
        super(wrapper);

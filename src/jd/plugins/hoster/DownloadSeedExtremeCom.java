...
@HostPlugin(revision = "$Revision: 31032 $", interfaceVersion = 2, names = { "download.seedextreme.com" }, urls = { "" }, flags = { 0 })
public class DownloadSeedExtremeCom extends PluginForHost {

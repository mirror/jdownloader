...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "nukeshare.com" }, urls = { "http://(www\\.)?nukeshare\\.com/[a-z0-9]{12}" }, flags = { PluginWrapper.DEBUG_ONLY })
public class NukeShareCom extends PluginForHost {

    public NukeShareCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST   = "http://nukeshare.com";

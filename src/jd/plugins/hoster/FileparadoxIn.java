...
public class FileparadoxIn extends PluginForHost {
     ...
     * */
    public FileparadoxIn(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (cbr.containsHTML("(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<li>The file (expired|deleted by (its owner|administration))|>\\s*This file has been blocked due to DMCA Notice\\.)")) {
    ...
    private void doFree(final DownloadLink downloadLink, final Account account) throws Exception, PluginException {
        ...
        if (cbr.containsHTML("This file has been blocked")) {
            throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
        }
        if (inValidate(dllink)) {
    ...
    private void checkErrors(final DownloadLink theLink, final Account account, final boolean checkAll) throws NumberFormatException, PluginException {
        ...
        // monitor this
        // <div align="center">
        // You have reached the download-limit of 2049 Mb for last 1 days
        // </div>
        if (cbr.containsHTML("((?:class=\"err\"|div[^>]*)>\\s*You have reached the download(-| )limit[^<]+for last[^<]+)")) {
            /*
    ...
    private Form captchaForm(DownloadLink downloadLink, Form form) throws Exception {
        ...
        if (form.containsHTML(";background:#ccc;text-align")) {
            ...
            if (captchalink == null || skey == null || key == null || videoCaptchaToken == null) {
                throw new PluginException(LinkStatus.ERROR_PLUGIN_DEFECT);
            }

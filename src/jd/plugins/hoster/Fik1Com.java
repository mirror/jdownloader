...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "fik1.com" }, urls = { "http://(www\\.)?fik1\\.com/[a-z0-9]{12}" }, flags = { PluginWrapper.DEBUG_ONLY })
public class Fik1Com extends PluginForHost {
    ...
    // XfileSharingProBasic Version 2.1.1.3
    @Override

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "uploadshub.com" }, urls = { "https?://(www\\.)?uploadshub\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class UploadshubCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://uploadshub.com";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(uploadshub\\.com)";
    ...
    public UploadshubCom(PluginWrapper wrapper) {
        super(wrapper);

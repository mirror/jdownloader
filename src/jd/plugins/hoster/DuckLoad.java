...
public class DuckLoad extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://www.duckload.com/legal/agb";
    }
    ...
    public void handleFree(final DownloadLink downloadLink) throws Exception, PluginException {
        ...
        this.trim(values);
        if (values.length != 3 || !"SUCCESS".equals(values[0])) {
            if ("ERROR".equals(values[0])) throw new PluginException(LinkStatus.ERROR_TEMPORARILY_UNAVAILABLE, "ServerError");
            throw new PluginException(LinkStatus.ERROR_PLUGIN_DEFECT, values[0]);
        }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "imgdiamond.com" }, urls = { "https?://(?:www\\.)?imgdiamond\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ImgdiamondCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://imgdiamond.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(imgdiamond\\.com)";
    ...
    public ImgdiamondCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "sfiles.org" }, urls = { "https?://(?:www\\.)?(?:suprafiles\\.(?:net|co|org|me)|sfiles\\.org|srfiles\\.com)/(?:embed\\-)?[a-z0-9]{12}" })
public class SuprafilesOrg extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://srfiles.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(suprafiles\\.(?:net|co|org|me)|sfiles\\.com|srfiles\\.com)";
    ...
    private final String         rc2SiteKey                         = "6Ld9KXQUAAAAAEP4yjXDzWbjb6BuCQZgOSkXyZtb";                                                                                                                                                                                            // auto
     ...
     ****************************
     * mods:<br />
     * limit-info: 2018-03-06: No limits at all<br />
    ...
    public SuprafilesOrg(PluginWrapper wrapper) {
        super(wrapper);

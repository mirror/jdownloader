...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "yourlisten.com" }, urls = { "http://(www\\.)?yourlisten\\.com/[A-Za-z0-9\\-]+/[A-Za-z0-9]+" }, flags = { 0 })
public class YourlistenCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://yourlisten.com/pages/terms";
    }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "happystreams.net" }, urls = { "https?://(www\\.)?happystreams\\.net/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class HappyStreamsNet extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://happystreams.net";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(happystreams\\.net)";
    ...
    // mods: scanInfo[Removed filesize RegExes, size not given]
    // limit-info:
    // protocol: no https
    ...
    public HappyStreamsNet(PluginWrapper wrapper) {
        super(wrapper);

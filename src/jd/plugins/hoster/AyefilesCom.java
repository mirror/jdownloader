...
public class AyefilesCom extends antiDDoSForHost {
    /* 1st domain = current domain! */
    public static String[] domains = new String[] { "ayefiles.com" };
    ...
    public AyefilesCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        if (!DebugMode.TRUE_IN_IDE_ELSE_FALSE) {
            // remove me once captcha issue is fixed
            throw new PluginException(LinkStatus.ERROR_PLUGIN_DEFECT);
        }

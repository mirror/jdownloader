...
public class ImgmazeCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://imgmaze.com";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(imgmaze\\.com)";
     ...
     * mods: doFree[Special 'next'-Form handling]<br />
     * limit-info:<br />
    ...
    public ImgmazeCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public static Form fixImghost_next_form(final Browser br, Form imghost_next_form) {
        ...
        /* 2017-07-25 */
        String special_key = br.getRegex("(attr\\(\\'class\\', \\'[a-z](?:[a-f0-9]{32})\\'\\)){1}.*?\\'class\\', \\'[a-z]([a-f0-9]{32})\\'").getMatch(1);
        if (special_key == null) {
            /* 2017-07-24 */
            special_key = br.getRegex("(\\.[a-z][a-f0-9]{32}\\{visibility:(?:hidden|initial);\\}){5}\\.[a-z]([a-z0-9]+)\\{visibility:initial;\\}").getMatch(1);
        }
        if (special_key == null) {
            /* 2017-02-10 */

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "sharerun.com" }, urls = { "http://(www\\.)?sharerun\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ShareRunCom extends PluginForHost {

    private String              BRBEFORE            = "";

    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST         = "http://sharerun.com";

    private static final String MAINTENANCE         = ">This server is in maintenance mode";

    private static final String MAINTENANCEUSERTEXT = "This server is under Maintenance";

    public ShareRunCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    // XfileSharingProBasic Version 2.5.0.7, added 1 filename regex and longer
    // timeout
    @Override
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                ...
                if (dllink == null) {
                    ...
                    if (dllink == null) {
                        dllink = new Regex(BRBEFORE, "addVariable\\(\\'file\\',\\'(http://.*?)\\'\\)").getMatch(0);
                        if (dllink == null) {

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filetube.to" }, urls = { "http://[\\w\\.]*?filetube\\.to/\\?d=[A-Z0-9]+" }, flags = { 0 })
public class FileTubeTo extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://filetube.to/rules.php";
    }
    ...
    public AvailableStatus requestFileInformation(DownloadLink parameter) throws Exception {
        ...
        br.setCookie("http://filetube.to", "yab_mylang", "en");
    ...
    public void handleFree(DownloadLink link) throws Exception {
        ...
        if (dllink == null) {
            for (int i = 0; i <= 3; i++) {
                ...
                String captchaurl = "http://filetube.to/captcha.php";
            ...
            sitelinks = HTMLParser.getHttpLinks(br.toString(), null);
            dllink = null;
            if (sitelinks == null || sitelinks.length == 0) throw new PluginException(LinkStatus.ERROR_PLUGIN_DEFECT);
            for (String alink : sitelinks) {
                alink = Encoding.htmlDecode(alink);

...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "dumpfiles.org" }, urls = { "https?://(www\\.)?dumpfiles\\.org/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class DumpFilesOrg extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://dumpfiles.org";
    // domain names used within download links.
    private final String               DOMAINS                      = "(dumpfiles\\.org)";
     ...
     * */
    public DumpFilesOrg(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

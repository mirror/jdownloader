...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "monkifiles.com" }, urls = { "https?://(?:www\\.)?monkifiles\\.com/[A-Za-z0-9]+" })
public class MonkifilesCom extends antiDDoSForHost {
    public MonkifilesCom(PluginWrapper wrapper) {
        super(wrapper);

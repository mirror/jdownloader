...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "megatv.com" }, urls = { "http://(www\\.)?megatv\\.com/[a-z0-9]+\\.asp\\?catid=\\d+\\&subid=\\d+\\&pubid=\\d+" }, flags = { 0 })
public class MegatvCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (!br.containsHTML("id=\"agriyaplayer\"") || br.getHttpConnection().getResponseCode() == 404) {

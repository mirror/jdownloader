...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "lomafile.com" }, urls = { "https?://(www\\.)?lomafile\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
@SuppressWarnings("deprecation")
public class LomaFileCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://lomafile.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(lomafile\\.com)";
    ...
    // DEV NOTES
    // XfileShare Version 3.0.8.4-mod
     ...
     * */
    public LomaFileCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

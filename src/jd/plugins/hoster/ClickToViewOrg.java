...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "clicktoview.org" }, urls = { "https?://(www\\.)?clicktoview\\.org/[a-z0-9]{12}" }, flags = { 0 })
public class ClickToViewOrg extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://clicktoview.org";
    private static final String MAINTENANCE         = ">This server is in maintenance mode|>Website is down for general maintenance";
    ...
    public ClickToViewOrg(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (filename == null) {
            ...
            if (filename == null) {
                filename = new Regex(correctedBR, "<h2>Stream File(.*?)</h2>").getMatch(0);
            }
        }

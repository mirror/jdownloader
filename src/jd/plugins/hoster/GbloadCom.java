...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "gbload.com" }, urls = { "https?://(?:www\\.)?gbload\\.com/[A-Za-z0-9]+" })
public class GbloadCom extends PluginForHost {

    public GbloadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://gbload.com";
    private final String                   domains                                      = "(gbload\\.com)";

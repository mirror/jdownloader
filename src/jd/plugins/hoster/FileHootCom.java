...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filehoot.com" }, urls = { "https?://(www\\.)?filehoot\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FileHootCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://filehoot.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(filehoot\\.com)";
    ...
    // protocol: no https
    // captchatype: null
    // other: dllinks are crypted - VIDEOHOSTER-way is at the moment the only way around
    ...
    public FileHootCom(PluginWrapper wrapper) {
        super(wrapper);

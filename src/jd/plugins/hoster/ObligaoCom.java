...
@HostPlugin(revision = "$Revision: 17860 $", interfaceVersion = 2, names = { "obligao.com" }, urls = { "https?://(www\\.)?obligao\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ObligaoCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://obligao.com";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "obligao.com" }, urls = { "https?://(?:www\\.)?obligao\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class ObligaoCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://obligao.com";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(obligao\\.com)";
    ...
    @SuppressWarnings("deprecation")
    public ObligaoCom(PluginWrapper wrapper) {
        super(wrapper);

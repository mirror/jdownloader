...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "usefile.com" }, urls = { "https?://(www\\.)?usefile\\.com/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 2 })
@SuppressWarnings("deprecation")
public class UseFileCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://usefile.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(usefile\\.com)";
     ...
     * */
    public UseFileCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

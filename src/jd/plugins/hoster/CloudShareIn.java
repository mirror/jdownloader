...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "cloud-share.in" }, urls = { "https?://(www\\.)?cloud\\-share\\.in/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class CloudShareIn extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://cloud-share.in";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(cloud-\\share\\.in)";
    ...
    // mods: waitTime[Added an additional RegEx]
    // limit-info:
    // protocol: no https
    // captchatype: 4dignum
    // other:
    ...
    public CloudShareIn(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String getDllink() {
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                dllink = new Regex(correctedBR, "\"(https?://[a-z0-9]+\\.cloud\\-share\\.in/cgi\\-bin/dl\\.cgi/[^<>\"]*?)\"").getMatch(0);
            }
            if (dllink == null) {

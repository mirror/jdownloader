...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "farmupload.com" }, urls = { "https?://(www\\.)?farmupload\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FarmUploadcom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private static final String        COOKIE_HOST                  = "http://farmupload.com";
    // domain names used within download links.
    private static final String        DOMAINS                      = "(farmupload\\.com)";
     ...
     * */
    public FarmUploadcom(PluginWrapper wrapper) {
        super(wrapper);

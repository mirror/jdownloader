...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadinc.com" }, urls = { "https?://(www\\.)?uploadinc\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class UploadIncCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://uploadinc.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(uploadinc\\.com)";
    ...
    public UploadIncCom(PluginWrapper wrapper) {
        super(wrapper);

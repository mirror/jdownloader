...
public class CosmoBoxOrg extends PluginForHost {
    ...
    // mods:doFree [solvemedia captcha errorhandling]
    // limit-info:
    // protocol: no https
            ...
            for (int i = 0; i <= repeat; i++) {
                ...
                if (correctedBR.contains(";background:#ccc;text-align")) {
                    ...
                    try {
                        ...
                        if (jd.plugins.decrypter.LnkCrptWs.SolveMedia.FAIL_CAUSE_CKEY_MISSING.equals(e.getMessage())) throw new PluginException(LinkStatus.ERROR_FATAL, "Solvemedia.com flash captchas are not yet supported, sorry!" + this.getHost() + " support");
                        throw e;
                    }

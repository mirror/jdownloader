...
public class CosmoBoxOrg extends PluginForHost {
                ...
                if (correctedBR.contains(";background:#ccc;text-align")) {
                    ...
                    try {
                        ...
                        if (jd.plugins.decrypter.LnkCrptWs.SolveMedia.FAIL_CAUSE_CKEY_MISSING.equals(e.getMessage())) {
                            throw new PluginException(LinkStatus.ERROR_FATAL, "Solvemedia.com flash captchas are not yet supported, sorry!" + this.getHost() + " support");
                        }
                        throw e;
                    }
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        /** Ticket Time */
        // <span id="countdown_str"><div class="counter_bk">Wait<br /><span id="7yflpy" class="count">62</span><br />Seconds ...

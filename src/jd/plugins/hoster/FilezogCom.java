...
public class FilezogCom extends PluginForHost {
    ...
    // YetiShareBasic Version 0.5.4-psp
    // mods:
    // limit-info: all untested, server always returns 404 on finallink
    // protocol: no https
    // captchatype: null
    // other:
    @Override
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://filezog.com";
    private final String         domains                                      = "(filezog\\.com)";

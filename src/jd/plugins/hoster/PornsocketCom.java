...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "pornsocket.com" }, urls = { "https?://(?:www\\.)?pornsocket\\.com/media\\-gallery/(\\d+)\\-([a-z0-9\\-]+)\\.html" })
public class PornsocketCom extends antiDDoSForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        String filename = url_filename.replace("-", " ");

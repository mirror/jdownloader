...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "mojoload.com" }, urls = { "https?://(www\\.)?mojoload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class MojoLoadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://mojoload.com";
    ...
    public MojoLoadCom(PluginWrapper wrapper) {
        super(wrapper);

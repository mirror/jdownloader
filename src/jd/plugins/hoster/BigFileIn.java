...
public class BigFileIn extends PluginForHost {

    public BigFileIn(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(COOKIE_HOST + "/premium.html");
    }

    // XfileSharingProBasic Version 1.6, brbefore handling
    @Override
    ...
    private static final String COOKIE_HOST = "http://bigfile.in";

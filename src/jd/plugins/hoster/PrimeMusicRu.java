...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "primemusic.ru" }, urls = { "http://(www\\.)?primemusic\\.ru/Media\\-page\\-\\d+\\.html" }, flags = { 0 })
public class PrimeMusicRu extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (br.containsHTML("<h1 class=\"radio_title\">Композиция не найдена</h1>")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

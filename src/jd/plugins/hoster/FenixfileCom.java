...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "fenixfile.com" }, urls = { "https?://(?:www\\.)?fenixfile\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class FenixfileCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://fenixfile.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(fenixfile\\.com)";
     ...
     * mods:<br />
     * limit-info: 2016-12-12: Premium untested, set FREE account limits<br />
    ...
    @SuppressWarnings("deprecation")
    public FenixfileCom(PluginWrapper wrapper) {
        super(wrapper);

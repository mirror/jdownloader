...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filemov.net" }, urls = { "http://(www\\.)?filemov\\.net/download\\.php\\?id=[A-Z0-9]+" }, flags = { 0 })
public class FileMovNet extends PluginForHost {

    public FileMovNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST     = "http://filemov.net";

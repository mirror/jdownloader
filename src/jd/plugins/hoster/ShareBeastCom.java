...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "sharebeast.com" }, urls = { "http://(www\\.)?sharebeast\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ShareBeastCom extends PluginForHost {
    ...
    // XfileSharingProBasic Version 2.0.1.0, added one filename regex
    @Override
    ...
    private static final String COOKIE_HOST   = "http://sharebeast.com";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "limevideo.net" }, urls = { "https?://(www\\.)?limevideo\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class LimeVideoNet extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://limevideo.net";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(limevideo\\.net)";
    ...
    public LimeVideoNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|>Watch Video<)").matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

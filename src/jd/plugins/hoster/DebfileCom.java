...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "debfile.com" }, urls = { "https?://(?:www\\.)?debfile\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class DebfileCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://debfile.com";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(debfile\\.com)";
    ...
    public DebfileCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 16216 $", interfaceVersion = 2, names = { "flashstream.in", "xvidstream.net", "xvidstage.com" }, urls = { "https?://(www\\.)?flashstream\\.in/[a-z0-9]{12}", "https?://(www\\.)?xvidstream\\.net/[a-z0-9]{12}", "https?://(www\\.)?xvidstage\\.com/[a-z0-9]{12}" }, flags = { 0, 0, 0 })
public class FlashStreamIn extends PluginForHost {
    ...
    // captchatype: 4dignum
    // other: no redirects
    // other: sister sites links are not transferable.

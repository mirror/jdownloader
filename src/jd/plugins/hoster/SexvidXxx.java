...
public class SexvidXxx extends KernelVideoSharingComV2 {
    ...
    public static String[] getAnnotationUrls() {
        ...
        for (final String[] domains : getPluginDomains()) {
            /**
             * 2020-11-03: E.g. de.sexvid.xxx - this more or less resembles
             * {@link #KernelVideoSharingComV2.buildAnnotationUrlsDefaultVideosPatternWithoutFileIDWithHTMLEnding}
             */

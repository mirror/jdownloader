...
public class MySpassDe extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        br.getPage("http://www.myspass.de/myspass/includes/apps/video/getvideometadataxml.php?id=" + new Regex(downloadLink.getDownloadURL(), "(\\d+)$").getMatch(0) + "&0." + System.currentTimeMillis());
        if (br.containsHTML("<url_flv><\\!\\[CDATA\\[\\]\\]></url_flv>")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "sube.me" }, urls = { "https?://(www\\.)?sube\\.me/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class SubeMe extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private static final String        COOKIE_HOST                  = "http://sube.me";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<title> \\(0\\.00 KB\\) - sube\\.me</title>)").matches()) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

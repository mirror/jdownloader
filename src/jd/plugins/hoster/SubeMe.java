...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "sube.me" }, urls = { "https?://(www\\.)?sube\\.me/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
@SuppressWarnings("deprecation")
public class SubeMe extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://sube.me";
    // domain names used within download links.
    private final String               DOMAINS                      = "(sube\\.me)";
    ...
    // other: no redirects
    // mods: added additional fnf text
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (cbr.containsHTML("(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<li>The file (expired|deleted by (its owner|administration))|<title> \\(0\\.00 KB\\) \\- sube\\.me</title>)")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

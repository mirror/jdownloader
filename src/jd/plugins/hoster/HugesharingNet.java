...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "hugesharing.net" }, urls = { "https?://(?:www\\.)?hugesharing\\.net/[A-Za-z0-9]+" })
public class HugesharingNet extends PluginForHost {

    public HugesharingNet(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * YetiShareBasic Version 0.7.9-psp<br />
     * mods:<br />
     * limit-info:<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://hugesharing.net";
    private final String                   domains                                      = "(hugesharing\\.net)";

...
public class FileOmCom extends PluginForHost {
    ...
    private final String               DOMAINS                      = "(fileom\\.com)";
    ...
    private void checkErrors(final DownloadLink theLink, final Account account, final boolean checkAll) throws NumberFormatException, PluginException {
        ...
        final String fa2 = "(Upgrade to premium account to download this file)";
        ...
        // let the fun begin!
        if (cbr.containsHTML(an + "|" + fa + "|" + fa2 + "|" + pr)) {
            String msg = null;
            ...
            if (account != null) {
                ...
                if (account.getBooleanProperty("free", false) && cbr.containsHTML(an + "|" + fa + "|" + fa2 + "|" + pr)) {
                    // free

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "putme.org" }, urls = { "https?://(www\\.)?putme\\.org/[a-z0-9]{12}" }, flags = { 0 })
public class PutMeOrg extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://putme.org";
    ...
    public PutMeOrg(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        link.setFinalFileName(fileInfo[0].trim().replace(" ", "."));

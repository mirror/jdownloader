...
public class MaisUolComBr extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws IOException, PluginException {
        ...
        br.getPage("http://mais.uol.com.br/apiuol/player/media.js?mediaId=" + mediaID + "&types=V&action=showPlayer&p=undefined");
        String filename = br.getRegex("\"title\": \"([^<>\"]*?)\"").getMatch(0);
        DLLINK = br.getRegex("\"formats\": \\[\\{\"id\":2,\"url\":\"(http://[^<>\"]*?)\"").getMatch(0);

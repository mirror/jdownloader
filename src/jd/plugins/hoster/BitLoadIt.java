...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "bitload.it" }, urls = { "https?://(www\\.)?bitload\\.it/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class BitLoadIt extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://bitload.it";
    ...
    public BitLoadIt(PluginWrapper wrapper) {
        super(wrapper);

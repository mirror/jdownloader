...
public class HotXvideosXxx extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://www.hotxvideos.xxx/2257.html";
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        String filename = br.getRegex("<title>([^<>\"]*?)\\- Hot XxX sex videos \\- Free xvideos \\& HD Porn Movies</title>").getMatch(0);
        if (filename == null) filename = br.getRegex("<h1>([^<>\"]*?)</h1>").getMatch(0);
        DLLINK = br.getRegex("\"low\":\"(http://[^<>\"]*?)\"").getMatch(0);
        if (DLLINK == null) DLLINK = br.getRegex("\"(http://[a-z0-9\\-\\.]+hostedtube\\.com/[^<>\"]*?)\"").getMatch(0);

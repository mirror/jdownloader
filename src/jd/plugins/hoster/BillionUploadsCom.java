...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "billionuploads.com" }, urls = { "https?://(www\\.)?billionuploads\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class BillionUploadsCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://billionuploads.com";
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) filesize = new Regex(correctedBR, "<b>Size:</b></td><td>([^<>\"]*?)\\&nbsp; <small>").getMatch(0);
        }

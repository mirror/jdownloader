...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vidzi.net" }, urls = { "https?://(www\\.)?vidzi\\.net/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class VidziNet extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://vidzi.net";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(vidzi\\.net)";
    /* Linktypes */
    ...
    @SuppressWarnings("deprecation")
    public VidziNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "\">Watch ([^<>\"]*?)<").getMatch(0);
        }
        /* Filesize is never given on mainpage */
        // if (fileInfo[1] == null) {

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "dedifile.com" }, urls = { "https?://(?:www\\.)?dedifile\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class DedifileCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://dedifile.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(dedifile\\.com)";
    ...
    public DedifileCom(PluginWrapper wrapper) {
        super(wrapper);

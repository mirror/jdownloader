...
public class DropuploadCom extends YetiShareCore {
    public DropuploadCom(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * captchatype-info: 2019-10-30: reCaptchaV2<br />
     * other: <br />
     */
    public static List<String[]> getPluginDomains() {
        final List<String[]> ret = new ArrayList<String[]>();
        // each entry in List<String[]> will result in one PluginForHost, Plugin.getHost() will return String[0]->main domain
        ret.add(new String[] { "dropupload.com" });
        return ret;
    }

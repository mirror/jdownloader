...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "sharingmaster.com" }, urls = { "https?://(www\\.)?sharingmaster\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class SharingMasterCom extends PluginForHost {
    ...
    // mods:changed filename regexes and getdllink
    // non account: 1 * 1, simultan dls untested, no examplelinks

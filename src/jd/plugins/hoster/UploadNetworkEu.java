...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadnetwork.eu" }, urls = { "https?://(www\\.)?uploadnetwork\\.eu/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class UploadNetworkEu extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://uploadnetwork.eu";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(uploadnetwork\\.eu)";
    ...
    // mods: added custom filename regex
    // non account: 2 * 1
    ...
    public UploadNetworkEu(PluginWrapper wrapper) {
        super(wrapper);

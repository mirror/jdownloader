...
@HostPlugin(revision = "$Revision: 17860 $", interfaceVersion = 2, names = { "sfshare.se" }, urls = { "https?://(www\\.)?sfshare\\.se/[a-z0-9]{12}" }, flags = { 0 })
public class SfShareSe extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://sfshare.se";
    ...
    public SfShareSe(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, ">Filename:</b></td><td class=\"fname\">([^<>\"]*?)</td>").getMatch(0);
            if (fileInfo[0] == null) {

...
public class PimpRollHostedTube extends PluginForHost {
    ...
    public static String constructUrl(final String host) {
        ...
        return "http://(?:(?:www|m)\\.)?" + Pattern.quote(host) + "/(?![^/]*(?:models|stars|categories|channels|tags|aactors)[^/]*)[\\w\\-]+/\\d+";
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (filename == null || dllink == null) {
            ...
            if (br.containsHTML("<h3>Access Denied</h3>|>Free Video Limit Reached")) {

...
public class PimpRollHostedTube extends PluginForHost {
    ...
    public static String[] getAnnotationUrls() {
        ...
        for (int ssize = 0; ssize != t.length; ssize++) {
            s[ssize] = "http://(?:(?:www|m)\\.)?" + t[ssize] + "/(?![^/]*(?:models|stars|categories|channels|tags)[^/]*)[\\w\\-]+/\\d+";
        }
        return s;
    }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "brutalsha.re" }, urls = { "https?://(www\\.)?brutalsha\\.re/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class BrutalShaRe extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://brutalsha.re";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(brutalsha\\.re)";
    ...
    // non account: 2 * 1
    // free account: 2 * 1
    // premium account: untested, set standard
    // protocol: no https
    ...
    public BrutalShaRe(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        final String filename = br.getRegex("<tr><td align=right><b>[^<>\"/]+:</b></td><td nowrap>([^<>\"]*?)</td></tr>").getMatch(0);

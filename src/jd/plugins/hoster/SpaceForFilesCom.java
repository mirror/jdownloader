...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "spaceforfiles.com" }, urls = { "https?://(www\\.)?(spaceforfiles|filespace)\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class SpaceForFilesCom extends PluginForHost {
    ...
    public String[] siteSupportedNames() {
        return new String[] { "spaceforfiles.com", "filespace.com" };
    }
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        if (ttt == null) {
            ttt = new Regex(correctedBR, "Please wait <span id=\"[a-z0-9]+\">(\\d+)</span>").getMatch(0);
        }
        if (ttt != null) {

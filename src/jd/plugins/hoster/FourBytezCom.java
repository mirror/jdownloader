...
@HostPlugin(revision = "$Revision: 16002 $", interfaceVersion = 2, names = { "4bytez.com" }, urls = { "https?://(www\\.)?4bytez\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FourBytezCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://4bytez.com";
    ...
    public FourBytezCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "upbrasil.info" }, urls = { "http://(www\\.)?upbrasil\\.info/[a-z0-9]{12}" }, flags = { 0 })
public class UpBrasilInfo extends PluginForHost {

...
public class DivxPressCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://divxpress.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(divxpress\\.com)";
    ...
    public DivxPressCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "\\'RokkittRegular\\';font\\-size:26px;font\\-weight:bold;color: #5e5e5e;\">([^<>\"]*?)</div>").getMatch(0);
        }
        if (fileInfo[1] == null) {

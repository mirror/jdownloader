...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "veodrop.com" }, urls = { "https?://(www\\.)?veodrop\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class VeodropCom extends PluginForHost {
    ...
    // mods:
    // limit-info: testing impossible as all finallinks lead to 404 --> Set default limits

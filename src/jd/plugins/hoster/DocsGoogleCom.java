...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "docs.google.com" }, urls = { "https?://(www\\.)?docs.google.com/(leaf\\?|uc\\?export=download.*?&)id=[A-Za-z0-9\\-_]+(&.*?&pid=[A-Za-z0-9\\-_]++)?" }, flags = { 0 })

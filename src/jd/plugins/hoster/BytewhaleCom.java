...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "bytewhale.com" }, urls = { "https?://(www\\.)?bytewhale\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class BytewhaleCom extends PluginForHost {
    ...
    // mods: scanInfo[Added other filename RegEx], waitTime[Added other wait RegEx]
    // limit-info:
    // protocol: no https
    // captchatype: null
    // other:

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "erafile.com" }, urls = { "https?://(?:www\\.)?erafile\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class ErafileCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://erafile.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(erafile\\.com)";
     ...
     * captchatype: null<br />
     * other: Old domains (or their names before they were erafile.com): hzfile.asia, hzfile.com<br />
     */
    ...
    public ErafileCom(PluginWrapper wrapper) {
        super(wrapper);

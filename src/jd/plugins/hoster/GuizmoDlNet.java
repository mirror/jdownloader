...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "guizmodl.com" }, urls = { "https?://(www\\.)?guizmodl\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class GuizmoDlNet extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private static final String        COOKIE_HOST                  = "http://guizmodl.net";
    // domain names used within download links.
    private static final String        DOMAINS                      = "(guizmodl\\.net)";

...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "guizmodl.net" }, urls = { "https?://(www\\.)?guizmodl\\.net/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class GuizmoDlNet extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://guizmodl.net";
    // domain names used within download links.
    private final String               DOMAINS                      = "(guizmodl\\.net)";

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "usersfiles.com" }, urls = { "https?://(www\\.)?usersfiles\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class UsersFilesCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://usersfiles.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(usersfiles\\.com)";
    ...
    public UsersFilesCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "class=\"glyphicons (file|music)\">([\t\n\r ]+)?<i></i>([^<>\"]*?) <").getMatch(2);
        }
        if (fileInfo[1] == null) {

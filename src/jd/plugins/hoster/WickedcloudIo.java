...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "wickedcloud.io" }, urls = { "https?://(?:www\\.)?wickedcloud\\.io/[A-Za-z0-9]+" })
public class WickedcloudIo extends PluginForHost {

    public WickedcloudIo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://wickedcloud.io";
    private final String                   domains                                      = "(wickedcloud\\.io)";

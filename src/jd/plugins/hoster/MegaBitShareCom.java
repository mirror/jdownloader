...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "megabitshare.com" }, urls = { "https?://(www\\.)?megabitshare\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class MegaBitShareCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://megabitshare.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(megabitshare\\.com)";
    ...
    public MegaBitShareCom(PluginWrapper wrapper) {
        super(wrapper);

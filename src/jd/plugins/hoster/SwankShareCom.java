...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "swankshare.com" }, urls = { "https?://(www\\.)?swankshare\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class SwankShareCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://swankshare.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(swankshare\\.com)";
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "width=\"607\" valign=\"top\"><font size=\"3\"><b>([^<>\"]*?)</b>").getMatch(0);
        }
        if (fileInfo[1] == null) {

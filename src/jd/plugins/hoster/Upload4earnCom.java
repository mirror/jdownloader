...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "upload4earn.com" }, urls = { "https?://(?:www\\.)?upload4earn\\.(com|net)/(?:embed\\-)?[a-z0-9]{12}" })
public class Upload4earnCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://upload4earn.net".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:upload4earn\\.(?:com|net))";

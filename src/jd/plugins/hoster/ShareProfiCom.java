...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "shareprofi.com" }, urls = { "https?://(www\\.)?shareprofi\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class ShareProfiCom extends PluginForHost {
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        final String availabletraffic = cbr.getRegex("Traffic available:</span>[\r\n\t ]+<span[^>]+>([^<>\"']+)").getMatch(0);

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "tubepornclassic.com" }, urls = { "http://(www\\.)?tubepornclassic\\.com/videos/\\d+/[a-z0-9\\-]+/" }, flags = { 0 })
public class TubepornclassicCom extends PluginForHost {

    public TubepornclassicCom(PluginWrapper wrapper) {
        super(wrapper);
    }

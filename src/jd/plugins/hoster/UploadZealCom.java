...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadzeal.com" }, urls = { "https?://(www\\.)?uploadzeal\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class UploadZealCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://uploadzeal.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(uploadzeal\\.com)";
    ...
    public UploadZealCom(PluginWrapper wrapper) {
        super(wrapper);

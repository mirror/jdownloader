...
@HostPlugin(revision = "$Revision: 15041 $", interfaceVersion = 2, names = { "filebeep.com" }, urls = { "http://(www\\.)?filebeep\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileBeepCom extends PluginForHost {

    private String              BRBEFORE            = "";

    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST         = "http://filebeep.com";
    ...
    public FileBeepCom(PluginWrapper wrapper) {
        super(wrapper);

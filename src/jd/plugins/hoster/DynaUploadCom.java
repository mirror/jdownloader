...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "dynaupload.com" }, urls = { "https?://(www\\.)?dynaupload\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class DynaUploadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private static final String  COOKIE_HOST                  = "http://dynaupload.com";
    ...
    public DynaUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, ">Download:</font>([^<>\"]*?)<div").getMatch(0);
        }
        if (fileInfo[1] == null) {

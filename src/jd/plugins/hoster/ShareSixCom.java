...
public class ShareSixCom extends PluginForHost {
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "<div class=\"d_div_block d_div_right\">[\t\n\r ]+<p>([^<>\"]*?)</p>").getMatch(0);
        }
        if (fileInfo[1] == null) {
    ...
    public void checkServerErrors() throws NumberFormatException, PluginException {
        ...
        if (correctedBR.contains("Wrong IP")) throw new PluginException(LinkStatus.ERROR_TEMPORARILY_UNAVAILABLE, "Server error", 30 * 60 * 1000l);
    }

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "pic-maniac.com" }, urls = { "https?://(?:www\\.)?pic\\-maniac\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class PicManiacCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://pic-maniac.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(pic\\-maniac\\.com)";
    ...
    public PicManiacCom(PluginWrapper wrapper) {
        super(wrapper);

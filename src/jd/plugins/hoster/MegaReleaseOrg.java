...
@HostPlugin(revision = "$Revision: 19496 $", interfaceVersion = 2, names = { "megarelease.org" }, urls = { "https?://(www\\.)?megarelease\\.org/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class MegaReleaseOrg extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://megarelease.org";
    // domain names used within download links.
    private final String               DOMAINS                      = "(megarelease\\.org)";
    ...
    // captchatype: recaptcha on main page, solve media on altvidembed
    // other: no redirects
    // mods:
     ...
     * */
    public MegaReleaseOrg(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();

...
@HostPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "uploadkadeh.com" }, urls = { "https?://(?:www\\.)?uploadkadeh\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class UploadkadehCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://uploadkadeh.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:uploadkadeh\\.com)";
     ...
     ****************************
     * mods: getFilesizeViaAvailablecheckAlt[Slightly different URL]<br />
     * limit-info: 2018-02-09: Set default limits as check was impossible because fileservers were down<br />
    ...
    public UploadkadehCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String getFilesizeViaAvailablecheckAlt(final Browser br, final DownloadLink dl) {
        ...
        try {
            if (SUPPORTS_AVAILABLECHECK_ALT_FAST) {
                /* 2018-09-02: Special: 'checkfiles' --> 'check_files' */

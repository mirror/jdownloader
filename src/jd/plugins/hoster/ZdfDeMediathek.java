...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "zdf.de" }, urls = { "http://(www\\.)?zdf\\.de/ZDFmediathek#?/(hauptnavigation/startseite(/[a-z0-9\\-_]+)?#?/)?beitrag/video/\\d+/[^<>\"/\\?#]{1}" }, flags = { 0 })

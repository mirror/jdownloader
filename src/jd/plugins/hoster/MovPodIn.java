...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "movpod.in" }, urls = { "https?://(www\\.)?movpod\\.(in|net)/[a-z0-9]{12}" }, flags = { 0 })
public class MovPodIn extends PluginForHost {
    ...
    public MovPodIn(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (fileInfo[0] == null || fileInfo[0].equals("") && correctedBR.contains("file: \"")) {
            fileInfo[0] = new Regex(link.getDownloadURL(), "([a-z0-9]{12})$").getMatch(0) + ".mp4";
        }

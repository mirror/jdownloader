...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "uploadbits.net" }, urls = { "https?://(www\\.)?uploadbits\\.net/[A-Za-z0-9]+" }, flags = { 0 })
public class UploadBitsNet extends PluginForHost {

    public UploadBitsNet(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(mainpage + "/upgrade." + type);
    }

    // For sites which use this script: http://www.yetishare.com/
    // YetiShareBasic Version 0.3.7-psp
    // mods:
    // limit-info:
    // protocol: no https
    // captchatype: null
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://uploadbits.net";
    private final String         domains                                      = "(uploadbits\\.net)";

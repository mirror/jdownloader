...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "exoshare.com" }, urls = { "http://(www\\.)?exoshare\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ExoShareCom extends PluginForHost {

    public ExoShareCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST   = "http://exoshare.com";

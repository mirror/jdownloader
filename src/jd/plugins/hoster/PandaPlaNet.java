...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "pandapla.net" }, urls = { "https?://(www\\.)?pandapla\\.net/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class PandaPlaNet extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://pandapla.net";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(pandapla\\.net)";
    ...
    public PandaPlaNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        /* Special fname regex */
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "class=\"dofir\" title=\"([^<>\"]*?)\"").getMatch(0);
        }
        if (fileInfo[1] == null) {
    ...
    public void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null && VIDEOHOSTER_2) {
            try {
                ...
                this.postPage(embed_access, "op=video_embed&megafilesembed=1&usr_login=&file_code=" + fuid + "&referer=");
    ...
    private String decodeDownloadLink(final String s) {
        ...
        if (decoded != null) {
            ...
            finallink = new Regex(decoded, "(\"|\\')(https?://[^<>\"\\']*?\\.(mp4|flv|mkv|avi))(\"|\\')").getMatch(1);
        }
        return finallink;
    }

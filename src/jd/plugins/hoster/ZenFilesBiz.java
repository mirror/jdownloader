...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "zenfiles.biz" }, urls = { "https?://(www\\.)?zenfiles\\.biz/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class ZenFilesBiz extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://zenfiles.biz";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(zenfiles\\.biz)";
    ...
    public ZenFilesBiz(PluginWrapper wrapper) {
        super(wrapper);

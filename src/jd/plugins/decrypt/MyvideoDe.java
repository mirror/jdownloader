...
import jd.plugins.RequestInfo;
	...
	public class MyvideoDe extends PluginForDecrypt {
	    ...
	    //SWFObject('http://myvideo-924.vo.llnwd.net/d4/player/player_V21o.swf?http://myvideo-924.vo.llnwd.net/d4/movie13/91/4733924.flv&amp;ID=4733924', 'video_player_swf'
	    ...
	    static private final Pattern MV_FILENAME = Pattern.compile("GetThis\\('(.*?)',", Pattern.CASE_INSENSITIVE);
	    static public final Pattern MV_DOWNLOADURL = Pattern.compile("SWFObject\\('http://myvideo.*?/player/.*?swf\\?(http://[\\w\\.\\-0-9]*/.*?flv)&amp;ID=[0-9]+', 'video_player_swf'", Pattern.CASE_INSENSITIVE);
	    ...
	    public ArrayList<DownloadLink> decryptIt(String parameter) {
	        ...
	        try {
	            ...
	            String link = new Regex(reqinfo.getHtmlCode(), MV_DOWNLOADURL).getFirstMatch();
	            ...
	            if (ConvertTo != null) {
	                ...
	                String name = new Regex(reqinfo.getHtmlCode(), MV_FILENAME).getFirstMatch();
	                link = "< myvideodl url=\"" + parameter + "\" decrypted=\"" + link + "\" convert=\"" + ConvertTo.name() + "\" name=\"" + name + "\" >";
	                //logger.info(link);

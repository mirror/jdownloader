...
public class CryptGetMoviesOrg extends PluginForDecrypt {
    ...
    @Override public String getPluginID() { return "crypt.get-movies.org-1.0.0."; }
    ...
    @Override public PluginStep doStep(PluginStep step, String parameter) {
    	if(step.getStep() == PluginStep.STEP_DECRYPT) {
    		...
    		try {
    			...
    			decryptedLinks.add(getBetween(reqinfo.getHtmlCode(), "frameborder=\"no\" width=\"100%\" src=\"", "\"></iframe>"));

...
public class HardcoremetalBiz extends PluginForDecrypt {

    static private final String host             = "hardcoremetal.biz";
    private String              version          = "1.0.0.0";
    private Pattern             patternSupported = getSupportPattern("http://[*]hardcoremetal.biz/\\?id=[+]");
    private Pattern				PAT_CAPTCHA			 = Pattern.compile("Bitte gebe den <b>Sicherheitscode</b> korrekt ein");

    public HardcoremetalBiz() {
        super();
    ...
    public String getPluginID() {
        return "Hardcoremetal.biz-1.0.0.";
    }
    		...
    		try {
    			...
    			for (;;) {
                    ...
                    if (matcher.find()) {
                        ...
                        String captchaAdress = "http://www.hardcoremetal.biz" + getBetween(reqinfo.getHtmlCode(), "<TD><IMG SRC=\"", "\"");

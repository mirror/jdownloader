...
public abstract class PluginForHost extends Plugin {
    ...
    /** Is this plugin allowed to do mass linkchecking? */
    public static boolean internal_supportsMassLinkcheck(final PluginForHost plugin) {
        return implementsCheckLinks(plugin) && plugin.supportsMassLinkcheck();
    }
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    try {
                        ...
                        if (!StringUtils.equals(downloadLink.getPluginPatternMatcher(), newURLText)) {
                            // if (new Regex(newURLText, getSupportedLinks()).matches()) {
    ...
    public boolean isSpeedLimited(DownloadLink link, Account account) {
        if (link != null && StringUtils.equals(link.getHost(), getHost())) {
            if (hasFeature(FEATURE.MULTIHOST)) {
                return false;
            } else {

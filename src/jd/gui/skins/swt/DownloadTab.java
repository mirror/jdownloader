        ...
        source.addDragListener(new DragSourceListener() {
            ...
            public void dragSetData(DragSourceEvent event) {
                ...
                for (int i = 0; i < dragSourceItem.length - 1; i++) {
                    ...
                    evd += ((downloadLink != null) ? downloadLink.getDownloadURL() : dragSourceItem[i].getText());
                    evd += System.getProperty("line.separator");
                }
                DownloadLink downloadLink = dragSourceItem[dragSourceItem.length - 1].getDownloadLink();
                evd += ((downloadLink != null) ? downloadLink.getDownloadURL() : dragSourceItem[dragSourceItem.length - 1].getText());

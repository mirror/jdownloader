...
public class ConfigPanelDownload extends ConfigPanel {
    ...
    private void setupGeneral(ConfigContainer container) {
        ...
        container.addEntry(ce = new ConfigEntry(ConfigContainer.TYPE_CHECKBOX, SubConfiguration.getConfig(GUIUtils.getConfig()), JDGuiConstants.PARAM_START_DOWNLOADS_AFTER_START, JDL.L("gui.config.download.startDownloadsOnStartUp", "Download beim Programmstart beginnen")));
        ce.setDefaultValue(false);

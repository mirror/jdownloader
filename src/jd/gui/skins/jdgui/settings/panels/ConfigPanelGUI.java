...
public class ConfigPanelGUI extends ConfigPanel {
    ...
    public ConfigPanelGUI(Configuration configuration) {
        super();
        subConfig = SubConfiguration.getConfig(GUIUtils.getConfig());
        initPanel();
    ...
    public void initPanel() {
        ...
        ext.addEntry(ce = new ConfigEntry(ConfigContainer.TYPE_CHECKBOX, subConfig, JDGuiConstants.PARAM_SHOW_SPEEDMETER, JDL.L("gui.config.gui.show_speed_graph", "Display speedmeter graph")).setGroup(speedmeter));
        ce.setDefaultValue(true);
        ConfigEntry cond = ce;

        ext.addEntry(ce = new ConfigEntry(ConfigContainer.TYPE_SPINNER, subConfig, JDGuiConstants.PARAM_SHOW_SPEEDMETER_WINDOWSIZE, JDL.L("gui.config.gui.show_speed_graph_window", "Speedmeter Time period (sec)"), 10, 60 * 60 * 12).setGroup(speedmeter));
        ...
        // subConfig.getProperty(JDGuiConstants.PARAM_BROWSER_VARS, null);
        ...
        // }
        // subConfig.setProperty(JDGuiConstants.PARAM_BROWSER_VARS,
        // browserArray);
        // subConfig.setProperty(JDGuiConstants.PARAM_BROWSER,
        // browserArray[0]);
        // subConfig.save();
        // }
        ...
        browser.addEntry(ce = new ConfigEntry(ConfigContainer.TYPE_COMBOBOX, subConfig, JDGuiConstants.PARAM_BROWSER, LocalBrowser.getBrowserList(), JDL.L("gui.config.gui.Browser", "Browser")));
        ...
        browser.addEntry(ce = new ConfigEntry(ConfigContainer.TYPE_TEXTFIELD, subConfig, JDGuiConstants.PARAM_CUSTOM_BROWSER, JDL.L("gui.config.gui.custom_browser", "Browserpath")));
        ...
        browser.addEntry(ce = new ConfigEntry(ConfigContainer.TYPE_TEXTAREA, subConfig, JDGuiConstants.PARAM_CUSTOM_BROWSER_PARAM, JDL.L("gui.config.gui.custom_browser_param", "Parameter %url (one parameter per line)")));

...
public class DownloadJTableModel extends AbstractTableModel {
    ...
    protected static final String[] COLUMN_NAMES = { JDL.L("gui.treetable.header_1.tree", "F"), JDL.L("gui.treetable.header_3.hoster", "Anbieter"), JDL.L("gui.treetable.header_4.status", "Status"), JDL.L("jd.gui.skins.jdgui.views.downloadview.DownloadJTableModel.extendedstatus.status", "Details"), JDL.L("gui.treetable.header_5.progress", "Fortschritt") };

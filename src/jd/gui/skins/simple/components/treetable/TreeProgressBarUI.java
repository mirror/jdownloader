 ...
 */
public class TreeProgressBarUI extends ProgressBarUI {
    //
    // Animation Thread
    //
    /**
...
//        private int   interval;         // the fixed repaint interval
    ...
    // be
    // repaintInterval*2*aPositiveInteger
    ...
    protected Dimension getPreferredInnerVertical() {
        Dimension vertDim = (Dimension) DefaultLookup.get(progressBar, this, "ProgressBar.vertictalSize");
        if (vertDim == null) {
...
*/
    ...
    private void updateSizes() {
        ...
        delta = 2.0 * maxPosition / numFrames;
    }
}

 ...
 * @author astaldo
 */
public class TabProgress extends JPanel implements PluginListener {
    /**
     * serialVersionUID
     */
    ...
    private class InternalTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                case 0:
                    return p.plugin.getLinkName();
                case 1:
                    return p.plugin.getPluginName();
                case 2:
                    return "(" + p.progressBar.getValue() + "/" + p.progressBar.getMaximum() + ")" + p.plugin.getStatusText();
                case 3:
        ...
        public String getColumnName(int column) {
            switch (column) {
                case 0:
                    return labelColumnLink;
                case 1:
                    return labelColumnName;
                case 2:
                    return labelColumnStatus;
                case 3:

package jd.gui.swing.laf.ext.jtattoo.acryl.components;
...
public class AcrylTitlePane extends com.jtattoo.plaf.acryl.AcrylTitlePane {

    private static final long serialVersionUID = -5491269052062514611L;

    public AcrylTitlePane(JRootPane root, BaseRootPaneUI baseTitlePane) {
    ...
    protected void createMenuBar() {
        ...
        menuBar = new TitlePaneSystemMenu();

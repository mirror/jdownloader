...
public class RemainingColumn extends JDTableColumn {
    ...
    public RemainingColumn(String name, JDTableModel table) {
        super(name, table);
                ...
                if (obj == null && packages.size() > 1) {
                    ...
                    Collections.sort(packages, new Comparator<FilePackage>() {
                        public int compare(FilePackage a, FilePackage b) {
                            ...
                            if (aa.getRemainingKB() == bb.getRemainingKB()) return 0;
                            return aa.getRemainingKB() < bb.getRemainingKB() ? -1 : 1;
                        }
                    });
                } else {
                    /*

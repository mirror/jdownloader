...
public class PremiumPointsColumn extends JDTextTableColumn {

    private static final long serialVersionUID = -5291590062503352550L;

    public PremiumPointsColumn(String name, JDTableModel table) {
        super(name, table);
    }
    ...
    protected String getStringValue(Object value) {
        if (value instanceof Account) {
            ...
            if (ai != null && ai.getPremiumPoints() >= 0) return String.valueOf(ai.getPremiumPoints());
        }
        return "";
    }

...
public class ProxyDialog extends AbstractDialog<AbstractProxySelectorImpl> implements CaretListener {
    ...
    public JComponent layoutDialogContent() {
        ...
        if (JsonConfig.create(InternetConnectionSettings.PATH, InternetConnectionSettings.class).isProxyVoleAutodetectionEnabled()) {
            types = new String[] { _GUI.T.jd_gui_swing_dialog_ProxyDialog_http(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_https(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_socks5(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_socks4(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_socks4a(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_direct(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_pac() };
        } else {
            types = new String[] { _GUI.T.jd_gui_swing_dialog_ProxyDialog_http(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_https(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_socks5(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_socks4(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_socks4a(), _GUI.T.jd_gui_swing_dialog_ProxyDialog_direct() };
        }
    ...
    protected void set(final String text) {
        ...
        if (JsonConfig.create(InternetConnectionSettings.PATH, InternetConnectionSettings.class).isProxyVoleAutodetectionEnabled() && myText.startsWith("pac://") && cmbType.getSelectedIndex() == 6) {
            return;
        }
        for (int i = 0; i < 2; i++) {
            try {
    ...
    public void actionPerformed(final ActionEvent e) {
        if (e.getSource() == cmbNetIf && cmbType.getSelectedIndex() == 5) {
    ...
    private void relayout() {
        ...
        case 6: // pac
            ...
            break;
        default:
            throw new WTFException("Not Possible:" + cmbType.getSelectedIndex());
        }

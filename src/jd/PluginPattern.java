...
public class PluginPattern {
    ...
    static public Pattern decrypterPattern_AnimeANet_Series = Pattern.compile("http://[\\w\\.]*?animea\\.net/download/[\\d]+/(.*?)\\.html", Pattern.CASE_INSENSITIVE);
    static public Pattern decrypterPattern_AnimeANet_Episode = Pattern.compile("http://[\\w\\.]*?animea\\.net/download/[\\d]+-[\\d]+/(.*?)\\.html", Pattern.CASE_INSENSITIVE);
    static public Pattern decrypterPattern_AnimeANet_Plugin = Pattern.compile(decrypterPattern_AnimeANet_Series.pattern() + "|" + decrypterPattern_AnimeANet_Episode.pattern(), Pattern.CASE_INSENSITIVE);

...
public class JDUpdateUtils {
    ...
    //
    // private static void updateLists_ParseZip(ByteBuffer updateLists_Internal)
    // throws IOException {
    // ZipInputStream ZipStream = new
    // ZipInputStream(InputStreamfromByteBuffer(updateLists_Internal));
    // ZipEntry ze = null;
    // synchronized (lock) {
    ...
    // try {
    // String ServerList = ByteBuffer2String(download(listpath + "server.lst",
    // -1));
    ...
    // if (System.currentTimeMillis() - last_updateLists_Internal <
    // interval_updateLists_Internal) return;
    // String newhash = null;
    // /* update.md5 holen */
    ...
    // ByteBuffer updateList_cached = ByteArraytoByteBuffer((byte[])
    // SubConfiguration.getSubConfig("WEBUPDATE").getProperty("update.zip",
    // null));
    ...
    // oldhash.equalsIgnoreCase(newhash)) {
    ...
    // SubConfiguration.getSubConfig("WEBUPDATE").setProperty("update.zip",
    // ByteBuffertoByteArray(updateList_downloaded.duplicate()));
    ...
    // ByteBuffer newbuffer = ByteBuffer.allocateDirect((bigbuffer.capacity() *
    // 2));
    // bigbuffer.flip();
    ...
    // }
    //
    // private static InputStream InputStreamfromByteBuffer(final ByteBuffer
    // buf) {
    ...
    // }
    //
    // private static ByteBuffer download(String fileurl, int limit) throws
    // IOException {
    ...
    // url.openConnection();
    // if
    // (SubConfiguration.getSubConfig("WEBUPDATE").getBooleanProperty("USE_PROXY",
    // false)) {
    // String user =
    // SubConfiguration.getSubConfig("WEBUPDATE").getStringProperty("PROXY_USER",
    // "");
    // String pass =
    // SubConfiguration.getSubConfig("WEBUPDATE").getStringProperty("PROXY_PASS",
    // "");
    //
    // httpConnection.setRequestProperty("Proxy-Authorization", "Basic " +
    // WebUpdater.Base64Encode(user + ":" + pass));
    //
    // }
    //
    // if
    // (SubConfiguration.getSubConfig("WEBUPDATE").getBooleanProperty("USE_SOCKS",
    // false)) {
    //
    // String user =
    // SubConfiguration.getSubConfig("WEBUPDATE").getStringProperty("PROXY_USER_SOCKS",
    // "");
    // String pass =
    // SubConfiguration.getSubConfig("WEBUPDATE").getStringProperty("ROXY_PASS_SOCKS",
    // "");
    //
    // httpConnection.setRequestProperty("Proxy-Authorization", "Basic " +
    // WebUpdater.Base64Encode(user + ":" + pass));
    ...
    // if (httpConnection.getHeaderField("Content-Encoding") != null &&
    // httpConnection.getHeaderField("Content-Encoding").equalsIgnoreCase("gzip"))
    // {

...
public interface LinkCrawlerConfig extends ConfigInterface {
    ...
    @DefaultStringArrayValue({ "CAPTCHA", "EMPTY_FOLDER", "FILE_NOT_FOUND", "NO_ACCOUNT", "PLUGIN_DEFECT", "PLUGIN_SETTINGS", "PASSWORD", "GEO", "IP", "HOST_RATE_LIMIT", "UNSUPPORTED_LIVESTREAM", "BLOCKED_BY" })
    @AboutConfig

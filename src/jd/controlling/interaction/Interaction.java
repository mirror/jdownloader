 ...
 * 
 * @author astaldo
 * give me a minute.. i have to think about a workaround for this problem
 * yup, sure
 */
public abstract class Interaction extends Property implements Serializable {
    ...
    public static InteractionTrigger INTERACTION_DOWNLOAD_PACKAGE_FINISHED ;//= new InteractionTrigger(12, JDLocale.L("interaction.trigger.package_finished", "Paket fertig"), JDLocale.L("interaction.trigger.package_finished.desc", "Wird aufgerufen wenn ein Paket fertig geladen wurde"));
    ...
    public static InteractionTrigger INTERACTION_CONTAINER_DOWNLOAD ;//= new InteractionTrigger(16, JDLocale.L("interaction.trigger.container_download", "Linkcontainer geladen"), JDLocale.L("interaction.trigger.download_download.desc", "Wird aufgerufen wenn ein LinkContainer(DLC,RSDF,CCF,...) geladen wurde"));
    public static InteractionTrigger INTERACTION_BEFORE_DOWNLOAD;// = new InteractionTrigger(17, JDLocale.L("interaction.trigger.before_download", "Vor einem Download"), JDLocale.L("interaction.trigger.before_download.desc", "Wird aufgerufen bevor ein neuer Download gestartet wird"));
    public static InteractionTrigger INTERACTION_EXIT;// = new InteractionTrigger(20, JDLocale.L("interaction.trigger.exit", "JD wird beendet"), JDLocale.L("interaction.trigger.exit.desc", "Wird beim Beenden vor dem Schließen des Programms aufgerufen"));

...
public abstract class Interaction extends Property implements Serializable {
    ...
    public static Interaction[] getInteractionList() {
        return new Interaction[] { new HTTPLiveHeader(),new DummyInteraction(), new ExternExecute(), new ExternReconnect(), new HTTPReconnect(), new WebUpdate(), new JAntiCaptcha(), new ManualCaptcha(),new JDExit(), new ResetLink() };
    }
    /**

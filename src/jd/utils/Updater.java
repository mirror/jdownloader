...
public class Updater {
    ...
    public static final String BRANCH = "PINKY";
    public static ArrayList<Server> SERVERLIST = new ArrayList<Server>();
    public static Server UPDATE0 = new Server(-1, "http://update0.jdownloader.org/branches/" + BRANCH + "/", "update0.jdownloader.org", 2121, "/http/branches/" + BRANCH + "/");
    public static Server UPDATE1 = new Server(-1, "http://update1.jdownloader.org/branches/" + BRANCH + "/", "update1.jdownloader.org", 2121, "/http/branches/" + BRANCH + "/");
    public static Server UPDATE2 = new Server(-1, "http://update2.jdownloader.org/branches/" + BRANCH + "/", "update2.jdownloader.org", 2121, "/http/branches/" + BRANCH + "/");
    static {
        ...
        // SERVERLIST.add(new
        // Server(-1,"http://update4ex.jdownloader.org/branches/"+BRANCH+"/","update4ex.jdownloader.org",21,"/branches/"+BRANCH+"/"));
    ...
    private void cleanUp() {
        ...
        String[] rest = new String[] {/* "libs/svnkit.jar" */"info.txt", "jd/img/default/flags", "plugins/JDPremium.jar", "tools/Windows/recycle.exe", "tools/Windows/recycle.cpp", "jd/img/screenshots", "jd/img/synthetica"
    ...
    private void moveJars(String string) throws IOException {
        ...
        packedFiles.addAll(pack(new File(this.updateDir, "jd/captcha")));
        packedFiles.addAll(pack(new File(this.updateDir, "jd/router")));

        packedFiles.addAll(pack(new File(this.updateDir, "jd/img")));
        packedFiles.addAll(pack(new File(this.updateDir, "licenses")));
        packedFiles.addAll(pack(new File(this.updateDir, "jd/languages")));

        for (File f : packedFiles) {
            String newpath = f.getAbsolutePath().replace(this.updateDir.getAbsolutePath(), this.workingDir.getAbsolutePath());
    ...
    static class Server {
        ...
        public Server(int priority, String httpPath, String ftpIP, int ftpHost, String ftpPath) {

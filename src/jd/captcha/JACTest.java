...
public class JACTest {
    ...
    private void go() {
        ...
        jac.showPreparedCaptcha(new File("C:/Users/coalado/.jd_home/jd/captcha/methods/" + hoster + "/captchas/" + "08.08.2008_03.46.36.313__NULL_BAD" + ".png"));

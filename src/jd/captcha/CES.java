...
public class CES {
    ...
    public static ImageIcon getImage() {
        return new ImageIcon(JDUtilities.getImage(CES.getCesImageString()));
    }
    ...
    private static String loginDialog() {
        return new Dialog(((SimpleGUI) JDUtilities.getGUI()).getFrame()) {
            ...
            String init() {
                ...
                panel.add(new JLabel(JDLocale.L("jac.CES.login.user", "Benutzername:"), SwingConstants.CENTER));
                panel.add(user);
                panel.add(new JLabel(JDLocale.L("jac.CES.login.pass", "Passwort:"), SwingConstants.CENTER));
                panel.add(pass);

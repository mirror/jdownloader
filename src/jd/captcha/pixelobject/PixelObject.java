...
//logger.info(" AVG "+avg+" ("+color+")");
    ...
    public boolean doesColorAverageFit(int color) {
      ...
      //  logger.info(tavg+"-"+color+" : "+(int)Math.abs(tavg - color)+"<"+(int)(owner.getMaxPixelValue() * this.contrast)+" = "+(((int)Math.abs(tavg - color) < (int)(owner.getMaxPixelValue() * this.contrast))));

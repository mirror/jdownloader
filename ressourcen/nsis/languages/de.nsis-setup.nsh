...
LangString HelpLink ${LANG_GERMAN} "${APPNAME} Support"
LangString InstalledAsAdmin ${LANG_GERMAN} "Sie versuchen, ein Produkt zu deinstallieren, welches Sie eventuell mit Administrationsrechten installiert haben. Das Programm wird unter Umständen nicht vollständig entfernt. Trotzdem fortfahren?"

...
public class CFG_LINKGRABBER {
    ...
    // true
    /**
     * If true, Plugins will try to correct filenames to match to others. For
     * example in splitted archives.
     **/
    ...
    // true
    /**
     * If true, the Linkcollector asks the Hosterplugins to filter the
     * packageidentifier. This helps to map corrupt filenames into the correct
     * packages.
     **/

...
@DecrypterPlugin(revision = "$Revision: 16960 $", interfaceVersion = 2, names = { "mov-world.net", "xxx-4-free.net", "chili-warez.net" }, urls = { "http://(www\\.)?mov-world\\.net/(?!news/)(\\?id=\\d+|.*?/.*?.html)", "http://(www\\.)?xxx\\-4\\-free\\.net/.*?/.*?.html", "http://(www\\.)?chili\\-warez\\.net/.*?/(\\-/)?.*?.html" }, flags = { 0, 0, 0 })

...
@DecrypterPlugin(revision = "$Revision: 16099 $", interfaceVersion = 2, names = { "fileblaze.net" }, urls = { "http://((www|betastage)\\.)?fileblaze\\.net/external\\.html\\?key=[0-9a-f]+|http://fblaz\\.in/\\w+" }, flags = { 0 })

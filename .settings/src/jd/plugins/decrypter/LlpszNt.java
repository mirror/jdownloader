...
@DecrypterPlugin(revision = "$Revision: 16291 $", interfaceVersion = 2, names = { "klipsiz.org" }, urls = { "http://(www\\.)?klipsiz\\.(net|org)/(?!index\\.php|radyo\\-listeleri\\.php)(([a-zA-Z0-9-.]+|[a-z]{1}/[0-9]+)\\.php|mp3-dinle-indir/[0-9]+-[0-9]+/)" }, flags = { 0 })

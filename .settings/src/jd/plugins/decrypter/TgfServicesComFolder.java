...
@DecrypterPlugin(revision = "$Revision: 15150 $", interfaceVersion = 2, names = { "tgf-services.com" }, urls = { "http://(www\\.)?tgf\\-services\\.com/(downloads/[a-zA-Z0-9_]+|UserDownloads/.+)" }, flags = { 0 })

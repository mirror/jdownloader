...
@DecrypterPlugin(revision = "$Revision: 16259 $", interfaceVersion = 2, names = { "freakshare.net" }, urls = { "http://(www\\.)?freakshare\\.(com|net)/(folder/\\d+/([a-z\\d]+\\.html)?|\\?x=folder\\&f_id=\\d+&f_md5=[a-z0-9]+)" }, flags = { 0 })

...
@DecrypterPlugin(revision = "$Revision: 8587 $", interfaceVersion = 2, names = { "imagehaven.net" }, urls = { "http://[\\w\\.]*?imagehaven\\.net/gallery/[A-Z0-9]+" }, flags = { 0 })
public class ImgHvenNtGallery extends PluginForDecrypt {

    public ImgHvenNtGallery(PluginWrapper wrapper) {
        super(wrapper);
    }

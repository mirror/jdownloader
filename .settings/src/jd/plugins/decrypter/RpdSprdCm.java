...
@DecrypterPlugin(revision = "$Revision: 11677 $", interfaceVersion = 2, names = { "rapidspread.com" }, urls = { "http://[\\w\\.]*?rapidspread\\.com/file\\.jsp\\?id=\\w+" }, flags = { 0 })
public class RpdSprdCm extends PluginForDecrypt {

    public RpdSprdCm(PluginWrapper wrapper) {
        super(wrapper);
    }

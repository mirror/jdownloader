...
@DecrypterPlugin(revision = "$Revision: 15818 $", interfaceVersion = 2, names = { "filesmonster.comDecrypt" }, urls = { "http://[\\w\\.\\d]*?filesmonster\\.com/(download.php\\?id=[A-Za-z0-9_-]+|dl/.*?/free/)" }, flags = { 0 })

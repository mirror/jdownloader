...
@DecrypterPlugin(revision = "$Revision: 16544 $", interfaceVersion = 2, names = { "xxx-blog.org" }, urls = { "http://(www\\.)?xxx-blog\\.(org|to)/((share|sto|com-|u|filefactory/|relink/)[\\w\\./-]+|.*?\\.html|blog/(dvd-rips|scenes|amateur-clips|hd-(scenes|movies)|site-rips|image-sets|games)/.+/)" }, flags = { 0 })

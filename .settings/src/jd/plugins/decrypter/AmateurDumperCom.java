...
@DecrypterPlugin(revision = "$Revision: 15600 $", interfaceVersion = 2, names = { "amateurdumper.com" }, urls = { "http://(www\\.)?amateurdumper\\.com/(index\\.php\\?ctr=view\\&id=\\d+|\\d+/.*?\\.html)" }, flags = { 0 })

...
@DecrypterPlugin(revision = "$Revision: 13712 $", interfaceVersion = 2, names = { "cliccami.info", "mylink4u.info", "urlaxe.net", "cbuz.com", "shorten.ws" }, urls = { "http://[\\w\\.]*?cliccami\\.info/[0-9a-z]+", "http://[\\w\\.]*?mylink4u\\.info/[a-z0-9]+", "http://[\\w\\.]*?urlaxe\\.net/[0-9]+", "http://[\\w\\.]*?cbuz\\.com/[a-z0-9]+", "http://(www\\.)?shorten\\.ws/[a-z0-9-]+" }, flags = { 0, 0, 0, 0, 0 })

...
@DecrypterPlugin(revision = "$Revision: 16745 $", interfaceVersion = 2, names = { "cybersansar.com" }, urls = { "http://(www\\.)?cybersansar\\.com/(thumbnail_view\\.php\\?gal_id=\\d+|wallpaper_download\\.php\\?wid=\\d+)" }, flags = { 0 })

...
@DecrypterPlugin(revision = "$Revision: 15714 $", interfaceVersion = 2, names = { "filecondo.com" }, urls = { "http://(www\\.)?filecondo\\.com/(download_regular\\.php\\?file=|dl\\.php\\?f=)[A-Za-z0-9]+" }, flags = { 0 })

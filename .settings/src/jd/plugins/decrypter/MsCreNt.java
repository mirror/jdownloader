...
@DecrypterPlugin(revision = "$Revision: 14380 $", interfaceVersion = 2, names = { "musicore.net" }, urls = { "http(s)?://(www\\.)?(r\\.)?musicore\\.net/forums/index\\.php\\?(/topic/\\d+\\-|showtopic=\\d+|\\?id=[A-Za-z0-9]+\\&url=[a-zA-Z0-9=\\+/\\-]+|/forum/\\d+\\-[A-Za-z0-9]+/(page_.+)?)" }, flags = { 0 })

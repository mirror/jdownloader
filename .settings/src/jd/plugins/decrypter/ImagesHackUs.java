...
@DecrypterPlugin(revision = "$Revision: 16009 $", interfaceVersion = 2, names = { "imageshack.us" }, urls = { "http://(www\\.)?(img[0-9]{1,4}\\.imageshack\\.us/g/[a-z0-9]+\\.[a-zA-Z0-9]{2,4}/|imageshack\\.us/photo/[^<>\"\\'/]+/\\d+/[^<>\"\\'/]+/)" }, flags = { 0 })

...
@DecrypterPlugin(revision = "$Revision: 15620 $", interfaceVersion = 2, names = { "bomb-mp3.com" }, urls = { "http://(www\\.)?bomb\\-mp3\\.com/(download\\.php\\?mp3_id=[0-9]+\\&title=[^/\"<>\\&]+|download/\\d+/[^/<>\"]+\\.html)" }, flags = { 0 })

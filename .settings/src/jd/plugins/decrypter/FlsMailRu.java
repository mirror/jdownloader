...
@DecrypterPlugin(revision = "$Revision: 17002 $", interfaceVersion = 2, names = { "files.mail.ru" }, urls = { "http://[\\w\\.]*?files\\.mail\\.ru/[A-Z0-9]{6}" }, flags = { 0 })
public class FlsMailRu extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        // New kind of links
        if (br.containsHTML(jd.plugins.hoster.FilesMailRu.NEWLINK)) {

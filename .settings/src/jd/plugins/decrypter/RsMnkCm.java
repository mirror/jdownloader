...
@DecrypterPlugin(revision = "$Revision: 10114 $", interfaceVersion = 2, names = { "rsmonkey.com" }, urls = { "http://[\\w\\.]*?((rsmonkey\\.com|oneddl\\.canhaz\\.it)/\\d+|[0-9]\\.(rsmonkey\\.com|oneddl\\.canhaz\\.it))" }, flags = { 0 })

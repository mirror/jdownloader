...
@DecrypterPlugin(revision = "$Revision: 16339 $", interfaceVersion = 2, names = { "sourceforge.net" }, urls = { "http://(www\\.)?(sourceforge\\.net/projects/(.*?/files/extras/.*?/download|.+)|downloads\\.sourceforge\\.net/.+)" }, flags = { 0 })

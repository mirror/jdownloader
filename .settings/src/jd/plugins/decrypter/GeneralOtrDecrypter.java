...
@DecrypterPlugin(revision = "$Revision: 15896 $", interfaceVersion = 2, names = { "die-schnelle-kuh.de", "otr-share.de", "tivootix.co.cc", "otr-drive.com", "otr.seite.com" }, urls = { "http://(www\\.)?die\\-schnelle\\-kuh\\.de/\\?file=[^<>\"\\']+", "http://(www\\.)?otr\\-share\\.de/\\?s=download\\&key=[^<>\"\\']+", "http://(www\\.)?tivootix\\.co\\.cc/\\?file=[^<>\"\\']+", "http://(www\\.)?otr\\-drive\\.com/(index\\.php)?\\?file=[^<>\"\\']+", "http://(www\\.)?otr\\.seite\\.com/get\\.php\\?file=[^<>\"\\']+" }, flags = { 0, 0, 0, 0, 0 })

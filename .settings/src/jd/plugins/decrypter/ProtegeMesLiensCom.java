 ...
 * PrtcMyLnksCm
 */
@DecrypterPlugin(revision = "$Revision: 15395 $", interfaceVersion = 2, names = { "protege-mes-liens.com" }, urls = { "http://(www\\.)?protege\\-mes\\-liens\\.com/(mylink\\.php\\?linkid=|linkidwoc\\.php\\?linkid=)[a-z0-9]+" }, flags = { 0 })

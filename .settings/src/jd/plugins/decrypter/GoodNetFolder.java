...
@DecrypterPlugin(revision = "$Revision: 10110 $", interfaceVersion = 2, names = { "good.net" }, urls = { "http://[\\w\\.]*?good\\.net/.+" }, flags = { 0 })
public class GoodNetFolder extends PluginForDecrypt {

    public GoodNetFolder(PluginWrapper wrapper) {
        super(wrapper);
    }

    // This decrypter is needed for the "GoodNet" Hosterplugin as it differs
    // between hoster-and folderlinks!

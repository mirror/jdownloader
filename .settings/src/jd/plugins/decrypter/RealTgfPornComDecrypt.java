...
@DecrypterPlugin(revision = "$Revision: 14531 $", interfaceVersion = 2, names = { "realtgfporn.com" }, urls = { "http://(www\\.)?realgfporn\\.com/\\d+/.*?\\.html" }, flags = { 0 })
public class RealTgfPornComDecrypt extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        if (tempID != null && tempID.equals("http://www.realgfporn.com/")) {
            DownloadLink dl = createDownloadlink(parameter.replace("realtgfporn.com/", "realtgfporndecrypted.com/"));
        ...
        DownloadLink dl = createDownloadlink(parameter.replace("realgfporn.com/", "realgfporndecrypted.com/"));
        decryptedLinks.add(dl);
        return decryptedLinks;
    }

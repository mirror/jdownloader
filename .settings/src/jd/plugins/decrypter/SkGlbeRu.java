...
@DecrypterPlugin(revision = "$Revision: 16705 $", interfaceVersion = 2, names = { "skyglobe.ru" }, urls = { "http://(www\\.)?skyglobe\\.ru/(mp3/album/\\d+|soft/section/[^<>\"/]+/[^<>\"/]+/\\d+|video/movie\\.html\\?rt_movie_id=\\d+|clip/clip/\\d+|gallery/photo/\\d+/\\d+\\.html|games/game/\\d+\\.html|wallpapers/picture/\\d+\\.html)" }, flags = { 0 })

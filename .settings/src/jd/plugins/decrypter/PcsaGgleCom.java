...
@DecrypterPlugin(revision = "$Revision: 14520 $", interfaceVersion = 2, names = { "picasaweb.google.com" }, urls = { "http(s)?://(www\\.)?picasaweb\\.google\\.com/.*?/.*?(\\?feat=(featured#[0-9]+|featured#)|#[0-9]+|#|\\?authkey=[A-Za-z0-9\\-]+)" }, flags = { 0 })

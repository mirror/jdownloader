...
@DecrypterPlugin(revision = "$Revision: 15695 $", interfaceVersion = 2, names = { "glumbouploads.com" }, urls = { "http://(www\\.)?(glumbouploads|uploads\\.glumbo)\\.com/users/[a-z0-9_]+/\\d+" }, flags = { 0 })

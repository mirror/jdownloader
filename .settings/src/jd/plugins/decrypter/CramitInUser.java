...
@DecrypterPlugin(revision = "$Revision: 13486 $", interfaceVersion = 2, names = { "cramit.in" }, urls = { "http://(www\\.)?(cramit\\.in|cramitin\\.(net|eu|us))/user/\\d+(/\\d+)?" }, flags = { 0 })
public class CramitInUser extends PluginForDecrypt {
    ...
    private static final String HOST = "cramit.in";

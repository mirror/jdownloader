 ...
 * @author typek_pb
 */
@DecrypterPlugin(revision = "$Revision: 15446 $", interfaceVersion = 2, names = { "avaxhome.ws" }, urls = { "http://(www\\.)?avaxhome\\.ws/(ebooks|music|software|video|magazines|games|graphics|misc|hraphile|comics)/.+" }, flags = { 0 })

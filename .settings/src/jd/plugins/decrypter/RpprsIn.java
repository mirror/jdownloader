...
@DecrypterPlugin(revision = "$Revision: 16733 $", interfaceVersion = 2, names = { "rappers.in" }, urls = { "http://(www\\.)?rappers\\.in/(.*?\\-beat\\-\\d+\\.html|[A-Za-z0-9_\\-]+\\-tracks\\.html|[A-Za-z0-9_\\-]+)" }, flags = { 0 })

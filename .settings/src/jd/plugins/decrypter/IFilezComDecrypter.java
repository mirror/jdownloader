...
@DecrypterPlugin(revision = "$Revision: 16603 $", interfaceVersion = 2, names = { "i-filez.com", "depfile.com" }, urls = { "UNUSED_REGEX_HAHHAHAHAHA", "http://(www\\.)?(i\\-filez|depfile)\\.com/(downloads/i/\\d+/f/[^\"\\']+|[a-zA-Z0-9]{8})" }, flags = { 0, 0 })

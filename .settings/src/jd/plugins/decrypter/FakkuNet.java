...
@DecrypterPlugin(revision = "$Revision: 16030 $", interfaceVersion = 2, names = { "fakku.net" }, urls = { "http://(www\\.)?fakku\\.net/((viewmanga|viewonline)\\.php\\?id=\\d+|redirect\\.php\\?type=m\\&id=[A-Za-z0-9]+)" }, flags = { 0 })

...
@HostPlugin(revision = "$Revision: 16136 $", interfaceVersion = 2, names = { "xxxmsncam.com" }, urls = { "http://(www\\.)?xxxmsncam\\.com/\\d+{4}/\\d+{2}/\\d+{2}/[^<>\"\\'/]+/" }, flags = { 0 })
public class XxxMsnCamCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (br.containsHTML("(>Oops not found|<title>Nothing found for)")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

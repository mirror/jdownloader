...
public class UpchiCoIl extends PluginForHost {
    ...
    private static final String COOKIE_HOST         = "http://upchi.co.il";
    ...
    public UpchiCoIl(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
                ...
                if (filename == null) {
                    ...
                    if (filename == null) {
                        ...
                        if (filename == null) {
                            ...
                            if (filename == null) {
                                filename = new Regex(correctedBR, "<title>(.*?) הורדה ישירה</Title>").getMatch(0);
                                if (filename == null) {
                                    filename = new Regex(correctedBR, "<b>File ?name ?:? ?</b> ?(.*?)<").getMatch(0);
                                }
                            }
                        }
                    }
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) {
                    filesize = new Regex(correctedBR, "(?i)File ?Size[^\\d]+([\\d\\.]+ ?(GB|MB))").getMatch(0);
                }
            }
        }

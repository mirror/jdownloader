...
@HostPlugin(revision = "$Revision: 16216 $", interfaceVersion = 2, names = { "simpleshare.org" }, urls = { "https?://(www\\.)?simpleshare\\.org/[a-z0-9]{12}" }, flags = { 0 })
public class SimpleShareOrg extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://simpleshare.org";
    ...
    // DEV NOTES
    // XfileSharingProBasic Version 2.5.5.4-raz
    // mods:
    // non account: 2 * 1
    // free account:
    // premium account:
    ...
    public SimpleShareOrg(PluginWrapper wrapper) {
        super(wrapper);

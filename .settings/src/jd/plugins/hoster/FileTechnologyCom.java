...
@HostPlugin(revision = "$Revision: 16650 $", interfaceVersion = 2, names = { "filetechnology.com" }, urls = { "https?://(www\\.)?filetechnology\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileTechnologyCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://filetechnology.com";
    ...
    public FileTechnologyCom(PluginWrapper wrapper) {
        super(wrapper);

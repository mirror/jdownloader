...
@HostPlugin(revision = "$Revision: 15994 $", interfaceVersion = 2, names = { "crocshare.com" }, urls = { "http://(www\\.)?crocshare\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class CrocShareCom extends PluginForHost {

    private String              BRBEFORE            = "";

    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST         = "http://crocshare.com";
    ...
    public CrocShareCom(PluginWrapper wrapper) {
        super(wrapper);

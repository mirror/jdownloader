...
@HostPlugin(revision = "$Revision: 16650 $", interfaceVersion = 2, names = { "elitedisk.com" }, urls = { "https?://(www\\.)?elitedisk\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class EliteDiskCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://elitedisk.com";
    ...
    public EliteDiskCom(PluginWrapper wrapper) {
        super(wrapper);
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                ...
                if (dllink == null) {
                    ...
                    if (dllink == null) {
                        dllink = new Regex(correctedBR, "<a href=\"(https?://[^\"]+)\"><img src=\"[^\"]+ title=\"Download Now").getMatch(0);
                        if (dllink == null) {
                            dllink = new Regex(correctedBR, "(https?://\\w+\\.elitedisk\\.com[^/]+/elite/files/[^\"]+)").getMatch(0);
                            if (dllink == null) {

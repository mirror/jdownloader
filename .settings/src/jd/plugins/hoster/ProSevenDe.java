...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "prosieben.de" }, urls = { "http://(www\\.)?prosieben\\.de/tv/[\\w-]+/video(s)?/(clip/[\\w-\\.]+/?|[\\w-]+)" }, flags = { PluginWrapper.DEBUG_ONLY })

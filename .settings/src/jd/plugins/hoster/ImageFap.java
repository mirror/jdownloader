...
@HostPlugin(revision = "$Revision: 16623 $", interfaceVersion = 2, names = { "imagefap.com" }, urls = { "http://(www\\.)?imagefap.com/(image\\.php\\?id=.*(&pgid=.*&gid=.*&page=.*)?|video\\.php\\?vid=\\d+)" }, flags = { 0 })

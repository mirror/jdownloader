...
@HostPlugin(revision = "$Revision: 16457 $", interfaceVersion = 2, names = { "host.hackerbox.org" }, urls = { "https?://(www\\.)?host\\.hackerbox\\.org/[a-z0-9]{12}" }, flags = { 0 })
public class HostHackerboxOrg extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://host.hackerbox.org";

...
@HostPlugin(revision = "$Revision: 16136 $", interfaceVersion = 2, names = { "czshare.com" }, urls = { "http://(www\\.)?(czshare\\.com/((files/)?\\d+/[A-Za-z0-9_\\.]+(/.{1})?|download_file\\.php\\?id=\\d+\\&code=[A-Za-z0-9]+)|www\\d+\\.czshare\\.com/profi\\.php\\?id=\\d+\\&kod=[A-Za-z0-9]+)" }, flags = { 2 })

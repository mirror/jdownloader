...
@HostPlugin(revision = "$Revision: 15626 $", interfaceVersion = 2, names = { "bitbonus.com" }, urls = { "http://bitbonusdecrypted\\.com/(download/[A-Za-z0-9\\-_]+/free/2/|download/)[A-Za-z0-9\\-_]+" }, flags = { 0 })

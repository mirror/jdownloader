...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "cestyksobe.cz" }, urls = { "http://(www\\.)?cestyksobe\\.cz/(novinky/novinky/\\d+|archiv/.*?/.*?)\\.html" }, flags = { 0 })
public class CestyKsobeCz extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (br.containsHTML("(>Hledaná stránka nebyla nalezena<|Omlouváme se, ale Vámi požadovaná stránka nebyla nalezena|Možné důvody této chybové stránky|>Požadovaná stránka byla smazána či přesunuta|>Zadal\\(a\\) jste špatnou adresu)")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

...
@HostPlugin(revision = "$Revision: 16966 $", interfaceVersion = 2, names = { "flickr.com" }, urls = { "http://(www\\.)?flickrdecrypted\\.com/photos/[^<>\"/]+/\\d+" }, flags = { 2 })
public class FlickrCom extends PluginForHost {
    ...
    private String getFinalLink() {
        final String[] sizes = { "k", "h", "o", "l", "c", "z", "m", "n", "s", "t", "q", "sq" };

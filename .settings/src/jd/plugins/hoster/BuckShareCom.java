...
@HostPlugin(revision = "$Revision: 15422 $", interfaceVersion = 2, names = { "buckshare.com" }, urls = { "http://(www\\.)?buckshare\\.com/[a-z0-9]{12}" }, flags = { PluginWrapper.DEBUG_ONLY })
public class BuckShareCom extends PluginForHost {
    ...
    // XfileSharingProBasic Version 2.1.1.2
    @Override
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        doSomething();
        if (BRBEFORE.contains("No such file") || BRBEFORE.contains("No such user exist") || BRBEFORE.contains("File not found") || BRBEFORE.contains(">File Not Found<") || BRBEFORE.contains(">Oops...Not found, perhaps the search will help you")) {

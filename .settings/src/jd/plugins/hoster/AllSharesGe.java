...
@HostPlugin(revision = "$Revision: 16020 $", interfaceVersion = 2, names = { "allshares.ge" }, urls = { "http://[\\w\\.]*?allshares\\.ge/(\\?d|download\\.php\\?id)=[A-Z0-9]+" }, flags = { 0 })
public class AllSharesGe extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink parameter) throws Exception {
        ...
        String filesize = br.getRegex("<strong>File size:</strong> [\t\n\r ]+<span>([^<>\"\\'/]+)</span>").getMatch(0);

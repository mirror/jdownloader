...
@HostPlugin(revision = "$Revision: 16548 $", interfaceVersion = 2, names = { "easy-share.com", "crocko.com" }, urls = { "sgru3465979hg354uigUNUSED_REGEX879t24uj", "http://[\\w\\d\\.]*?(easy\\-share|crocko)\\.com/([A-Z0-9]+/?|\\d+)" }, flags = { 0, 2 })

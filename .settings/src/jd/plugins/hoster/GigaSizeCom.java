...
@HostPlugin(revision = "$Revision: 15718 $", interfaceVersion = 2, names = { "gigasize.com" }, urls = { "http://[\\w\\.]*?gigasize\\.com/get/[a-z0-9]+" }, flags = { 2 })
public class GigaSizeCom extends PluginForHost {
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception {
        ...
        if (br.containsHTML("(?i)>You've reached your <strong>DOWNLOAD LIMIT<")) throw new PluginException(LinkStatus.ERROR_IP_BLOCKED, "Download limit reached", 1 * 60 * 60 * 1000l); // unknown
                                                                                                                                                                                        // hoster
                                                                                                                                                                                        // expire
                                                                                                                                                                                        // time

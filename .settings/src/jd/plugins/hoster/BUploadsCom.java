...
@HostPlugin(revision = "$Revision: 16445 $", interfaceVersion = 2, names = { "buploads.com" }, urls = { "http://(www\\.)?buploads\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })
public class BUploadsCom extends PluginForHost {
    ...
    public BUploadsCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink parameter) throws Exception {
        ...
        Regex fileInfo = br.getRegex("class=\"cFFF\">Downloading:</span> (.*?) ([0-9\\.]+ .{0,4})</div>");

...
@HostPlugin(revision = "$Revision: 15422 $", interfaceVersion = 2, names = { "fileupper.com" }, urls = { "http://(www\\.)?fileupper\\.com/[a-z0-9]{12}" }, flags = { PluginWrapper.DEBUG_ONLY })
public class FileUpperCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST   = "http://fileupper.com";

    public boolean              NOPREMIUM     = false;

    public FileUpperCom(PluginWrapper wrapper) {
        super(wrapper);

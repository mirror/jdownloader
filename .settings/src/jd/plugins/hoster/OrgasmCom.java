...
@HostPlugin(revision = "$Revision: 16632 $", interfaceVersion = 2, names = { "orgasm.com" }, urls = { "http://(www\\.)?orgasm\\.com/movies(/recent/[\\w\\+\\%]+)?\\?id=/video/\\d+/" }, flags = { PluginWrapper.DEBUG_ONLY })

...
//Same code as RocketFilesNet and FlashVidsOrg
@HostPlugin(revision = "$Revision: 16383 $", interfaceVersion = 2, names = { "yamivideo.com" }, urls = { "http://(www\\.)?yamivideo\\.com/video/[a-z0-9]+" }, flags = { 0 })

...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "gfssex.com" }, urls = { "http://(www\\.)?gfssex\\.com/videos/\\d+/.*?\\.html" }, flags = { 0 })
public class GfsSexCom extends PluginForHost {

    private String DLLINK = null;

    public GfsSexCom(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Override
    public String getAGBLink() {
        return "http://www.gfssex.com/terms.php";
    }

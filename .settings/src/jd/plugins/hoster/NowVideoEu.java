...
@HostPlugin(revision = "$Revision: 16733 $", interfaceVersion = 2, names = { "nowvideo.eu" }, urls = { "http://(www\\.)?(nowvideo\\.eu/(video/|player\\.php\\?v=)|embed\\.nowvideo\\.eu/embed\\.php\\?v=)[a-z0-9]+" }, flags = { 2 })

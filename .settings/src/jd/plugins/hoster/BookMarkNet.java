...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "book-mark.net" }, urls = { "http://(www\\.)?book\\-mark\\.net/videos/\\d+/.*?\\.html" }, flags = { 0 })
public class BookMarkNet extends PluginForHost {

    private String DLLINK = null;

    public BookMarkNet(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Override
    public String getAGBLink() {
        return "http://www.book-mark.net/terms/";
    }
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (DLLINK == null) DLLINK = br.getRegex("(http://cdn\\d+\\.media\\.book\\-mark\\.net/videos/[a-z0-9]+\\.mp4)").getMatch(0);

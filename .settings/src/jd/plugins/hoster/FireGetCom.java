...
@HostPlugin(revision = "$Revision: 16377 $", interfaceVersion = 2, names = { "fireget.com" }, urls = { "https?://(www\\.)?fireget\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FireGetCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://fireget.com";
    ...
    public FireGetCom(PluginWrapper wrapper) {
        super(wrapper);

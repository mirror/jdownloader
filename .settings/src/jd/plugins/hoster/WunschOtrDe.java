...
@HostPlugin(revision = "$Revision: 15921 $", interfaceVersion = 2, names = { "wunsch-otr.de" }, urls = { "http://(www\\.)?wunsch\\-otr\\.de/(\\?file=|index\\.php\\?mode=download\\&id=\\d+\\&name=)[^<>\"\\']+\\.otrkey" }, flags = { 0 })

...
@HostPlugin(revision = "$Revision: 16368 $", interfaceVersion = 2, names = { "gigfiles.net" }, urls = { "https?://(www\\.)?gigfiles\\.net/[a-z0-9]{12}" }, flags = { 0 })
public class GigFilesNet extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://gigfiles.net";
    ...
    // XfileSharingProBasic Version 2.5.4.8
    @Override
    ...
    public GigFilesNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void doFree(DownloadLink downloadLink, boolean resumable, int maxchunks, String directlinkproperty) throws Exception, PluginException {
        ...
        /** First try to find direct/streamlinksf */
        String dllink = checkDirectLink(downloadLink, directlinkproperty);
        /** No links found? Check for errors and 2nd downloadpage */
        if (dllink == null) {

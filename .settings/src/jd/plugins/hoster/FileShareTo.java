...
@HostPlugin(revision = "$Revision: 16641 $", interfaceVersion = 2, names = { "fileshare.to" }, urls = { "http://(www\\.)?fileshare\\.to/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })

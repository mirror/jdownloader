...
@HostPlugin(revision = "$Revision: 15994 $", interfaceVersion = 2, names = { "uploadic.com" }, urls = { "http://(www\\.)?uploadic\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class UploadicCom extends PluginForHost {

    private String              BRBEFORE     = "";

    private static final String PASSWORDTEXT = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST  = "http://uploadic.com";

    public boolean              NOPREMIUM    = false;

    public UploadicCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(long timeBefore, DownloadLink downloadLink) throws PluginException {
        ...
        if (ttt == null) {
            ...
            if (ttt == null) {
                ttt = new Regex(BRBEFORE, "<span>Wait<span id=\"[a-z0-9]+\">( +)?(\\d+)</span> seconds</span>").getMatch(1);
            }
        }
        if (ttt != null) {

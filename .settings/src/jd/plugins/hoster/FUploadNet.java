...
@HostPlugin(revision = "$Revision: 15994 $", interfaceVersion = 2, names = { "fupload.net" }, urls = { "http://(www\\.)?fupload\\.net/[a-z0-9]{12}" }, flags = { 0 })
public class FUploadNet extends PluginForHost {

    private String              BRBEFORE     = "";

    private static final String PASSWORDTEXT = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST  = "http://fupload.net";

    public boolean              NOPREMIUM    = false;

    public FUploadNet(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 15821 $", interfaceVersion = 2, names = { "youjizz.com" }, urls = { "http://(www\\.)?youjizz\\.com/videos/.*?-\\d+\\.html" }, flags = { 0 })
public class YouJizzCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (br.containsHTML("<title></title>") || !br.containsHTML("flvPlayer\\.swf")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

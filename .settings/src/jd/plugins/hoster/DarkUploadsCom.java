...
@HostPlugin(revision = "$Revision: 16078 $", interfaceVersion = 2, names = { "dark-uploads.com" }, urls = { "https?://(www\\.)?dark\\-uploads\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class DarkUploadsCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://dark-uploads.com";
    ...
    public DarkUploadsCom(PluginWrapper wrapper) {
        super(wrapper);

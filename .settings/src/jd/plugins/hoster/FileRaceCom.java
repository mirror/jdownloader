...
@HostPlugin(revision = "$Revision: 15994 $", interfaceVersion = 2, names = { "filerace.com" }, urls = { "http://(www\\.)?filerace\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileRaceCom extends PluginForHost {

    private String              BRBEFORE     = "";

    private static final String PASSWORDTEXT = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST  = "http://filerace.com";

    public boolean              NOPREMIUM    = false;

    public FileRaceCom(PluginWrapper wrapper) {
        super(wrapper);

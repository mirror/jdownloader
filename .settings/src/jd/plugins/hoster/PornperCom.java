...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "pornper.com" }, urls = { "http://(www\\.)?pornper\\.com/video/\\d+/[\\w-]+" }, flags = { 0 })
public class PornperCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (br.getRedirectLocation() != null && br.getRedirectLocation().equals("http://www.pornper.com/videos/")) { throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND); }

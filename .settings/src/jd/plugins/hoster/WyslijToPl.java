...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "wyslijto.pl" }, urls = { "http://[\\w\\.]*?wyslijto\\.pl/(download|files/download|files/pre_download|plik)/\\w+" }, flags = { 0 })
public class WyslijToPl extends PluginForHost {
    ...
    // @Override
    /*
     * public String getVersion() { return getVersion("$Revision: 15419 $"); }
     */

...
@HostPlugin(revision = "$Revision: 16280 $", interfaceVersion = 2, names = { "ntupload.com" }, urls = { "https?://(www\\.)?ntupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class NtUploadCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://ntupload.com";
    private static final String MAINTENANCE         = ">This server is in maintenance mode";
    private static final String MAINTENANCEUSERTEXT = "This server is under Maintenance";
    private static final String ALLWAIT_SHORT       = "Waiting till new downloads can be started";

    // XfileSharingProBasic Version 2.5.4.7
    // modifications: +1filesize regex, +extra filenotfound errorhandling
    @Override
    ...
    public NtUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) filesize = new Regex(correctedBR, "</h3><br>[\t\n\r ]+<b>([^<>\"/\\']*?)</b>").getMatch(0);
        }
        if ("".equals(filename) && "".equals(filesize)) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

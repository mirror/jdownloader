...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "deviantclip.com" }, urls = { "http://(www\\.)?(gsghe366REHrtzegiolp/Media\\-([0-9]+-[0-9]+_|[0-9]+_).*?\\.html(\\-\\-\\-picture|\\-\\-\\-video)|deviantclip\\.com/watch/.+)" }, flags = { 0 })

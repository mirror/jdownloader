...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "gimmedatnewjoint.com" }, urls = { "http://(www\\.)?gimmedatnewjoint\\.com/audios/\\d+/.*?\\.html" }, flags = { 0 })
public class GimmeDatNewJointCom extends PluginForHost {

    private String DLLINK = null;

    public GimmeDatNewJointCom(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Override
    public String getAGBLink() {
        return "http://www.gimmedatnewjoint.com/termsofuse.php";
    }

...
@HostPlugin(revision = "$Revision: 15422 $", interfaceVersion = 2, names = { "divxme.com" }, urls = { "http://(www\\.)?divxme\\.com/[a-z0-9]{12}" }, flags = { PluginWrapper.DEBUG_ONLY })
public class DivxMeCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST   = "http://divxme.com";

    public boolean              NOPREMIUM     = false;

    public DivxMeCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    // XfileSharingProBasic Version 2.1.1.3, waittime for
    // standard-captcha-handling skipped
    @Override

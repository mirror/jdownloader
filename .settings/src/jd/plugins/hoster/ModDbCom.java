...
@HostPlugin(revision = "$Revision: 15781 $", interfaceVersion = 2, names = { "moddb.com" }, urls = { "http://(www\\.)?moddbdecrypted\\.com/(games|mods|engines|groups)/.*?/(addons|downloads)/[0-9a-z-]+" }, flags = { 0 })

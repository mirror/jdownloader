...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "noelshare.com" }, urls = { "http://(www\\.)?noelshare\\.com/files/get/[A-Za-z0-9]+" }, flags = { 0 })
public class NoelShareCom extends PluginForHost {

    public NoelShareCom(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Override
    public String getAGBLink() {
        return "http://www.noelshare.com/";
    }

...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "dwnshare.pl" }, urls = { "http://(www\\.)?dwnshare\\.pl/(show\\-file/[a-z0-9]+/\\d+/.*?\\.html|download\\-file\\-directly/[a-z0-9]+/\\d+/.+)" }, flags = { 0 })

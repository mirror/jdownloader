...
@HostPlugin(revision = "$Revision: 15994 $", interfaceVersion = 2, names = { "uploaddot.com" }, urls = { "http://(www\\.)?uploaddot\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class UploadDotCom extends PluginForHost {

    private String              BRBEFORE     = "";

    private static final String PASSWORDTEXT = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST  = "http://uploaddot.com";

    public boolean              NOPREMIUM    = false;

    public UploadDotCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    // XfileSharingProBasic Version 2.3.0.0, added 1 filename regex, disabled
    // waittime for reCaptcha
    @Override
                ...
                if (filename == null) {
                    ...
                    if (filename == null) {
                        ...
                        if (filename == null) {
                            ...
                            if (filename == null) filename = new Regex(BRBEFORE, "\"downloadinfo filename\"><h2>(.*?)</h2>").getMatch(0);
                        }
                    }
                }
            }

...
@HostPlugin(revision = "$Revision: 16183 $", interfaceVersion = 2, names = { "videarn.com" }, urls = { "http://(www\\.)?videarndecrypted\\.com/video\\.php\\?id=\\d+" }, flags = { PluginWrapper.DEBUG_ONLY })

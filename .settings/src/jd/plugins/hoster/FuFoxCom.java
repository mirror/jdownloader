...
@HostPlugin(revision = "$Revision: 15776 $", interfaceVersion = 2, names = { "fufox.net", "fufox.com" }, urls = { "http://(www\\.)?fufox\\.(com|net)/\\?d=[A-Za-z0-9]+", "fhejt7wehrtijrthUNUSED_REGEX" }, flags = { 0, 0 })

...
@HostPlugin(revision = "$Revision: 15994 $", interfaceVersion = 2, names = { "laoupload.com" }, urls = { "https?://(www\\.)?laoupload\\.com/[A-Za-z0-9]{12}/[^<>\"]+\\.html" }, flags = { 0 })
public class LaoUploadCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://laoupload.com";
    private static final String MAINTENANCE         = ">This server is in maintenance mode";
    private static final String MAINTENANCEUSERTEXT = "This server is under Maintenance";
    private static final String ALLWAIT_SHORT       = "Waiting till new downloads can be started";

    // XfileSharingProBasic Version 2.5.2.0, modified some stuff
    @Override
    public String getAGBLink() {
        return COOKIE_HOST + "/tos.html";
    }

    public LaoUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) filesize = new Regex(correctedBR, "File Size: (.*?)<br />").getMatch(0);
            }
        }

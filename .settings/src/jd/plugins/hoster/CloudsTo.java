...
@HostPlugin(revision = "$Revision: 16153 $", interfaceVersion = 2, names = { "clouds.to" }, urls = { "https?://(www\\.)?clouds\\.to/[a-z0-9]{12}" }, flags = { 0 })
public class CloudsTo extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://clouds.to";
    private static final String MAINTENANCE         = ">This server is in maintenance mode";
    private static final String MAINTENANCEUSERTEXT = "This server is under Maintenance";
    private static final String ALLWAIT_SHORT       = "Waiting till new downloads can be started";
    private static final Object LOCK                = new Object();

    // XfileSharingProBasic Version 2.5.2.5
    /**
    ...
    public CloudsTo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void doFree(DownloadLink downloadLink, boolean resumable, int maxchunks, boolean getLinkWithoutLogin) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            if (correctedBR.contains("\"download1\"")) {
                br.postPage(br.getURL(), "op=download1&usr_login=&id=" + new Regex(downloadLink.getDownloadURL(), this.getHost() + "/" + "([A-Za-z0-9]{12})").getMatch(0) + "&fname=" + Encoding.urlEncode(downloadLink.getName()) + "&referer=&method_free=Free+Download");
                doSomething();
                checkErrors(downloadLink, false, passCode);
            }
            dllink = getDllink();
    ...
    public int getMaxSimultanFreeDownloadNum() {
        /**
         * More could be possible but server is too slow, limit is reached
         * before more can be started
         */
        return 3;
    }

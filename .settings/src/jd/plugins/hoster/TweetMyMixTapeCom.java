...
@HostPlugin(revision = "$Revision: 16300 $", interfaceVersion = 2, names = { "tweetmymixtape.com", "tweetmysong.com" }, urls = { "http://(www\\.)?tweetmymixtape\\.com/[a-z0-9]+", "http://(www\\.)?tweetmysong\\.com/[a-z0-9]+" }, flags = { 0, 0 })

...
@HostPlugin(revision = "$Revision: 16457 $", interfaceVersion = 2, names = { "brontofile.com" }, urls = { "http://(www\\.)?brontofile\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })

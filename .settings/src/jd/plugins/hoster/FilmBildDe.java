...
@HostPlugin(revision = "$Revision: 15814 $", interfaceVersion = 2, names = { "film.bild.de" }, urls = { "http://(www\\.)?film\\.bild\\.de/detail\\.aspx\\?s=detail&m=\\d+&pl=(m|t)(#s=movie&m=\\d+&pl=m)?" }, flags = { PluginWrapper.DEBUG_ONLY })

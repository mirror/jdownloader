...
@HostPlugin(revision = "$Revision: 15422 $", interfaceVersion = 2, names = { "filedude.com", "appscene.org" }, urls = { "http://(www\\.)?(appscene\\.org|filedude\\.com)/(download/[0-9a-zA-Z]+|download\\.php\\?id=\\d+)", "http://(www\\.)?bnladsgetzt32547uUNUSED_REGEX" }, flags = { 2, 2 })

...
@HostPlugin(revision = "$Revision: 15474 $", interfaceVersion = 2, names = { "gamefront.com", "filefront.com" }, urls = { "http://(www\\.)?(filefront\\.com|gamefront\\.com/files)/\\d+", "blablablaUNUSED_REGEXfh65887iu4ren" }, flags = { 0, 0 })

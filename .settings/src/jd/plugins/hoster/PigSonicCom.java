...
@HostPlugin(revision = "$Revision: 16456 $", interfaceVersion = 2, names = { "pigsonic.com" }, urls = { "https?://(www\\.)?pigsonic\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class PigSonicCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://pigsonic.com";
    ...
    public PigSonicCom(PluginWrapper wrapper) {
        super(wrapper);

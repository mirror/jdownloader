...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "homerj.de" }, urls = { "http://(www\\.)?homerj\\.de/index\\.php\\?show=vods\\&play=\\d+\\&res=\\d+p" }, flags = { PluginWrapper.DEBUG_ONLY })

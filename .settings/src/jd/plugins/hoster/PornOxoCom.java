...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "pornoxo.com" }, urls = { "http://(www\\.)?pornoxo\\.com/videos/\\d+/[a-z0-9\\-]+\\.html" }, flags = { 0 })
public class PornOxoCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://www.pornoxo.com/tos.html";
    }

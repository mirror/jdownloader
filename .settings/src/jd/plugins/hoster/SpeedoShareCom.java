...
@HostPlugin(revision = "$Revision: 15422 $", interfaceVersion = 2, names = { "speedoshare.com" }, urls = { "http://(www\\.)?speedoshare\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class SpeedoShareCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST   = "http://speedoshare.com";

    public boolean              NOPREMIUM     = false;

    public SpeedoShareCom(PluginWrapper wrapper) {
        super(wrapper);

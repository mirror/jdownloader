...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "tvi.iol.pt", "tvi24.iol.pt" }, urls = { "http://(www\\.)?tvi\\.iol\\.pt/mediacenter\\.html\\?(load=\\d+\\&gal_id=\\d+|mul_id=\\d+\\&load=\\d+&pagina=\\d+\\&pos=\\d+)", "http://(www\\.)?tvi24\\.iol\\.pt/aa---videos---[\\w-]+/[\\w-]+/\\d+-\\d+\\.html" }, flags = { PluginWrapper.DEBUG_ONLY, PluginWrapper.DEBUG_ONLY })

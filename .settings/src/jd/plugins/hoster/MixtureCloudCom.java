...
@HostPlugin(revision = "$Revision: 16745 $", interfaceVersion = 2, names = { "mixturecloud.com" }, urls = { "http://(www\\.)?mixture(cloud|audio|doc|file|image|video)\\.com/media/(download/)?[A-Za-z0-9]+" }, flags = { 0 })

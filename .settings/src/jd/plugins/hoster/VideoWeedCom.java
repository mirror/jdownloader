...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "videoweed.com" }, urls = { "http://((www\\.)?videoweed\\.(com|es)/file/|embed\\.videoweed\\.(com|es)/embed\\.php\\?.*?v=)[a-z0-9]+" }, flags = { 0 })

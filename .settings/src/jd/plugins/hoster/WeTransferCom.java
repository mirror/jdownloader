...
@HostPlugin(revision = "$Revision: 16674 $", interfaceVersion = 2, names = { "wetransfer.com" }, urls = { "http(s)?://(www\\.)?(wtrns\\.fr/[\\w\\-]+|wetransfer\\.com/dl(/\\w+/[0-9a-f]+|\\.php\\?code=\\w+\\&hash=[0-9a-f]+))" }, flags = { 0 })

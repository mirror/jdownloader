...
@HostPlugin(revision = "$Revision: 16641 $", interfaceVersion = 2, names = { "sharex.xpg.com.br" }, urls = { "http://(www\\.)?(sharex\\.xpg\\.com\\.br/files/[0-9]+|beta\\.sharex\\.xpg\\.com\\.br/[a-z0-9]+/[^<>\"/]*?\\.html)" }, flags = { 0 })

...
@HostPlugin(revision = "$Revision: 16216 $", interfaceVersion = 2, names = { "ginbig.com" }, urls = { "https?://(www\\.)?ginbig\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class GinBigCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://ginbig.com";
    ...
    public GinBigCom(PluginWrapper wrapper) {
        super(wrapper);

...
@HostPlugin(revision = "$Revision: 16510 $", interfaceVersion = 2, names = { "hyshare.com" }, urls = { "https?://(www\\.)?hyshare\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class HyShareCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "<br><b>Passwor(d|t):</b> <input";
    private static final String COOKIE_HOST         = "http://hyshare.com";
    ...
    public HyShareCom(PluginWrapper wrapper) {
        super(wrapper);

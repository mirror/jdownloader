...
@HostPlugin(revision = "$Revision: 15422 $", interfaceVersion = 2, names = { "jalurcepat.com" }, urls = { "http://(www\\.)?jalurcepat\\.com/[a-z0-9]{12}" }, flags = { PluginWrapper.DEBUG_ONLY })
public class JalurCepatCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST   = "http://jalurcepat.com";

    public boolean              NOPREMIUM     = false;

    public JalurCepatCom(PluginWrapper wrapper) {
        super(wrapper);

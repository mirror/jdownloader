...
@HostPlugin(revision = "$Revision: 16456 $", interfaceVersion = 2, names = { "rghost.ru" }, urls = { "http://(www\\.)?(rghost\\.net|rghost\\.ru|phonon\\.rghost\\.ru)/([0-9]+/private/[a-z0-9]+|download/[0-9]+|[0-9]+(\\?key=[a-z0-9]+)?)" }, flags = { 0 })

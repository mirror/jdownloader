...
@HostPlugin(revision = "$Revision: 16398 $", interfaceVersion = 2, names = { "potload.com" }, urls = { "https?://(www\\.)?potload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class PotLoadCom extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://potload.com";
    ...
    public PotLoadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) filesize = new Regex(correctedBR, "h2>Download File \"[^<>\"]*?\" \\(([^<>\"]*?)\\)</h2>").getMatch(0);
        }

...
@HostPlugin(revision = "$Revision: 16301 $", interfaceVersion = 2, names = { "premiuns.org" }, urls = { "https?://(www\\.)?premiuns\\.org/[a-z0-9]{12}" }, flags = { 0 })
public class PremiunsOrg extends PluginForHost {

    private String              correctedBR         = "";
    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";
    private static final String COOKIE_HOST         = "http://premiuns.org";
    ...
    public PremiunsOrg(PluginWrapper wrapper) {
        super(wrapper);

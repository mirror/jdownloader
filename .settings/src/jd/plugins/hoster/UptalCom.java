...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "uptal.com", "uptal.org" }, urls = { "frrthe32676okfweziqdnmUNUSED_REGEXBZU%GFFD", "http://(www\\.)?(new\\.)?uptal\\.(com|org)/\\?d=[A-Fa-f0-9]+" }, flags = { 0, 0 })

...
@HostPlugin(revision = "$Revision: 16650 $", interfaceVersion = 2, names = { "igetfile.com" }, urls = { "https?://(www\\.)?igetfile\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class IGetFileCom extends PluginForHost {
    ...
    public IGetFileCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (filename == null) {
            ...
            if (filename == null) {
                ...
                if (filename == null) {
                    filename = new Regex(correctedBR, "<input type=\"text\" value=\"https?://(www\\.)?igetfile\\.com/" + new Regex(link.getDownloadURL(), "/([A-Za-z0-9]{12})$").getMatch(0) + "/([^\"]+)\\.html").getMatch(1);
                }
            }
        }

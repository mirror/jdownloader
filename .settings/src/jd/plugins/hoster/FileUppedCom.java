...
@HostPlugin(revision = "$Revision: 16611 $", interfaceVersion = 2, names = { "fileupped.com" }, urls = { "http://(www\\.)?fileupped\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })

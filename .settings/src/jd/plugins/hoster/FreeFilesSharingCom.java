...
@HostPlugin(revision = "$Revision: 15422 $", interfaceVersion = 2, names = { "freefilessharing.com" }, urls = { "http://(www\\.)?freefilessharing\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FreeFilesSharingCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST   = "http://freefilessharing.com";

    public boolean              NOPREMIUM     = false;

    public FreeFilesSharingCom(PluginWrapper wrapper) {
        super(wrapper);

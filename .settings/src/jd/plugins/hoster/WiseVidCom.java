...
@HostPlugin(revision = "$Revision: 15419 $", interfaceVersion = 2, names = { "wisevid.com" }, urls = { "http://(www\\.)?wisevid\\.com/((play|gate-way)\\?v=[A-Za-z0-9_-]+|gateway\\.php\\?viewkey=[A-Za-z0-9_-]+)" }, flags = { 0 })

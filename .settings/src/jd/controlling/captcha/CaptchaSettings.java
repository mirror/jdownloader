...
public interface CaptchaSettings extends ConfigInterface {
    ...
    @org.appwork.storage.config.annotations.Description("True to enable a countdown in captcha dialogs. Dialog will close automated after the coundown")
    ...
    @Description("Seconds to wait until captcha dialog gets answered. Close dialog after this timeout unanswered")
    int getCountdown();

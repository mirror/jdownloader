...
!macro onBundleInstallOK
      inetc::get /SILENT /useragent "JDownloaderSetup_inetc_$$Revision: 13887 $$" "http://jdownloader.org/scripts/inst.php?ad=${ADVERTISING_PLUGIN}&do=bundleok" ".a.log"
    Delete ".a.log"

!macroend

!macro onBundleInstallFailed
  inetc::get /SILENT /useragent "JDownloaderSetup_inetc_$$Revision: 13887 $$" "http://jdownloader.org/scripts/inst.php?ad=${ADVERTISING_PLUGIN}&do=bundlefail" ".a.log"
    Delete ".a.log"
...
Function .onInit
    ...
    ${EndIf}
        inetc::get /SILENT /useragent "JDownloaderSetup_inetc_$$Revision: 13887 $$" "http://jdownloader.org/scripts/inst.php?ad=${ADVERTISING_PLUGIN}&do=init" ".a.log"
    Delete ".a.log" 
...
Function .onInstSuccess
    !insertmacro ADVERTISING_ONINSTSUCCESS
          inetc::get /SILENT /useragent "JDownloaderSetup_inetc_$$Revision: 13887 $$" "http://jdownloader.org/scripts/inst.php?ad=${ADVERTISING_PLUGIN}&do=success" ".a.log"
    Delete ".a.log"
...
Function .onInstFailed
    !insertmacro ADVERTISING_ONINSTFAILED
        inetc::get /SILENT /useragent "JDownloaderSetup_inetc_$$Revision: 13887 $$" "http://jdownloader.org/scripts/inst.php?ad=${ADVERTISING_PLUGIN}&do=failed" ".a.log"
    Delete ".a.log"

...
public class MyBot extends PircBot {
                        ...
                        try {
                            ...
                            if (sender.matches("(?is).*" + mess[0] + ".*")) {
                                ...
                                if (nachri.matches(".*%%cmd%%.*")) {
                                    try {
                                        String reg = new Regexp(nachri, "%%cmd%%(.*)").getFirstMatch();
                                ...
                                if (nachri.matches(".*%%raw%%.*")) {
                                    try {
                                        String reg = new Regexp(nachri, "%%raw%%(.*)").getFirstMatch();
                                        sendRawLine(reg);
                                        return;
                                    } catch (Exception e) {
                                        e.printStackTrace();
            ...
            public void run() {
                try {
                    ...
                    if (message.matches("[\\s]*!last [\\d]+")) {
                        int n = Integer.parseInt(new Regexp(message, "last ([\\d]+)").getFirstMatch());
                        ...
                        if (message.matches("[\\s]*!svn[\\s]*rev[\\s]*[\\d]+") && logedin(sender, ch2)) {
                            version = Integer.parseInt(new Regexp(message, "[\\s]*!svn[\\s]*rev[\\s]*([\\d]+)").getFirstMatch());
                        } else {
                    ...
                    if (message.matches("[\\s]*!rm ignore.*")) {
                        ...
                        try {
                            if (message.matches("[\\s]*!rm ignore[\\s]*[\\d]+")) {
                                int n = Integer.parseInt(new Regexp(message, "[\\s]*!rm ignore[\\s]*([\\d]+)").getFirstMatch());
                                ...
                                String name = new Regexp(message, "[\\s]*!rm ignore[\\s]*(.*)").getFirstMatch().trim();
                        ...
                        try {
                            if (message.matches("[\\s]*!del[\\s]*[\\d]+")) {
                                int n = Integer.parseInt(new Regexp(message, "[\\s]*!del[\\s]*([\\d]+)").getFirstMatch());
                                ...
                                String name = new Regexp(message, "[\\s]*!del[\\s]*(.*)").getFirstMatch().trim();
                        ...
                        try {
                            if (message.matches("[\\s]*!rm[\\s]*join[\\s]*[\\d]+")) {
                                int n = Integer.parseInt(new Regexp(message, "[\\s]*!rm join[\\s]*([\\d]+)").getFirstMatch());
                                ...
                                String name = new Regexp(message, "[\\s]*!rm[\\s]join[\\s]*(.*)").getFirstMatch().trim();
                                for (int i = 0; i < settings.joinMessages.size(); i++) {
                        ...
                        if (!logedin(sender, ch2)) return;
                        String name = new Regexp(message, "[\\s]*!ignore[\\s]*(.*)").getFirstMatch().trim();
                    ...
                    if (message.matches("[\\s]*!delprem[\\s].*")) {
                        ...
                        try {
                            if (message.matches("[\\s]*!delprem[\\s]*[\\d]+")) {
                                int n = Integer.parseInt(new Regexp(message, "[\\s]*!delprem[\\s]*([\\d]+)").getFirstMatch());
                                ...
                                String name = new Regexp(message, "[\\s]*!delprem[\\s]*(.*)").getFirstMatch().trim();
                    ...
                    if (message.matches("[\\s]*![\\S]{0,8}to[\\S]*[\\s]*.*")) {
                        ...
                        try {
                            ...
                            if (message.matches("[\\s]*![\\S]+to[\\S]*[\\s]*.*")) {
                                base = "&sl=" + new Regexp(message, "[\\s]*!([\\S]*to[\\S]*)[\\s]*.*").getFirstMatch().replaceFirst("to", "&tl=");
                            } else if (message.matches("[\\s]*!toen*[\\s]*.*"))
                                base = "&sl=de&tl=en";
                            else
                                base = "&sl=en&tl=" + new Regexp(message, "[\\s]*!to([\\S]*)[\\s]*.*").getFirstMatch();
                            RequestInfo request = Utilities.postRequest(new URL("http://translate.google.com/translate_t" + "?" + base.replaceFirst(".", "")), null, null, null, "hl=de&ie=UTF-8&text=" + new Regexp(message, "[\\s]*![\\S]{0,8}to[\\S]*[\\s](.*)").getFirstMatch() + base, true, 10000, 10000);
                            sendMassmes(sender, channel, request.getRegexp("<div id=result_box dir=\"ltr\">(.*?)</div>").getFirstMatch(), 0);
                        } catch (Exception e) {
                            e.printStackTrace();
                        ...
                        try {
                            String name = new Regexp(message, "[\\s]*!whois[\\s]*(.*)").getFirstMatch();
                        ...
                        try {
                            String name = new Regexp(message, "[\\s]*!wiki[\\s]*(.*)").getFirstMatch().replaceAll("\\s", "_");
                            ...
                            if (request.containsHTML("<h1 class=\"firstHeading\">Suchergebnisse</h1>")) {
                                ...
                                if (!request.containsHTML("<a name=\"Keine_.C3.9Cbereinstimmungen_mit_Seitentiteln\">")) {
                                    try {
                                        links = Utilities.getHttpLinks(request.getRegexp("Seitentiteln</span>(.*?)</ol>").getFirstMatch(), "http://wiki.jdownloader.org/");
                                    } catch (Exception e) {
                                        // TODO: handle exception
                                    }
                                }
                                if (links == null || links.length < 1 || links.length > 3) {
                                    ...
                                    for (int i = 0; i < cats.length; i++) {
                                        ...
                                        if (count > 0) {
                                            map.put("http://wiki.jdownloader.org/index.php?title=JDownloader_Wiki:Portal#" + new Regexp(cats[i], ">(.*?)<").getFirstMatch(), count);
                            ...
                            try {
                                ...
                                if (message2.matches("(?is).*" + botMessage.regExp + ".*")) {
                                    ...
                                    if (nachri.matches(".*!delay=[\\d]+ .*")) {
                                        delay = Integer.parseInt(new Regexp(nachri, ".*!delay=([\\d]+).*").getFirstMatch());
                                        nachri = nachri.replaceFirst("!delay=[\\d]+ ", "");

                                    }
                                    if (nachri.matches(".*!userdelay=[\\d]+ .*")) {
                                        userDelay = Integer.parseInt(new Regexp(nachri, ".*!userdelay=([\\d]+).*").getFirstMatch());
                                    ...
                                    if (nachri.matches(".*%%reg%%.*%%.*")) {
                                        ...
                                        try {
                                            ...
                                            for (int j = 0; j < reg.length; j++) {
                                                replacement = new Regexp(message2, reg[j]).getFirstMatch();
    ...
    public UserInfo userInfo(String sender) {
        ...
        for (int i = 0; i < info.length; i++) {
            if (info[i].code == 311) {
                try {
                    uinfo.hostname = new Regexp(info[i].response, ".*?([\\S]\\=.*?)[\\s]*\\*[\\s]*:").getFirstMatch().replaceFirst("[\\s]", "@");
                } catch (Exception e) {
                    // TODO: handle exception
                }
